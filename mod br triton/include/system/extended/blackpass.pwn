#if defined _TOP_BR_BLACKPASS_INCLUDED
    #endinput
#endif
#define _TOP_BR_BLACKPASS_INCLUDED

#define BLACKPASS_SEASON_NUMBER         28
#define BLACKPASS_SEASON_NAME           "������� ������"
...
new const g_blackpass_standard_reward_names[BLACKPASS_MAX_LEVELS + 1][64] =
{
    "",
    "����� X5", "5000 �", "5 EXP", "X5 ����", "���������� X1",
    "GOLD 8�.", "����� X5", "10 BC", "X2 �� 24�.", "�����",
    "�������", "7500 �", "5 EXP", "X5 ����", "���������� X1",
    "SILVER 2�.", "����� X5", "5 BC", "X2 �� 24�.", "����� X1",
    "��������", "7500 �", "5 EXP", "X5 ����", "���������� X1",
    "SILVER 2�.", "����� X5", "5 BC", "X2 �� 24�.", "�����",
    "����", "7500 �", "10 EXP", "X5 ����", "���������� X1",
    "SILVER 2�.", "����� X5", "5 BC", "X2 �� 24�.", "����� X1",
    "����� ���������", "7500 �", "10 EXP", "X5 ����", "���������� X1",
    "GOLD 2�.", "10 BC", "����� X5", "X2 �� 24�.", "��������",
    "����������", "15000 �", "10 EXP", "X5 ����", "���������� X1",
    "GOLD 2�.", "10000 �", "15 BC", "X2 �� 24�.", "Volvo 940",
    "5000 �"
};
...
new const g_blackpass_premium_reward_names[BLACKPASS_MAX_LEVELS + 1][64] =
{
    "",
    "40 BC", "15000 �", "����� X5", "X10 ����", "�����",
    "GOLD 2�.", "15000 �", "10 BC", "����� X1", "Chevrolet Malibu Police Car - Cobra",
    "���������", "15000 �", "����� X10", "X10 ����", "������� �����",
    "GOLD 2�.", "15000 �", "10 BC", "���������� X1", "������� �����",
    "������", "20000 �", "����� X10", "X10 ����", "����������� X1",
    "GOLD 2�.", "20000 �", "10 BC", "����� X1", "Land Cruiser 300",
    "����������� �������", "30000 �", "����� X10", "X10 ����", "��������",
    "GOLD 2�.", "30000 �", "10 BC", "����� X1", "�����������",
    "����", "40000 �", "����� X20", "X10 ����", "����� X2",
    "PLATINUM 2�.", "40000 �", "10 BC", "����� X1", "�����",
    "�����������", "50000 �", "����� X25", "X10 ����", "����: �������� X1",
    "PLATINUM 2�.", "50000 �", "15 BC", "����� X1", "Mercedes-Benz S-Class W223",
    "20000 �"
};
...
{
    return ShowNotificationSile(playerid, 2, 4, 0, 0, "������ BlackPass �������� ���������", " ");
}
...
stock BlackPass_SendStateRefresh(playerid, current_layout = 0, visible_layout = -1)
{
    ...
    ShowPlayerGUI(playerid, 22, refresh_json);
...
stock BlackPass_SendLevelSyncPacket(playerid, level = -1, exp_value = -1)
{
    ...
    ShowPlayerGUI(playerid, 22, sync_json);
...
stock BlackPass_SendRewardClaimPacket(playerid, reward_id, bool:is_premium, layout_id = 0)
{
    ...
    ShowPlayerGUI(playerid, 22, claim_json);
...
stock BlackPass_GetTaskDescription(task_id, output[], output_len)
{
    ...
    switch(task_id)
    {
        case 254: format(output, output_len, "������� � ����");
        case 52: format(output, output_len, "��������� 1 ���");
        case 124: format(output, output_len, "�������� ����� ���������");
        case 108: format(output, output_len, "��������� ������");
        case 96: format(output, output_len, "������� ���������� � ��� (/ad)");
        case 97: format(output, output_len, "���������� ��������� ������ ���� � �����");
        case 99: format(output, output_len, "����������� 15000 ������ ��� ����� � �����");
        case 143: format(output, output_len, "�������������� � 2 ��������");
        case 256: format(output, output_len, "�������� 8 ����� ��� � ������");
        case 257: format(output, output_len, "����������� 100 000 ������");
        case 6: format(output, output_len, "�������� ������ ������ ���������� � ���");
        case 255: format(output, output_len, "�������� 5 ����� ������");
        case 104: format(output, output_len, "�������� ������ �� ���� ����� � ����� ����������");
        case 2: format(output, output_len, "�������� ����");
        case 4: format(output, output_len, "�������� ������");
        default: format(output, output_len, "������� Black Pass");
    }
    return 1;
}
...
stock BlackPass_ShowTaskReadyGui(playerid, task_id)
{
    ...
    JSON_SetString(json, "h", "�������� ������� BLACK PASS");
    JSON_SetString(json, "s", "������� ������� <font color='#ffd801'></font> ���������. �������, �����  �������� �������.");
    JSON_SetString(json, "b", "��������");
...
stock BlackPass_ClaimTaskReward(playerid, task_id)
{
    ...
    format(notify_str, sizeof(notify_str), "�� �������� %d ������", money_reward);
    ShowNotificationSile(playerid, 3, 4, 0, 0, notify_str, "qq");

    if(BlackPass_GetCurrentLevel(playerid) > old_level)
    {
        ShowNotificationSile(playerid, 3, 3, 0, 0, "�� ������� �������� ����� ������� Black Pass.", "qq");
...
stock BlackPass_BeginTrackTask(playerid, task_id)
{
    ...
    ShowNotificationSile(playerid, 3, 3, 0, 0, "����� �������� � ��� �� GPS", "qq");
...
stock BlackPass_HandleTaskExchange(playerid, Node:json)
{
    ...
    {
        ShowNotificationSile(playerid, 2, 3, 0, 0, "������������ BC.", "qq");
        return 1;
    }
    ...
    {
        ShowNotificationSile(playerid, 2, 3, 0, 0, "������ ��� ������� ������ ��������.", "qq");
        return 1;
    }
    ...
    GivePlayerDonateRub(playerid, -BLACKPASS_EXCHANGE_COST, "����� ������� BlackPass", true, true);
    ...
    ShowNotificationSile(playerid, 3, 3, 0, 0, "�� ��������� 10 �� � {FFFF00}�������\n������� �������{FFFF00}{FFFFFF}!", "qq");
...
stock BlackPass_SendMainPacket(playerid, Node:json, latype)
{
    ...
    switch(latype)
    {
        case 0:
        {
            ...
            ShowPlayerGUI(playerid, 22, json);
            return 1;
        }
...
stock BlackPass_HandleBuyLevels(playerid, Node:json)
{
    ...
    GivePlayerDonateRub(playerid, -price, "������� ������� BlackPass", true, true);
    BlackPass_SavePlayer(playerid);
    ...
    BlackPass_ShowLootNotification(playerid, "������� �������� � �������");
    return 1;
}
...
stock BlackPass_HandlePurchasePremium(playerid, Node:json)
{
    ...
    GivePlayerDonateRub(playerid, -price, is_deluxe ? "������� BlackPass Deluxe" : "������� BlackPass Premium", true, true);
    ...
    if(is_deluxe)
    {
        ...
        BlackPass_SendMainPacket(playerid, json, 0);
        BlackPass_SendStateRefresh(playerid, 0, -1);
        BlackPass_ShowLootNotification(playerid, "������� Premium Deluxe �������� � �������");
    }
    else
    {
        ...
        BlackPass_SendMainPacket(playerid, json, 0);
        BlackPass_SendStateRefresh(playerid, 0, -1);
        BlackPass_ShowLootNotification(playerid, "������� Premium �������� � �������");
    }
    return 1;
}
...
stock BlackPass_HandleRefreshRating(playerid, Node:json)
{
    ...
    {
        ShowNotificationSile(playerid, 2, 4, 0, 0, "��������� ������� ����� ��� � 30 ������", "qq");
        return 1;
    }
