...
new ruletka_prize[12][R_STRUCT] =//  :  []  
{
    {T_CAR, "txd:brgiftsuncar", 	"Toyota_Mark_2", "Toyota Mark II",		547},
	{T_CAR, "txd:brgiftsuncar", 	"Ford_Mustang", "Ford Mustang GT",			603},
	{T_DONATE, "txd:brgiftsdonate", 		"_150_-.", " 150 -", 150},
    {T_MONEY, "txd:brgiftscash", 	"o_500000_p.", " 500000 ",		500000},
	{T_SLOT, "txd:brgiftsfreeslot", 		"__", 	"  ",	1},
    {T_VIP, "txd:brgiftsgvip", 		"Gold-Vip", "GOLD-VIP  15 ",			3},
    {T_LIC, "txd:brgiftslic", 		"aka_c_e", 	"  ",	1},
    {T_MONEY, "txd:brgiftscash", 	"o_100000_p.",  " 100000 ",	100000},
    {T_GUN, "txd:brgiftsgun", 		"Cyaoe_opye", 	" ",	25},
...
public SYS_ROULETTE_OnGameModeInit()
{
    printf("[LAIRD_SYSTEM]   .\n");
    RuletkaMenu();
    LoadPrizeRuletka();
   ...
   #if defined _ALS_SYS_ROULETTE_OnGameModeInit
    #undef SYS_ROULETTE_OnGameModeInit
#else
    #define _ALS_SYS_ROULETTE_OnGameModeInit
#endif
#define SYS_ROULETTE_OnGameModeInit rul_OnGameModeInit
#if defined rul_OnGameModeInit
    forward rul_OnGameModeInit();
#endif

public SYS_ROULETTE_OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    if(dialogid == 2832)
    {
        if(response)
        {
            if(listitem == 0 || listitem == 1)
            {
                ...
                Dialog(playerid, 2832, DIALOG_STYLE_LIST, "{FF0000}  ", dialog, "", "");
                return 1;
            }
            ...
            switch(id)
            {
                case 0,1:
                {
                    ...
                    format(text, sizeof text, "  %s  . !",  ruletka_prize[id][R_NAME_PRIZE]);
                }
                case 2:
                {
                    count = random(150)+1;
                    ...
                    format(text, sizeof text, "  %d -  . !", count);
                }
                case 3,7:
                {
                ...
                case 5:
                {
                    ...
                    format(text, sizeof text, "  {FFEE00}VIP Gold{FFFFFF}  {F5D000}%02d.%02d.%d  . ", prem_day, prem_month, prem_year);
            ...
            if(mysql_errno()) return SendClientMessage(playerid, -1, "  .");
        }
    }
    #if defined name_SYS_ROULETTE_OnDialogResponse
return name_SYS_ROULETTE_OnDialogResponse(playerid, dialogid, response, listitem, inputtext);
#endif
}
#if defined _ALS_SYS_ROULETTE_OnDialogResponse
#undef SYS_ROULETTE_OnDialogResponse
#else
#define _ALS_SYS_ROULETTE_OnDialogResponse
#endif
#define SYS_ROULETTE_OnDialogResponse name_SYS_ROULETTE_OnDialogResponse
#if defined name_SYS_ROULETTE_OnDialogResponse
forward name_SYS_ROULETTE_OnDialogResponse(playerid, dialogid, response, listitem, inputtext[]);
#endif

public SYS_ROULETTE_OnPlayerConnect(playerid)
{
...
#if defined _ALS_SYS_ROULETTE_OnPlayerConnect
    #undef SYS_ROULETTE_OnPlayerConnect
#else
    #define _ALS_SYS_ROULETTE_OnPlayerConnect
#endif
#define SYS_ROULETTE_OnPlayerConnect rul_OnPlayerConnect
#if defined rul_OnPlayerConnect
    forward rul_OnPlayerConnect(playerid);
#endif

public SYS_ROULETTE_OnPlayerClickTextDraw(playerid, Text:clickedid)
{
	if(clickedid == welsirltk_TD[4])
	{
        if(animation_player[playerid]) return SCM(playerid, -1, ""USC"  .");
        ...
        else SendClientMessage(playerid, -1, "   50 -.");
	}
...
#if defined _ALS_SYS_ROULETTE_OnPlayerClickTextDraw
    #undef SYS_ROULETTE_OnPlayerClickTextDraw
#else
    #define _ALS_SYS_ROULETTE_OnPlayerClickTextDraw
#endif
#define SYS_ROULETTE_OnPlayerClickTextDraw rul_OnPlayerClickTextDraw
#if defined rul_OnPlayerClickTextDraw
...
stock RuletkaMenu()
{
    welsirltk_TD[0] = TextDrawCreate(3.6665, 208.3332, "txd:brgiftsdownpanel"); // 
    ...
    welsirltk_TD[1] = TextDrawCreate(47.2378, 11.6280, "txd:brgiftsbgspin"); // 
    ...
    welsirltk_TD[2] = TextDrawCreate(255.0950, 167.3733, "txd:brgiftsdostupno"); // 
    ...
    welsirltk_TD[4] = TextDrawCreate(114.1427, 66.2651, "txd:brgiftsbuycase"); // 
    ...
    welsirltk_TD[5] = TextDrawCreate(553.9045, 366.4369, "txd:brgiftscash"); // 
    ...
    welsirltk_TD[6] = TextDrawCreate(586.6188, 399.6828, "o_100000_p."); // 
    ...
    welsirltk_TD[7] = TextDrawCreate(196.6666, 288.5704, "txd:brgiftbronzatext"); // 
    ...
    welsirltk_TD[8] = TextDrawCreate(239.3332, 219.0370, "POHO"); // 
    ...
    welsirltk_TD[9] = TextDrawCreate(399.5713, 366.8517, "txd:brgiftscash"); // 
    ...
    welsirltk_TD[10] = TextDrawCreate(433.2857, 400.5124, "o_100000_p."); // 
    ...
    welsirltk_TD[11] = TextDrawCreate(476.2379, 366.4370, "txd:brgiftscash"); // 
    ...
    welsirltk_TD[12] = TextDrawCreate(509.6188, 400.5125, "o_100000_p."); // 
    ...
    welsirltk_TD[13] = TextDrawCreate(551.9046, 213.7850, "txd:brgiftscash"); // 
    ...
    welsirltk_TD[14] = TextDrawCreate(585.9521, 247.4457, "o_100000_p."); // 
    ...
    welsirltk_TD[15] = TextDrawCreate(399.2380, 214.1998, "txd:brgiftscash"); // 
    ...
    welsirltk_TD[16] = TextDrawCreate(432.9524, 247.8605, "o_100000_p."); // 
    ...
    welsirltk_TD[17] = TextDrawCreate(475.9046, 213.7850, "txd:brgiftscash"); // 
    ...
    welsirltk_TD[34] = TextDrawCreate(580.9998, 2.0888, "t.me/prizmamobile"); // 
    welsirltk_TD[18] = TextDrawCreate(509.2855, 247.8606, "o_100000_p."); // 
    ...
    welsirltk_TD[19] = TextDrawCreate(551.5712, 264.8072, "txd:brgiftscash"); // 
    ...
    welsirltk_TD[20] = TextDrawCreate(585.6187, 298.4679, "o_100000_p."); // 
    ...
    welsirltk_TD[21] = TextDrawCreate(398.9046, 265.2220, "txd:brgiftscash"); // 
    ...
    welsirltk_TD[22] = TextDrawCreate(432.6191, 298.8827, "o_100000_p."); // 
    ...
    welsirltk_TD[23] = TextDrawCreate(475.5713, 264.8073, "txd:brgiftscash"); // 
    ...
    welsirltk_TD[24] = TextDrawCreate(508.9522, 298.8828, "o_100000_p."); // 
    ...
    welsirltk_TD[25] = TextDrawCreate(552.2379, 315.4146, "txd:brgiftscash"); // 
    ...
    welsirltk_TD[26] = TextDrawCreate(586.2855, 349.0754, "o_100000_p."); // 
    ...
    welsirltk_TD[27] = TextDrawCreate(399.5713, 315.8294, "txd:brgiftscash"); // 
    ...
    welsirltk_TD[28] = TextDrawCreate(433.2857, 349.4902, "o_100000_p."); // 
    ...
    welsirltk_TD[29] = TextDrawCreate(476.2379, 315.4147, "txd:brgiftscash"); // 
    ...
    welsirltk_TD[30] = TextDrawCreate(509.6188, 349.4902, "o_100000_p."); // 
    ...
    welsirltk_TD[31] = TextDrawCreate(27.5713, 143.9302, "txd:brgiftsupdate"); // 
    ...
    welsirltk_TD[32] = TextDrawCreate(528.2379, 159.6932, "ruletka:brgiftsexit"); // 
    ...
    welsirltk_TD[33] = TextDrawCreate(259.6665, 68.3864, "ruletka:brgiftsspin"); // 
...
{
	ruletka_PTD[playerid][0] = CreatePlayerTextDraw(playerid, 430.2377, 13.7539, "txd:brgiftslic"); // 
	...
	ruletka_PTD[playerid][1] = CreatePlayerTextDraw(playerid, 352.6664, 13.7340, "txd:brgiftsuncar"); // 
	...
	ruletka_PTD[playerid][2] = CreatePlayerTextDraw(playerid, 276.3807, 14.9784, "txd:brgiftsgvip"); // 
	...
	ruletka_PTD[playerid][4] = CreatePlayerTextDraw(playerid, 123.9045, 14.6739, "txd:brgiftscash"); // 
	...
	ruletka_PTD[playerid][3] = CreatePlayerTextDraw(playerid, 200.4284, 15.0650, "txd:brgiftsgun"); // 
	...
	ruletka_PTD_t[playerid][1] = CreatePlayerTextDraw(playerid, 389.3807, 44.9925, "BMW_M5_F90"); // 
	...
	ruletka_PTD_t[playerid][2]  = CreatePlayerTextDraw(playerid, 311.8570, 46.6399, "Gold-Vip"); // 
	...
	ruletka_PTD_t[playerid][3]  = CreatePlayerTextDraw(playerid, 235.2379, 47.0784, " "); // 
	...
	ruletka_PTD_t[playerid][4]  = CreatePlayerTextDraw(playerid, 157.2856, 48.3346, " 100000 ."); // 
	...
	ruletka_PTD_t[playerid][0]  = CreatePlayerTextDraw(playerid, 466.8570, 45.8340, "  "); // 
    ...
    ruletka_PTD_t[playerid][5] = CreatePlayerTextDraw(playerid, 11.6664, 358.4451, "txd:brgiftsuncar"); // 
    ...
    ruletka_PTD_t[playerid][6] = CreatePlayerTextDraw(playerid, 99.6666, 361.7334, "Welsi_Developer"); // 
    ...
    ruletka_PTD_t[playerid][7] = CreatePlayerTextDraw(playerid, 47.7141, 388.8739, "BMW_M5_F90"); // 
    ...
    ruletka_PTD_t[playerid][8] = CreatePlayerTextDraw(playerid, 86.9999, 376.6668, "POHO KEC"); // 
    ...
    ruletka_PTD_t[playerid][9] = CreatePlayerTextDraw(playerid, 10.9998, 305.7636, "txd:brgiftsuncar"); // 
    ...
    ruletka_PTD_t[playerid][10] = CreatePlayerTextDraw(playerid, 47.3807, 336.1924, "BMW_M5_F90"); // 
    ...
    ruletka_PTD_t[playerid][11] = CreatePlayerTextDraw(playerid, 99.6666, 308.2222, "Welsi_Developer"); // 
    ...
    ruletka_PTD_t[playerid][12] = CreatePlayerTextDraw(playerid, 86.9999, 323.1556, "POHO KEC"); // 
    ...
    ruletka_PTD_t[playerid][13] = CreatePlayerTextDraw(playerid,11.3331, 253.0822, "txd:brgiftsuncar"); // 
    ...
    ruletka_PTD_t[playerid][14] = CreatePlayerTextDraw(playerid,47.7141, 283.5110, "BMW_M5_F90"); // 
    ...
    ruletka_PTD_t[playerid][15] = CreatePlayerTextDraw(playerid,99.6666, 256.3703, "Welsi_Developer"); // 
    ...
    ruletka_PTD_t[playerid][16] = CreatePlayerTextDraw(playerid,86.9999, 271.3037, "POHO KEC"); // 
    ...
    ruletka_PTD_t[playerid][17] = CreatePlayerTextDraw(playerid, 317.3334, 173.8222, "4"); // 
...
public SYS_ROULETTE_OnPlayerDisconnect(playerid, reason)
{
...
#if defined _ALS_SYS_ROULETTE_OnPlayerDisconnect
    #undef SYS_ROULETTE_OnPlayerDisconnect
#else
    #define _ALS_SYS_ROULETTE_OnPlayerDisconnect
#endif
#define SYS_ROULETTE_OnPlayerDisconnect rul_OnPlayerDisconnect
#if defined rul_OnPlayerDisconnect
...
public:RunRuletka(playerid)
{
	...
	if(ruletka_count[playerid])
	{
		...
		{
			format(text, sizeof text, "!   %s{FFFF00}.{FFFFFF}    {FFFF00}/roulette", ruletka_prize[menu_prize_player[playerid][2]][R_NAME_PRIZE]);
			SendClientMessage(playerid, -1, text);
...
CMD:roulette(playerid)
{
    ...
    if(!cache_num_rows()) return SendClientMessage(playerid, -1, "     .");
