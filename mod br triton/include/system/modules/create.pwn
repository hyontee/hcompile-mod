...
{
   print("[LAIRD_SYSTEM]    ");
    #if defined create_SYS_CREATE_OnGameModeInit
        return create_SYS_CREATE_OnGameModeInit();
    #else
        return 1;
    #endif
}
   #if defined _ALS_SYS_CREATE_OnGameModeInit
    #undef SYS_CREATE_OnGameModeInit
#else
    #define _ALS_SYS_CREATE_OnGameModeInit
#endif
#define SYS_CREATE_OnGameModeInit create_SYS_CREATE_OnGameModeInit
#if defined create_SYS_CREATE_OnGameModeInit
    forward create_SYS_CREATE_OnGameModeInit();
#endif
...
public SYS_CREATE_OnPlayerEnterDynamicArea(playerid, areaid)
{
   ...
   #if defined _ALS_SYS_CREATE_OnPlayerEnterDynamicArea
    #undef SYS_CREATE_OnPlayerEnterDynamicArea
#else
    #define _ALS_SYS_CREATE_OnPlayerEnterDynamicArea
#endif
#define SYS_CREATE_OnPlayerEnterDynamicArea cr_OnPlayerEnterDynamicArea
#if defined cr_OnPlayerEnterDynamicArea
...
#if defined _ALS_SYS_CREATE_OnDialogResponse
#undef SYS_CREATE_OnDialogResponse
#else
#define _ALS_SYS_CREATE_OnDialogResponse
#endif
#define SYS_CREATE_OnDialogResponse cr_OnDialogResponse
#if defined cr_OnDialogResponse
