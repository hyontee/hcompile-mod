//A  : https://t.me/welsistudio
//  : https://t.me/welsistudio

#define tc_msg "{FFAE00}[ ] {FFFFFF}"
...
{
    {40000, 10000}, // salary_order 40000  50000
    {35000, 10000}, //   35000  45000 (10000   ?) 
    {50000, 5000},
...
{
    {TC_TYPE_ORDER_COAL, TC_LOCALITY_BUSAEVO, {-2435.133789,2712.665527,39.636734}, TC_ORDER_NLOAD, 0, " \".\""},//0
    {TC_TYPE_ORDER_COAL, TC_LOCALITY_BUSAEVO, {598.226501,1757.621826,11.861831}, TC_ORDER_NLOAD, 0, " "},//1
    {TC_TYPE_ORDER_METAL, TC_LOCALITY_BUSAEVO, {-2210.867187,-415.374481,29.209861}, TC_ORDER_NLOAD, 0, "  \".\""},//2
    {TC_TYPE_ORDER_METAL, TC_LOCALITY_BUSAEVO, {2058.106445,-2604.110351,10.619886}, TC_ORDER_NLOAD, 0, " \".\""},//3
    {TC_TYPE_ORDER_METAL, TC_LOCALITY_BUSAEVO, {2738.700439,-2316.699707,17.697065}, TC_ORDER_NLOAD, 0, " \".\""},//4
    {TC_TYPE_ORDER_OZON, TC_LOCALITY_BUSAEVO, {-2401.122314,10.525905,25.986291}, TC_ORDER_NLOAD, 0, "  1"},//5
    {TC_TYPE_ORDER_OZON, TC_LOCALITY_BUSAEVO, {144.481414,383.239746,15.635400}, TC_ORDER_NLOAD, 0, "  4"},//6
    {TC_TYPE_ORDER_PETROL, TC_LOCALITY_BUSAEVO, {2273.441162,-704.361145,13.17}, TC_ORDER_NLOAD, 0, " 1"},//7
    {TC_TYPE_ORDER_PETROL, TC_LOCALITY_BUSAEVO, {2746.985351,730.965515,30.781}, TC_ORDER_NLOAD, 0, " 2"},//8
    {TC_TYPE_ORDER_PRODUCTS, TC_LOCALITY_BUSAEVO, {2329.867675,-1923.195190,21.90}, TC_ORDER_NLOAD, 0, "  1"},//9
    {TC_TYPE_ORDER_PRODUCTS, TC_LOCALITY_BUSAEVO, {-508.971923,-1560.070434,41.18}, TC_ORDER_NLOAD, 0, "  2"},//10
    {TC_TYPE_ORDER_PRODUCTS, TC_LOCALITY_BUSAEVO, {100.912979,816.841613,12.01930}, TC_ORDER_NLOAD, 0, "  3"},//11
    {TC_TYPE_ORDER_TECHNOLOGY, TC_LOCALITY_BUSAEVO, {-2437.050781,-172.995223,27.44}, TC_ORDER_NLOAD, 0, " \".\""},//12
    {TC_TYPE_ORDER_TECHNOLOGY, TC_LOCALITY_BUSAEVO, {-2476.282226,2772.179199,37.43}, TC_ORDER_NLOAD, 0, "  \".\""},//13
    {TC_TYPE_ORDER_GLASS, TC_LOCALITY_BUSAEVO, {-2210.867187,-415.374481,29.209861}, TC_ORDER_NLOAD, 0, "  \".\""},//14
    {TC_TYPE_ORDER_GLASS, TC_LOCALITY_BUSAEVO, {-24.590059,1805.262939,9.197439}, TC_ORDER_NLOAD, 0, "  \".\""},//15
    {TC_TYPE_ORDER_GLASS, TC_LOCALITY_BUSAEVO, {598.226501,1757.621826,11.861831}, TC_ORDER_NLOAD, 0, " "},//16
    {TC_TYPE_ORDER_BANANS, TC_LOCALITY_BUSAEVO, {-2420.096923,-263.920196,26.99}, TC_ORDER_NLOAD, 0, " \".\""},//17
    {TC_TYPE_ORDER_BANANS, TC_LOCALITY_BUSAEVO, {568.488647,947.387084,11.64748}, TC_ORDER_NLOAD, 0, "  \".\""},//18
    {TC_TYPE_ORDER_WATERMELON, TC_LOCALITY_BUSAEVO, {-2639.756835,2879.549072,37.632}, TC_ORDER_NLOAD, 0, " "},//19
    {TC_TYPE_ORDER_COAL,  TC_LOCALITY_BATUREVO, {-995.730895,2151.722656,44.348934}, TC_ORDER_NLOAD, 0, " \".\""},//20
    {TC_TYPE_ORDER_COAL,  TC_LOCALITY_BATUREVO, {598.226501,1757.621826,11.861831}, TC_ORDER_NLOAD, 0, " "},//21
    {TC_TYPE_ORDER_METAL, TC_LOCALITY_BATUREVO, {-24.590059,1805.262939,9.197439}, TC_ORDER_NLOAD, 0, "  \".\""},//22
    {TC_TYPE_ORDER_METAL, TC_LOCALITY_BATUREVO, {2058.106445,-2604.110351,10.619886}, TC_ORDER_NLOAD, 0, " \".\""},//23
    {TC_TYPE_ORDER_METAL, TC_LOCALITY_BATUREVO, {-2435.133789,2712.665527,39.636734}, TC_ORDER_NLOAD, 0, " \".\""},//24
    {TC_TYPE_ORDER_OZON,  TC_LOCALITY_BATUREVO, {-2399.693603,-0.686437,25.999822}, TC_ORDER_NLOAD, 0, "  2"},//25
    {TC_TYPE_ORDER_OZON,  TC_LOCALITY_BATUREVO, {676.783447,273.557373,12.856797}, TC_ORDER_NLOAD, 0, "  3"},//26
    {TC_TYPE_ORDER_PETROL,  TC_LOCALITY_BATUREVO, {2606.705078,2578.849121,16.18}, TC_ORDER_NLOAD, 0, " 3"},//27
    {TC_TYPE_ORDER_PETROL,  TC_LOCALITY_BATUREVO, {-2503.146972,-693.505493,29.3}, TC_ORDER_NLOAD, 0, " 4"},//28
    {TC_TYPE_ORDER_PRODUCTS,  TC_LOCALITY_BATUREVO, {-15.615036,954.794677,11.682}, TC_ORDER_NLOAD, 0, "  5"},//29
    {TC_TYPE_ORDER_PRODUCTS,  TC_LOCALITY_BATUREVO, {409.448211,1940.463623,8.148}, TC_ORDER_NLOAD, 0, "  4"},//30
    {TC_TYPE_ORDER_PRODUCTS,  TC_LOCALITY_BATUREVO, {-1738.667602,764.833312,35.3}, TC_ORDER_NLOAD, 0, "  6"},//31
    {TC_TYPE_ORDER_TECHNOLOGY, TC_LOCALITY_BATUREVO, {2721.642089,-1630.229980,23.10}, TC_ORDER_NLOAD, 0, " \"  Welsi Studio\""},//32
    {TC_TYPE_ORDER_TECHNOLOGY, TC_LOCALITY_BATUREVO, {225.049224,375.714019,15.59920}, TC_ORDER_NLOAD, 0, "  \".\""},//33
    {TC_TYPE_ORDER_GLASS,  TC_LOCALITY_BATUREVO, {-2210.867187,-415.374481,29.209861}, TC_ORDER_NLOAD, 0, "  \".\""},//34
    {TC_TYPE_ORDER_GLASS,  TC_LOCALITY_BATUREVO, {-24.590059,1805.262939,9.197439}, TC_ORDER_NLOAD, 0, "  \".\""},//35
    {TC_TYPE_ORDER_GLASS,  TC_LOCALITY_BATUREVO, {598.226501,1757.621826,11.861831}, TC_ORDER_NLOAD, 0, " "},//36
    {TC_TYPE_ORDER_BANANS,  TC_LOCALITY_BATUREVO, {134.547683,610.323303,11.58130}, TC_ORDER_NLOAD, 0, " \".\""},//37
    {TC_TYPE_ORDER_BANANS,  TC_LOCALITY_BATUREVO, {-2420.196289,-238.634353,26.99}, TC_ORDER_NLOAD, 0, " \".\""},//38
    {TC_TYPE_ORDER_WATERMELON, TC_LOCALITY_BATUREVO, {-2534.645263,1749.024536,53.025}, TC_ORDER_NLOAD, 0, " "}//39
};
...
stock GivePlayerExpTC(playerid, count)
{
    ...
    {
        new message[144];
        format(message, sizeof message, ""tc_msg"  {FFAE00}%d{FFFFFF} (a) .", count);
        SendClientMessage(playerid, -1, message);

        if(level_up) {
            format(message, sizeof message, ""tc_msg"!   {FFAE00}%d{FFFFFF}  .   ",
            player_tc[playerid][p_TC_Level]);
            SendClientMessage(playerid, -1, message);
        }

        format(message, sizeof message, ""tc_msg"     {FFAE00}%d{FFFFFF}   {FFAE00}%d{FFFFFF}  .",
...
public SYS_TRANSPORT_COMPANY_OnPlayerConnect(playerid)
{
...
#if defined _ALS_SYS_TRANSPORT_COMPANY_OnPlayerConnect
    #undef SYS_TRANSPORT_COMPANY_OnPlayerConnect
#else
    #define _ALS_SYS_TRANSPORT_COMPANY_OnPlayerConnect
#endif
#define SYS_TRANSPORT_COMPANY_OnPlayerConnect tc_OnPlayerConnect
#if defined tc_OnPlayerConnect
    forward tc_OnPlayerConnect(playerid);
#endif

public SYS_TRANSPORT_COMPANY_OnPlayerEnterDynamicArea(playerid, areaid)
{
    ...
    if(areaid == player_tc[playerid][p_TC_Sphere_Finish])
    {
        if(player_tc[playerid][p_TC_Progress_Order] && player_tc[playerid][p_TC_Order] != -1)
        {
            ...
            if(vehicle != player_tc[playerid][p_TC_Truck])
                return SendClientMessage(playerid, -1, ""tc_msg"      .");
            ...
            switch(player_tc[playerid][p_TC_Progress_Order])
            {
                case 2:
                {       
                    GameTextForPlayer(playerid, "~y~...~n~ ", 4000, 3);
   ...
   #if defined _ALS_SYS_TRANSPORT_COMPANY_OnPlayerEnterDynamicArea
    #undef SYS_TRANSPORT_COMPANY_OnPlayerEnterDynamicArea
#else
    #define _ALS_SYS_TRANSPORT_COMPANY_OnPlayerEnterDynamicArea
#endif
#define SYS_TRANSPORT_COMPANY_OnPlayerEnterDynamicArea tc_OnPlayerEnterDynamicArea
#if defined tc_OnPlayerEnterDynamicArea
...
//A  : https://t.me/welsistudio
//  : https://t.me/welsistudio
public SYS_TRANSPORT_COMPANY_OnGameModeInit()
{
    print("[LAIRD_SYSTEM]    .");
    ...
    for(new i, string[114];i < 2;i++)
    {
        ...
        Create3DTextLabel(""tc_msg"\n  ", -1, coord_tcompany[i][0], coord_tcompany[i][1], coord_tcompany[i][2], 10.0, 0);
        ...
        Create3DTextLabel(""tc_msg"\n  ", -1, coord_tcompany_exit[0], coord_tcompany_exit[1], coord_tcompany_exit[2], 10.0, i+1);
    ...
    CreateActorEx(" ", "{828282}  ..", 228, -2639.756835,2879.549072,37.632812,177.616, 0, 0);
    CreateActorEx("", "{828282}:\n    ? (   )", 89, -2534.645263,1749.024536,53.025150,299.114, 0, 0);
    ...
    SetTimer("UpdateOrderTC", 2000*60, true); //  2  ( 2000  3000    3 )
   ...
   #if defined _ALS_SYS_TRANSPORT_COMPANY_OnGameModeInit
    #undef SYS_TRANSPORT_COMPANY_OnGameModeInit
#else
    #define _ALS_SYS_TRANSPORT_COMPANY_OnGameModeInit
#endif
#define SYS_TRANSPORT_COMPANY_OnGameModeInit tc_OnGameModeInit
#if defined tc_OnGameModeInit
    forward tc_OnGameModeInit();
#endif

public SYS_TRANSPORT_COMPANY_OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    if(dialogid == 2902)
    {
        ...
        if(player_level >= level) { format(level_txt, sizeof level_txt, "   {FFAE00}{FFFFFF}   "); SetPVarInt(playerid, "dostup_order", 0); }
        else { format(level_txt, sizeof level_txt, "   {FFAE00} {FFFFFF}   "); SetPVarInt(playerid, "dostup_order", 1); }

    
        if(player_level > 10){
            format(salary_txt, sizeof salary_txt, "\n{FFFFFF}   {FFAE00}%d{FFFFFF}  (  {FFAE00}{FFFFFF})", GetPlayerIncreaseTC(playerid));
        ...
        format(
            ...
            {FFFFFF}  : {FFAE00}%d\n\n\
            {FFFFFF}%s\n\n\
            {FFFFFF}  : {FFAE00}%d %s", name_order_TC[orders_tc[id][o_TC_Type]-1],
    ...
    if(dialogid == 2903)
    {
        if(!response)
        {
            ...
            if(GetPVarInt(playerid, "dostup_order")) return
                SendClientMessage(playerid, -1, ""tc_msg"       .");
            ...
            player_tc[playerid][p_TC_Text] = CreateDynamic3DTextLabel("{FFAE00} \n{FFFFFF}   ", -1,
...
#if defined _ALS_SYS_TRANSPORT_COMPANY_OnDialogResponse
#undef SYS_TRANSPORT_COMPANY_OnDialogResponse
#else
#define _ALS_SYS_TRANSPORT_COMPANY_OnDialogResponse
#endif
#define SYS_TRANSPORT_COMPANY_OnDialogResponse tc_OnDialogResponse
#if defined tc_OnDialogResponse
...
public SYS_TRANSPORT_COMPANY_OnPlayerSpawn(playerid)
{
    DefaultPlayerOrder(playerid);
...
#if defined _ALS_SYS_TRANSPORT_COMPANY_OnPlayerSpawn
    #undef SYS_TRANSPORT_COMPANY_OnPlayerSpawn
#else
    #define _ALS_SYS_TRANSPORT_COMPANY_OnPlayerSpawn
#endif
#define SYS_TRANSPORT_COMPANY_OnPlayerSpawn tc_OnPlayerSpawn
#if defined tc_OnPlayerSpawn
...
public:LoadTrailerTC(playerid)
{
    ...
    switch(player_tc[playerid][p_TC_Progress_Order])
    {
        ...
        case 3:{
            ...
            format(string, sizeof string, ""tc_msg"  {FFAE00}%d {FFFFFF}.   .", salary);
...
public SYS_TRANSPORT_COMPANY_OnTrailerUpdate(playerid, vehicleid)
{
...
#if defined _ALS_SYS_TRANSPORT_COMPANY_OnTrailerUpdate
    #undef SYS_TRANSPORT_COMPANY_OnTrailerUpdate
#else
    #define _ALS_SYS_TRANSPORT_COMPANY_OnTrailerUpdate
#endif
#define SYS_TRANSPORT_COMPANY_OnTrailerUpdate tc_OnTrailerUpdate
#if defined tc_OnTrailerUpdate
    forward tc_OnTrailerUpdate(playerid, vehicleid);
#endif
//A  : https://t.me/welsistudio
//  : https://t.me/welsistudio
public SYS_TRANSPORT_COMPANY_OnPlayerEnterCheckpoint(playerid)
{ 
   ...
   #if defined _ALS_SYS_TRANSPORT_COMPANY_OnPlayerEnterCheckpoint
    #undef SYS_TRANSPORT_COMPANY_OnPlayerEnterCheckpoint
#else
    #define _ALS_SYS_TRANSPORT_COMPANY_OnPlayerEnterCheckpoint
#endif
#define SYS_TRANSPORT_COMPANY_OnPlayerEnterCheckpoint tc_OnPlayerEnterCheckpoint
#if defined tc_OnPlayerEnterCheckpoint
...
public:UpdateOrderTC()
{
    ...
    {
        print("[LAIRD_SYSTEM]     :");
        printf("[LAIRD_SYSTEM] %d    %d  ", order[0], order[1]);
    }
...
CMD:tcstats(playerid)
{
    ...
    if(player_tc[playerid][p_TC_Level] > 10)
    {
        ...
        format(lvl_text, sizeof lvl_text, "\n  {FFAE00}  {FFFFFF}( ).\n\
           {FFAE00}   {FFFFFF}   {FFAE00}%d {FFFFFF}\n\
        :    500.000 .   {FFAE00}%d {FFFFFF}.", GetPlayerIncreaseTC(playerid), salary);

    }

    format(string, sizeof string, 
    "  :{FFAE00}%d {FFFFFF}\n\
      :{FFAE00}%d{FFFFFF}/{FFAE00}100 {FFFFFF}\n\
        {FFAE00}%d {FFFFFF}.\n%s", player_tc[playerid][p_TC_Level], 
    player_tc[playerid][p_TC_Exp], 100-player_tc[playerid][p_TC_Exp], lvl_text);

    Dialog(playerid,-1, DIALOG_STYLE_MSGBOX, "{FFAE00} ", string, "", "");
    return 1;
}

stock ShowDialogOrders(playerid, Locality)
{
    if(player_tc[playerid][p_TC_Order] != -1) return SendClientMessage(playerid, -1, ""tc_msg"   ");
        if(GetPlayerLevel(playerid) < LEVEL_START_TC){
        new string[124];
        format(string, sizeof string, ""tc_msg"      {FFAE00}%d {FFFFFF}", LEVEL_START_TC);
        SendClientMessage(playerid, -1, string);
    }

    new stroka[56], dialog[sizeof stroka * 20 + 56] = {"{FFFFFF}\t{FFFFFF}  \n"}, order_open;
    ...
    for(new i, listitem = 1;i < sizeof orders_tc;i++)
    {
        ...
        format(stroka, sizeof stroka, "{FFFFFF}%s\t{FFAE00}%d{FFFFFF} \n", name_order_TC[orders_tc[i][o_TC_Type]-1], orders_tc[i][o_TC_Salary]);
        strcat(dialog, stroka);
        SetPlayerListitemValue(playerid, listitem, i);
        listitem++;
    } 

    DialogTruck(playerid, 2902, DIALOG_STYLE_LIST, "{FFAE00}  ", dialog, "", "");
    return 1;
}

CMD:setlvltc(playerid, params[])
{
	if(GetPlayerAdminEx(playerid) >= 4) // 6 -       ?
	{
		if(!strlen(params))
		return SendClientMessage(playerid, 0x999999FF, ": /setlvltc [id ] [ ]");
		...
		format(text, sizeof text, ""tc_msg"     %s .    %d  ", GetPlayerNameEx(to_player), lvl);
		SendClientMessage(playerid, -1, text);
		format(text, sizeof text, ""tc_msg"  %s     %d", GetPlayerNameEx(playerid), lvl);
