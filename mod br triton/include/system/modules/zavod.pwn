...
public SYS_ZAVOD_OnGameModeInit() {
    f_enter_pickup = CreatePickup(19132, 23, -978.7820, 2070.2219, 45.3795, -1);
    f_exit_pickup = CreatePickup(19132, 23, -31.8808, -3.9729, 1381.0601, -1);
...
public SYS_ZAVOD_OnPlayerPickUpPickupEx(playerid, pickupid, action_type, action_id) {
...
public SYS_ZAVOD_OnPlayerUpdate(playerid) {
...
#if defined _ALS_SYS_ZAVOD_OnGameModeInit
    #undef SYS_ZAVOD_OnGameModeInit
#else
    #define _ALS_SYS_ZAVOD_OnGameModeInit
#endif
#define SYS_ZAVOD_OnGameModeInit F_OnGameModeInit
#if defined F_OnGameModeInit
    forward F_OnGameModeInit();
#endif

#if defined _ALS_SYS_ZAVOD_OnPlayerPickUpPickupEx
    #undef SYS_ZAVOD_OnPlayerPickUpPickupEx
#else
    #define _ALS_SYS_ZAVOD_OnPlayerPickUpPickupEx
#endif
#define SYS_ZAVOD_OnPlayerPickUpPickupEx F_OnPlayerPickUpPickupEx
#if defined F_OnPlayerPickUpPickupEx
    forward F_OnPlayerPickUpPickupEx(playerid, pickupid, action_type, action_id);
#endif

#if defined _ALS_SYS_ZAVOD_OnPlayerUpdate
    #undef SYS_ZAVOD_OnPlayerUpdate
#else
    #define _ALS_SYS_ZAVOD_OnPlayerUpdate
#endif
#define SYS_ZAVOD_OnPlayerUpdate F_OnPlayerUpdate
#if defined F_OnPlayerUpdate
