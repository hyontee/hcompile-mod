...
for(new i = 0; i < sizeof(yg_areas); i++)
   ...
   #if defined _ALS_SYS_VODO_OnPlayerEnterDynamicArea
    #undef SYS_VODO_OnPlayerEnterDynamicArea
#else
    #define _ALS_SYS_VODO_OnPlayerEnterDynamicArea
#endif
#define SYS_VODO_OnPlayerEnterDynamicArea vodo_OnPlayerEnterDynamicArea
#if defined vodo_OnPlayerEnterDynamicArea
...
if(GetPlayerLevel(playerid)<18) return ShowNotificationLaird(playerid, 2, 6, 0, 0, "   18 !", "");
ShowPlayerDialog(playerid, 58901, DIALOG_STYLE_LIST, "{ed4b00} ", "{ed4b00}1.{fff7fc}  \t\t\t\t{dbd5d9}  \n{ed4b00}2.{fff7fc}   \t\t\t\t{dbd5d9}  \n{ed4b00}3.{fff7fc}    \t\t\t\t{dbd5d9}  ","","");
}
/*
