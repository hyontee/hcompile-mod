...
{//цена в тысячах
    ...
    {"Audi RS6 дорест",   10000000,     8000,   1, 310, 4},     // 405
    {"ЗИЛ 131 Самосвал",    0,          0,      0},     // 406
    {"Пожарка",             0,          0,      0},     // 407
    {"Мусоровоз",           0,          0,      0},     // 408
    {"Лимузин",              0,   50000, 2},     // 409
    {"Mercedes-Benz C63s AMG",  6200000,     7800,   1, 278, 3.9},     // 410
    ...
    {"Икарус",              0,          0,      0},     // 437
    {"GAZ Volga hellowen 2053",               3000000,          0,      0},     // 438
    ...
    {"Push Pinzgauer 710k",      1200000,    20000,  0},     // 573
    ...
    {"RCcam",               0,          0,      0},     // 594
    {"Launch",              0,          0,      0},     // 595
    {"BMW M5 F90",             50000000,          0,      0},     // 596
    {"Vaz 2172",             20000000,          0,      0},     // 597
    {"Volkswagen Jetta",             35000000,          0,      0},     // 598
    {"samp мил",             0,          0,      0},     // 599
    ...
    {"Tesla Model X",             21000000,    0,  2, 351, 3}     // 2543    
};
