...
public OnGameModeInit()
{
    ...
    g_SQLHandle = mysql_connect(MYSQL_HOST, MYSQL_USER, MYSQL_DB, MYSQL_PASS);
...
// Возвращаем имя через dest — Pawn не умеет возвращать массивы
stock GetPlayerLevelName(playerid, dest[], size = sizeof(dest))
{
    format(dest, size, "%s", g_AdminLevelNames[gPlayerData[