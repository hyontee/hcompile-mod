...
public SummerEvent_Init()
{
    return 1;
}

public SummerEvent_OnPlayerConnect(playerid)
{
    #pragma unused playerid
    return 1;
}

public SummerEvent_OnPlayerDisconnect(playerid, reason)
{
    #pragma unused playerid, reason
    return 1;
}

public SummerEvent_OnPlayerDeath(playerid, killerid, reason)
{
    #pragma unused playerid, killerid, reason
    return 1;
}

public SummerEvent_OnPlayerUpdate(playerid)
{
    #pragma unused playerid
    return 1;
}

public SummerEvent_OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    #pragma unused playerid, dialogid, response, listitem, inputtext
    return 0;
}

public Admin_AuthorizationComplete(playerid)
{
    #pragma unused playerid
    return 1;
}

public Admin_OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    #pragma unused playerid, dialogid, response, listitem, inputtext
    return 0;
}
...
{
    new level = gPlayerData[playerid][pAdmin];
    if(le