...
{   
    for(new i;i < sizeof(fam_TD);i++)
    {
        ...
        fam_TD[i][2] = TextDrawCreate(10.3332, 252.2221, "Ochki vashi:"); // пусто
        ...
        fam_TD[i][3] = TextDrawCreate(10.3332, 266.7406, "Lider:"); // пусто
        ...
        fam_TD[i][7] = TextDrawCreate(40.6666, 284.9925, "TIME:");
