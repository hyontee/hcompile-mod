...
{
    WorkkTextDraw = TextDrawCreate(10.0, 440.0, "REAL ONLINE Build 1.15.5 - ");
...
public UpdateWorkkText(playerid)
{
    ...
    new text[128];
    format(text, sizeof(text), "Turn Russia Build 1.15.5 Time - %02d:%02d:%02d - Player Name  (%d)%s", hour, minute, second, playerid, playerName);
