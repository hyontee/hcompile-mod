...
stock UpdateGarages(garageid)
{
 ...
 SetGarageData(garageid, G_ENTER_PICKUP, CreatePickup(19134, 23, GetGarageData(garageid, GARAGE_X), GetGarageData(garageid, GARAGE_Y), GetGarageData(garageid, GARAGE_Z), 0, PICKUP_ACTION_TYPE_GARAGE, garageid));
}
 ...
 new garageid = GetPlayerGarage(playerid);
  ...
  if(USE_ZOMENO_OLD_ENGINE == 0)
   ...
   GivePlayerMoneyEx(playerid, -5000000);
     ...
     {
         ShowNotificationNew(playerid, 3, 5, 1, 10, "  !", "");
            GivePlayerMoneyEx(playerid, -5000000);
        }
     }
      else 
