...
stock AirDrop()
{
    ...
    {
        air_obj[a] = CreateDynamicObject(1271, airdrop[a][AIR_X], airdrop[a][AIR_Y], airdrop[a][AIR_Z] - 0.6, 0.0, 0.0, 0.0);
...
{
    if(id_air < 0 || id_air >= MAX_AIRDROP) return 0;
