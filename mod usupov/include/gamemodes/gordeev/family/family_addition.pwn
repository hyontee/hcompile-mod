...
cmd:loadfamily(playerid)
{
    ...
    new player_fam_sql = GetPlayerFamily(playerid, ID_SQL_FAMILY);
if(vehicleid == INVALID_VEHICLE_ID || GetCarFamily(action, CAR_F_database) == -1 || GetCarFamily(action, OW_F_database) != player_fam_sql)
