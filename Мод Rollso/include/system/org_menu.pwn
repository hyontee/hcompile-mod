...
new const g_org_right_name[ORG_RIGHT_NUM][40] =
{
	"Повышать в звании",
	"Понижать в звании",
...
new g_orgm_target_acc[MAX_PLAYERS];              // id аккаунта выбранного сотрудника
new g_orgm_target_online[MAX_PLAYERS];            // playerid, если сотрудник онлайн, иначе INVALID_PLAYER_ID
new g_orgm_target_name[MAX_PLAYERS][MAX_PLAYER_NAME];
new g_orgm_target_rang[MAX_PLAYERS];
new g_orgm_edit_rang[MAX_PLAYERS];                // ранг, права которого сейчас настраивает лидер
new g_orgm_list_acc[MAX_PLAYERS][100];            // соответствие "строка списка" -> account_id
new g_orgm_list_name[MAX_PLAYERS][100][MAX_PLAYER_NAME];
new g_orgm_list_rang[MAX_PLAYERS][100];
new g_orgm_list_count[MAX_PLAYERS];               // сколько реально строк в последнем списке
