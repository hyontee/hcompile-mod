...
forward LoadGarageSystem(500);//загрузка системы гаражей
forward UnloadGarageSystem(500);//выгрузка системы гаражей
forward CarTest(carpl);//определение запрещённого транспорта
forward CarGarageDel(500);//таймер ТП запрещённого транспорта из гаража
...
#endif
new RealName[500][MAX_PLAYER_NAME];//реальный ник игрока
...
new garagecost2[500000];//стоимость гаража (текущая)
new garagelock[1];//0- гараж открыт, 1- гараж закрыт
new garagevwin[1];//виртуальный мир входного пикапа в гараж
new garageintin[1];//интерьер входного пикапа в гараж
new Float:garagecordxin[1];//координаты входного пикапа в гараж
new Float:garagecordyin[1];
new Float:garagecordzin[1];
new Float:garageanglein[1];//угол выхода из гаража
new Float:garagecordx[1];//координаты спавна транспорта в гараже
