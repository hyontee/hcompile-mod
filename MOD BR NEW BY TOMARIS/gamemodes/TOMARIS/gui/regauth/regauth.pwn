    ...
    switch(t)
    {
        case -1:
                ...
                case 1:
                {
                    ...
                    {
                        ShowNotificationKirill(playerid, 2, 5, -1, -1, "Пароль должен быть от 6 до 32 символов", "");
                        JSON_Cleanup(JSONObject);
                        return 1;
                    }
        ...
        case 3:
                {
                    ...
                    {
                        ShowNotificationKirill(playerid, 2, 5, -1, -1, "Ошибка создания аккаунта!", "");
                        Kick(playerid);
                    }
        ...
        case 4:
                {
                    ...
                    {
                        ShowNotificationKirill(playerid, 2, 5, -1, -1, "Указанный Nick-Name не найден!", "");
                        JSON_Cleanup(JSONObject);
                        JSON_Cleanup(json);
                        return;
                    }
        ...
        case 6:
                {
                    ...
                    {
                        ShowNotificationKirill(playerid, 2, 5, -1, -1, "Неверный пароль!", "");
                    }
