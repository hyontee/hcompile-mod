...
stock TCompany_BuyTruckFromSalon(playerid, marketid, ownablecar)
{
    ...
    if(!(color_1 >= 0 && color_1 <= MAX_COLOR_ID)) color_1 = GetPlayerData(playerid, P_AUTOSALON_COLOR1);
    if(!(color_2 >= 0 && color_2 <= MAX_COLOR_ID)) color_2 = GetPlayerData(playerid, P_AUTOSALON_COLOR2);
