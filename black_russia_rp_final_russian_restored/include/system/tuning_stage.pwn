...
public OnGameModeInit()
{
    ...
    CreateTextDrawStage();
    // 3D-текст техцентра создаётся в основном OnGameModeInit, чтобы не было двойной надписи.
...
stock SetVehicleStage(vehicle, stage)
{
    ...
    switch(stage)
    {
        ...
        case 1:
        {
            ...
            if(0.8 <= setting_vehicle[model][V_TRACTION_LOSS] && setting_vehicle[model][V_TRACTION_LOSS] <= 0.9) SetVehicleTractionLoss  (vehicle, setting_vehicle[model][V_TRACTION_LOSS]+0.05); 
            else if(0.7 <= setting_vehicle[model][V_TRACTION_LOSS] && setting_vehicle[model][V_TRACTION_LOSS] <= 0.8) SetVehicleTractionLoss(vehicle, setting_vehicle[model][V_TRACTION_LOSS]+0.09);  

            if(0.6 <= setting_vehicle[model][V_TRACTION_BIAS] && setting_vehicle[model][V_TRACTION_BIAS] <= 0.65) SetVehicleTractionBias  (vehicle, setting_vehicle[model][V_TRACTION_BIAS]-0.02); 
            else if(0.4 <= setting_vehicle[model][V_TRACTION_BIAS] && setting_vehicle[model][V_TRACTION_BIAS] <= 0.5)SetVehicleTractionBias  (vehicle, setting_vehicle[model][V_TRACTION_BIAS]+0.02);   
        ...
        case 2:
        {
            ...
            if(0.8 <= setting_vehicle[model][V_TRACTION_LOSS] && setting_vehicle[model][V_TRACTION_LOSS] <= 0.9) SetVehicleTractionLoss  (vehicle, setting_vehicle[model][V_TRACTION_LOSS]+0.05); 
            else if(0.7 <= setting_vehicle[model][V_TRACTION_LOSS] && setting_vehicle[model][V_TRACTION_LOSS] <= 0.8) SetVehicleTractionLoss(vehicle, setting_vehicle[model][V_TRACTION_LOSS]+0.1);  

            if(0.6 <= setting_vehicle[model][V_TRACTION_BIAS] && setting_vehicle[model][V_TRACTION_BIAS] <= 0.65) SetVehicleTractionBias  (vehicle, setting_vehicle[model][V_TRACTION_BIAS]-0.03); 
            else if(0.4 <= setting_vehicle[model][V_TRACTION_BIAS] && setting_vehicle[model][V_TRACTION_BIAS] <= 0.5)SetVehicleTractionBias  (vehicle, setting_vehicle[model][V_TRACTION_BIAS]+0.03);  
        ...
        case 3:
        {
            ...
            if(0.8 <= setting_vehicle[model][V_TRACTION_LOSS] && setting_vehicle[model][V_TRACTION_LOSS] <= 0.9) SetVehicleTractionLoss  (vehicle, setting_vehicle[model][V_TRACTION_LOSS]+0.07); 
            else if(0.7 <= setting_vehicle[model][V_TRACTION_LOSS] && setting_vehicle[model][V_TRACTION_LOSS] <= 0.8) SetVehicleTractionLoss(vehicle, setting_vehicle[model][V_TRACTION_LOSS]+0.12);  
            
            if(0.6 <= setting_vehicle[model][V_TRACTION_BIAS] && setting_vehicle[model][V_TRACTION_BIAS] <= 0.65) SetVehicleTractionBias  (vehicle, setting_vehicle[model][V_TRACTION_BIAS]-0.05); 
            else if(0.4 <= setting_vehicle[model][V_TRACTION_BIAS] && setting_vehicle[model][V_TRACTION_BIAS] <= 0.5)SetVehicleTractionBias  (vehicle, setting_vehicle[model][V_TRACTION_BIAS]+0.05);  
        ...
        case 4:
        {
            ...
            if(0.8 <= setting_vehicle[model][V_TRACTION_LOSS] && setting_vehicle[model][V_TRACTION_LOSS] <= 0.9) SetVehicleTractionLoss  (vehicle, setting_vehicle[model][V_TRACTION_LOSS]-0.5); 
            else if(0.7 <= setting_vehicle[model][V_TRACTION_LOSS] && setting_vehicle[model][V_TRACTION_LOSS] <= 0.8) SetVehicleTractionLoss(vehicle, setting_vehicle[model][V_TRACTION_LOSS]-0.3);  
            
            if(0.6 <= setting_vehicle[model][V_TRACTION_BIAS] && setting_vehicle[model][V_TRACTION_BIAS] <= 0.65) SetVehicleTractionBias  (vehicle, setting_vehicle[model][V_TRACTION_BIAS]+0.05); 
            else if(0.4 <= setting_vehicle[model][V_TRACTION_BIAS] && setting_vehicle[model][V_TRACTION_BIAS] <= 0.5)SetVehicleTractionBias  (vehicle, setting_vehicle[model][V_TRACTION_BIAS]+0.15);  
...
public OnPlayerClickTextDraw(playerid, Text:clickedid)
{
    ...
    if(clickedid == stg_TD[3])
    {
        ...
        if(1 <= player_select_stage[playerid] && player_select_stage[playerid] <= 4) 
        {
...
stock ShowPanelStage(playerid, panel)
{
    ...
    {
        if(1 <= default_c[w] && default_c[w] <= 10) format(text_default, sizeof text_default, "txd:brtuning2stage%d", default_c[w]);
        else format(text_default, sizeof text_default, "txd:brtuning2stage10");

        if(1 <= after[w] && after[w] <= 10) format(text_after, sizeof text_after, "txd:brtuning4lstage%d", after[w]);
...
/*stock ShowPanelStage(playerid, panel)
{
    ...
    for(new e, Float:rabotay_suka, text[24], dotext[24], default_s, after; e < 4; e++)
    {
        ...
        if(after >= 1 && after <= 10) format(text, sizeof text, "txd:brtuning2stage%d", after);
        else format(text, sizeof text, "txd:brtuning2stage10");
        strcat(text_after[e], text);
        if(default_s >= 1 && default_s <= 10) format(dotext, sizeof dotext, "txd:brtuning4lstage%d", default_s);
