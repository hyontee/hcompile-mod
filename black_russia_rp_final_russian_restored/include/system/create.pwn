...
{
   print("[LAIRD_SYSTEM] Помощник в создании загружен");
...
{
   if(l_create[0][H_ID_NET] <= areaid && areaid <= l_create[sizeof l_create - 1][H_ID_NET])
   {
      new text[35], id;
