...
{
    welsi_tun_TD[1] = TextDrawCreate(484.6665, 150.4369, "txd:brtuning2service"); // 
    ...
    welsi_tun_TD[2] = TextDrawCreate(186.3332, 389.7853, "txd:brtuning3cost"); // 
    ...
    welsi_tun_TD[0] = TextDrawCreate(580.9998, 2.0888, "t.me/welsistudio"); // 
    welsi_tun_TD[3] = TextDrawCreate(186.9998, 419.6520, "txd:brtuning2buy"); // 
    ...
    welsi_tun_TD[4] = TextDrawCreate(334.6665, 419.6520, "txd:brtuning2exit"); // 
...
{
    welsi_tun_PTD[playerid][0] = CreatePlayerTextDraw(playerid, 503.0000, 165.1257, "txd:brtuning3m11"); // 
    ...
    welsi_tun_PTD[playerid][1] = CreatePlayerTextDraw(playerid, 503.0000, 203.2888, "txd:brtuning3m12"); // 
    ...
    welsi_tun_PTD[playerid][2] = CreatePlayerTextDraw(playerid, 503.0000, 241.0368, "txd:brtuning3m13"); // 
    ...
    welsi_tun_PTD[playerid][3] = CreatePlayerTextDraw(playerid, 503.0000, 278.7850, "txd:brtuning3m19"); // 
    ...
    welsi_tun_PTD[playerid][4] = CreatePlayerTextDraw(playerid, 186.3332, 357.8445, "txd:brtuning3noklirens"); // 
    ...
    welsi_tun_PTD[playerid][5] = CreatePlayerTextDraw(playerid, 3.0000, 181.1333, "txd:brtuning3oklirens"); // 
    ...
    welsi_tun_PTD[playerid][7] = CreatePlayerTextDraw(playerid, 80.0000, 241.1925, "0.5"); // 
    ...
    welsi_tun_PTD[playerid][6] = CreatePlayerTextDraw(playerid, 18.3332, 240.8666, "txd:brtuning2stage1"); // 
    ...
    welsi_tun_PTD[playerid][8] = CreatePlayerTextDraw(playerid, 385.6666, 395.3333, "10000_PY"); // 
    ...
    welsi_tun_PTD[playerid][9] = CreatePlayerTextDraw(playerid,87.6666, 258.7034, "txd:brtuning2plus"); // 
    ...
    welsi_tun_PTD[playerid][10] = CreatePlayerTextDraw(playerid,18.3332, 259.1184, "txd:brtuning2minus"); // 
...
public OnPlayerClickTextDraw(playerid, Text:clickedid)
{
    if(clickedid == welsi_tun_TD[3])
    {
        ...
        if(GetPlayerMoneyEx(playerid) >= price)
        {
            ...
            PlayerTextDrawSetString(playerid, welsi_tun_PTD[playerid][8], "0000_");
...
public OnPlayerClickPlayerTextDraw(playerid, PlayerText:playertextid)
{
    ...
    if(playertextid == welsi_tun_PTD[playerid][9])
    {
        ...
        format(string, sizeof string, "%d000_", player_wheel_panel[playerid][tun_sct_param]);
