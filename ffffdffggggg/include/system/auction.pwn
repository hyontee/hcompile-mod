...
#define AUCTION_STATE_DURATION      (12 * 60 * 60)
...
new gAuctionServiceBiz[6] = {-1, -1, -1, -1, -1, -1};
...
new auction_button[8][2][20] =
{
    ...
    {"txd:braucnubuy", "txd:braucubuy"}, //������
    {"txd:braucnusell", "txd:braucusell"}, //�������
    {"txd:braucnumy", "txd:braucumy"}, //������� ���
    {"txd:braucnutip", "txd:braucutip"}, //��� ������
    {"txd:braucnutovar", "txd:braucutovar"}, //����� ������
    {"txd:braucnuopisanie", "txd:braucuopisanie"}, //�������� ������
    {"txd:braucnucost", "txd:braucucost"} //���� ������
};
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    if(dialogid == 5990)
    {
        ...
        if(rate < min_rate)
            return SendClientMessage(playerid, -1, ""SC" ���� ������ ������ ���� ���� ����������� ������ �� ���.");
    ...
    if(dialogid == 5991)
    {
        ...
        switch(GetPVarInt(playerid, "select_param"))
        {
            ...
            case 2: // opisanie
            {
                //if(!inputtext) return SendClientMessage(playerid, -1, ""USC" ������ ��������� �������� ������");
            ...
            case 3://price
            {
                ...
                if(price >= 1_000_000_001 || price <= 4_999) return SendClientMessage(playerid, -1, ""USC" ������� ����� �� 5000 ��� �� 1000000000 ���");
        ...
        switch(GetPVarInt(playerid, "type_param"))
        {
            case TYPE_VEHICLE_NUMBER, TYPE_SUM_NUMBER, TYPE_CLOTHES, TYPE_ACCESSORY:
            {
                if(!GetPVarInt(playerid, "auction_inventory_confirmed"))
                {
                    ...
                    format(text, sizeof text, "�� ������ ��������� �� ������� %s?", selected_name);
            ...
            case TYPE_HOUSE:
                format(name, 24, "��� %d", GetPVarInt(playerid, "tovar_param_server"));
case TYPE_VEHICLE:
            {
        ...
        if(response)
        {
            ...
            else if(player_info_panel[playerid][filter_type] == 2)
            {
                ...
                else
                {
                    ...
                    {
                        SendClientMessage(playerid, 0xFFFFFFFF, ""USC" ����������� ���� ������ ���� ������ ��� ������������");
                        player_info_panel[playerid][filter_type] = 0;
                    ...
                    {
                        SendClientMessage(playerid, 0xFFFFFFFF, ""USC" ���� ������ ���� �� 1000 ��� �� 500000000 ���");
                        player_info_panel[playerid][filter_type] = 0;
...
{
    auction_PTD[playerid][0] = CreatePlayerTextDraw(playerid, 27.3333, 100.2444, "txd:braucbuy"); // ��� / ������
    ...
    auction_PTD[playerid][1] = CreatePlayerTextDraw(playerid, 490.6665, 211.9851, "-"); // ��� ��������� �����
    ...
    auction_PTD[playerid][2] = CreatePlayerTextDraw(playerid, 490.6665, 236.4593, "-"); // ��� �����
    ...
    auction_PTD[playerid][3] = CreatePlayerTextDraw(playerid, 490.6665, 261.7631, "-"); // ���������
    ...
    auction_PTD[playerid][4] = CreatePlayerTextDraw(playerid, 490.6665, 286.6520, "-"); // ������� ����
    ...
    auction_PTD[playerid][5] = CreatePlayerTextDraw(playerid, 490.6665, 311.5410, "-"); // �����
    ...
    auction_PTD[playerid][7] = CreatePlayerTextDraw(playerid, 193.3333, 316.5185, "-"); // �����
    ...
    auction_PTD[playerid][8] = CreatePlayerTextDraw(playerid, 303.6669, 317.3482, "-"); // �����
    ...
    auction_PTD[playerid][9] = CreatePlayerTextDraw(playerid, 381.3334, 326.8889, "-"); // �����
    ...
    auction_PTD[playerid][11] = CreatePlayerTextDraw(playerid, 193.3333, 167.1852, "-"); // �����
    ...
    auction_PTD[playerid][12] = CreatePlayerTextDraw(playerid, 303.6669, 168.0148, "-"); // �����
    ...
    auction_PTD[playerid][13] = CreatePlayerTextDraw(playerid, 381.3334, 177.5556, "-"); // �����
    ...
    auction_PTD[playerid][15] = CreatePlayerTextDraw(playerid, 193.3333, 217.7926, "-"); // �����
    ...
    auction_PTD[playerid][16] = CreatePlayerTextDraw(playerid, 303.6669, 218.6222, "-"); // �����
    ...
    auction_PTD[playerid][17] = CreatePlayerTextDraw(playerid, 381.3334, 228.1630, "-"); // �����
    ...
    auction_PTD[playerid][19] = CreatePlayerTextDraw(playerid, 193.3333, 267.1556, "-"); // �����
    ...
    auction_PTD[playerid][20] = CreatePlayerTextDraw(playerid, 303.6669, 267.9852, "-"); // �����
    ...
    auction_PTD[playerid][21] = CreatePlayerTextDraw(playerid, 381.3334, 277.5260, "-"); // �����
    ...
    auction_PTD[playerid][22] = CreatePlayerTextDraw(playerid, 492.3333, 132.6000, "txd:brauchome"); // ������ �����
    ...
    auction_PTD[playerid][23] = CreatePlayerTextDraw(playerid, 43.3333, 125.1333, "txd:braucubuy"); // ������ �������
    ...
    auction_PTD[playerid][24] = CreatePlayerTextDraw(playerid, 43.3333, 170.3481, "txd:braucnusell"); // ������� �������
    ...
    auction_PTD[playerid][25] = CreatePlayerTextDraw(playerid, 43.6666, 216.8074, "txd:braucnumy"); // ������� ���
    ...
    auction_PTD[playerid][26] = CreatePlayerTextDraw(playerid, 43.3333, 285.6667, "txd:braucexit"); // �����
    ...
    auction_PTD[playerid][27] = CreatePlayerTextDraw(playerid, 94.3333, 368.3703, "1"); // ��������
    ...
    auction_PTD[playerid][28] = CreatePlayerTextDraw(playerid, 172.0000, 289.4001, "txd:braucnucost"); // �����
    ...
    auction_PTD[playerid][29] = CreatePlayerTextDraw(playerid,171.3333, 154.5852, "txd:braucnutip"); // ��� ������
    ...
    auction_PTD[playerid][30] = CreatePlayerTextDraw(playerid,172.0000, 200.2147, "txd:braucnutovar"); // �����
    ...
    auction_PTD[playerid][31] = CreatePlayerTextDraw(playerid,172.6666, 244.1851, "txd:braucnuopisanie"); // ��������
    ...
    auction_PTD[playerid][32] = CreatePlayerTextDraw(playerid,491.9997, 310.7110, "0_RUB"); // �����������
    ...
    auction_PTD[playerid][33] = CreatePlayerTextDraw(playerid, 240.3332, 132.1851, "txd:braucsale"); // �����
    ...
    auction_PTD[playerid][34] = CreatePlayerTextDraw(playerid, 393.3332, 146.2888, "txd:braucpurchase"); // �����
    ...
    auction_PTD[playerid][35] = CreatePlayerTextDraw(playerid, 140.0001, 362.5701, "txd:braucright"); //��������� ������
    ...
    auction_PTD[playerid][36] = CreatePlayerTextDraw(playerid, 39.3333, 362.9849, "txd:braucleft"); // ������� ������
    ...
    auction_PTD[playerid][37] = CreatePlayerTextDraw(playerid, 482.3333, 319.6813, "txd:braucbet"); // ������� ������
    ...
    auction_PTD[playerid][38] = CreatePlayerTextDraw(playerid, 439.0000, 115.1778, "txd:braucfilter"); // �������
    ...
    auction_PTD[playerid][39] = CreatePlayerTextDraw(playerid, 482.3333, 319.6813, "txd:braucexpose"); // ���������
...
public OnGameModeInit()
{
    ...
    CreateDynamic3DTextLabel("������� ������� {FF0000}/auction{FFFFFF}\n����� ������������ �������", -1, 1000.000915,2508.325927,1497.994628, 5.0);
    ...
    Create3DTextLabel("{FFFF00}���� � �������\n{FFFFFF}��������� ����� ����� �����", -1, 2092.610351,-2283.928955,23.096267, 10.0, 0);
...
public OnPlayerClickPlayerTextDraw(playerid, PlayerText:playertextid)
{
    ...
    if(playertextid == auction_PTD[playerid][6])
    {
        ...
        new string[13];
        format(string, sizeof string, "%d_���", auction_slot[slot][START_RATE]);
        PlayerTextDrawSetString(playerid, auction_PTD[playerid][3], string);
        
        format(string, sizeof string, "%d_���", auction_slot[slot][CURRENT_RATE]);
        PlayerTextDrawSetString(playerid, auction_PTD[playerid][4], string);

        format(string, 9, "%d_�.",  ConvertUnixTime(auction_slot[slot][TIMER_END] - gettime(), CONVERT_TIME_TO_HOURS));
    ...
    {
        if(!player_info_panel[playerid][opisanie_tovar]) return SCM(playerid, -1, " ������� �������� ��������");
    ...
    {
        if(!player_info_panel[playerid][type_tovar]) return SCM(playerid, -1, "������� �������� ��� ������");
        ...
        switch(GetPVarInt(playerid, "type_param"))
        {
            case TYPE_VEHICLE:
            {
                if(GetPlayerOwnableCar(playerid) != INVALID_VEHICLE_ID)
                {
                    ...
                    format(text, sizeof text, "�� ������ ��������� �� ������� ��������� %s [%d]?", GetVehicleInfo(model, VI_NAME), GetOwnableCarData(action, OC_SQL_ID));
            ...
            case TYPE_BUSINESS:
            {
                if(GetPlayerBusiness(playerid) != -1)
                {
                    ...
                    format(text, sizeof text, "�� ������ ��������� �� ������� ������ %s?", GetBusinessData(business, B_NAME), sql);
            ...
            case TYPE_HOUSE:
            {
                if(GetPlayerHouse(playerid) != -1)
                {
                    ...
                    format(text, sizeof text, "�� ������ ��������� �� ������� ��� %d?", house);
    ...
    {
        if(!player_info_panel[playerid][tovar]) return SCM(playerid, -1, "������� �������� �����");
    ...
    if(playertextid == auction_PTD[playerid][34])
    {
        ...
        if(!have_buy) return ShowNotification(playerid, 2, "� ��� ��� ������ �� �������", 3, "", ""); 
    ...
    if(playertextid == auction_PTD[playerid][37])
    {
        ...
        if(auction_slot[id_slot][TIMER_END] <= gettime()) return SendClientMessage(playerid, -1, ""SC" ����� �����. ��� ����� ���������.");

        if(GetPlayerMoneyEx(playerid) < auction_slot[id_slot][CURRENT_RATE])
        {
            format(dialog, sizeof dialog, "� ��� %d, � ����� %d ������", GetPlayerMoneyEx(playerid), auction_slot[id_slot][CURRENT_RATE]);
    ...
    {
        if(!player_info_panel[playerid][price_tovar]) return SendClientMessage(playerid, -1, ""USC" ������� �������� ���");
...
CMD:auction(playerid)
{
   ...
   if(!(8 <= hour <= 21)) return SendClientMessage(playerid, -1, ""USC"������� �������� � 8:00 �� 22:00");

    if(GetPlayerVirtualWorld(playerid) != AUCTION_WORLD)
    {
        EnablePlayerGPS(playerid, 55, 2090.941650,-2283.999511,23.101566, "�������������� �������� �������� �� �����.");
        return 1;
    }
...
{
    new time = gettime();
    if(player_cd_auction[playerid] > time) return SendClientMessage(playerid, -1, "��������� �������...");
...
stock ShowTabSell(playerid)
{
    ...
    PlayerTextDrawSetString(playerid, auction_PTD[playerid][32], "���");
...
stock ShowTabMy(playerid)
{
    ...
    auction_PTD[playerid][0] = CreatePlayerTextDraw(playerid, 83.9999, 103.5629, "txd:braucmy"); // �����
    ...
    auction_PTD[playerid][23] = CreatePlayerTextDraw(playerid,97.3332, 115.5925, "txd:braucnubuy"); // �����
    ...
    auction_PTD[playerid][24] = CreatePlayerTextDraw(playerid,97.6666, 164.5406, "txd:braucnusell"); // �����
    ...
    auction_PTD[playerid][25] = CreatePlayerTextDraw(playerid,97.6666, 213.4888, "txd:braucumy"); // �����
    ...
    auction_PTD[playerid][26] = CreatePlayerTextDraw(playerid,97.6666, 272.3926, "txd:braucexit"); // �����
...
stock Auction_FormatInventoryName(item_id, model_id, old_skin, sim_value, oldsim_value, extra_1, const meta[], name[], name_size)
{
    if(item_id == 134)
    {
        ...
        format(name, name_size, "���� #%d", skin_id);
        return 1;
    }
    if(item_id == 58)
    {
        ...
        format(name, name_size, "SIM-����� %d", sim_number);
        return 1;
    }
    if(Inventory11_IsPlateItem(item_id))
    {
        ...
        if(!sscanf(meta, "p<|>s[2]is[16]s[8]", marker, plate_type, plate, region) && plate[0])
            format(name, name_size, "�������� %s%s", plate, region);
        else
            format(name, name_size, "��������������� �����");
        return 1;
    }
    if(Inventory11_IsAccessoryItem(item_id))
    {
        Market_GetItemName(item_id, model_id, name, name_size);
        if(!name[0]) format(name, name_size, "��������� #%d", item_id);
        return 1;
    }
    Market_GetItemName(item_id, model_id, name, name_size);
    return 1;
...
stock Auction_ShowInventoryItems(playerid, type)
{
    ...
    Dialog(playerid, 5992, DIALOG_STYLE_LIST, "{FF0000}����� ��������", dialog, "�������", "�����");
    return 1;
}
...
public Auction_ShowPendingResult(playerid)
{
    ...
    switch(kind)
    {
        case 1:
        {
            format(dialog_title, sizeof(dialog_title), "������ �� ��������");
    ...
    mysql_query(mysql, query, false);
    Dialog(playerid, AUCTION_DIALOG_RESULT, DIALOG_STYLE_MSGBOX, dialog_title, body, "�������", "");
    return 1;
}
...
{
    new businessid = -1;
    if(g_player[playerid][P_LAST_TUNING] == 3) businessid = gAuctionServiceBiz[0];
    else if(g_player[playerid][P_LAST_TUNING] == 2) businessid = gAuctionServiceBiz[1];
...
stock Auction_RegisterServiceBusiness(service_index, const business_name[], business_type, business_price, Float:x, Float:y, Float:z, Float:angle)
{
    ...
    {
        if(!strcmp(g_business[idx][B_NAME], business_name, true) || GetDistanceBetweenCoords(x, y, z, GetBusinessData(idx, B_POS_X), GetBusinessData(idx, B_POS_Y), GetBusinessData(idx, B_POS_Z)) <= 1.5)
        {
            businessid = idx;
            break;
        }
    ...
    SetBusinessData(businessid, B_INTERIOR, 0);
    ...
    mysql_format(mysql, query, sizeof(query),
        "UPDATE business SET type=%d,price=%d,rent_price=5000,name='%e',x='%f',y='%f',z='%f',exit_x='%f',exit_y='%f',exit_z='%f',exit_angle='%f' WHERE id=%d LIMIT 1",
        business_type, business_price, business_name, x, y, z, x, y, z, angle, GetBusinessData(businessid, B_SQL_ID));
    mysql_query(mysql, query, false);
    ...
    // Service points use their own interaction zones. Remove the generic
    // business pickup so it does not duplicate the kiosk/tuning interaction.
...
{
    Auction_RegisterServiceBusiness(0, "����������� �����", BUSINESS_TYPE_TECH_CENTER, 5000000, -432.036956, 1005.609924, 12.189999, 353.804565);
    Auction_RegisterServiceBusiness(1, "����������", BUSINESS_TYPE_TIRE_SHOP, 2500000, 1731.149414, 2447.544921, 14.979245, 290.826629);
    Auction_RegisterServiceBusiness(2, "���� �����", BUSINESS_TYPE_FOOD_STALL, 750000, -2402.414306, 194.326232, 26.070606, 0.0);
    Auction_RegisterServiceBusiness(3, "���� �������", BUSINESS_TYPE_FOOD_STALL, 750000, 2744.309326, -2429.061279, 21.821552, 0.0);
    Auction_RegisterServiceBusiness(4, "���� ��������", BUSINESS_TYPE_FOOD_STALL, 750000, 1801.018432, 2531.215087, 14.686512, 0.0);
    Auction_RegisterServiceBusiness(5, "���� ���������", BUSINESS_TYPE_FOOD_STALL, 750000, 846.679809, 803.254028, 13.400713, 0.0);
    return 1;
}
...
public AuctionDatabaseInit()
{
    ...
    {
        printf("[AUCTION] Failed to create auction_lots, errno=%d. MySQL connection is managed by the gamemode.", mysql_errno(mysql));
        return 0;
    }
    ...
    if(mysql_errno(mysql) != 0)
    {
        printf("[AUCTION] Failed to create auction_notifications, errno=%d. MySQL connection is managed by the gamemode.", mysql_errno(mysql));
        return 0;
    }
...
stock create_auction_slot(playerid, type, opisanie[124], start_rate, data_base, server_id, number_vehicle[7] = "", number_SUM = 0)
{
    ...
    if(id == -1) return SendClientMessage(playerid, -1, ""SC" ��������� ����� ����� ��������.");
    ...
    else
    {
        switch(type)
        {
            ...
            case TYPE_HOUSE:
            {
                ...
                format(auction_slot[id][SLOT_NAME], 32, "���_(%d)", server_id);
            }
        }
    }
    ...
    if(!Auction_InsertLot(id))
    {
        ...
        Auction_ClearSlot(id);
        return SendClientMessage(playerid, -1, ""USC" ������ ���� ������. ������� ��������� � /mpreward.");
    }
    ...
    SendClientMessage(playerid, -1, ""SC" ��� ��������� �� ������� �� 24 ����.");
    return 1;
}
...
stock AuctionBusiness(sql_id, slot)
{
    ...
    if(auction_slot[slot][OWNER_SLOT_SQL] > 0)
    {
        ...
        mysql_query(mysql, query, false);
        foreach(new i : Player)
            if(GetPlayerAccountID(i) == auction_slot[slot][OWNER_SLOT_SQL] && GetPlayerData(i, P_BUSINESS) == businessid) SetPlayerData(i, P_BUSINESS, -1);
    }
    ...
    mysql_format(mysql, query, sizeof(query), "UPDATE business SET owner_id=%d,improvements=0,products=20,prod_price=0,balance=0,rent_time=%d,`lock`=0 WHERE id=%d LIMIT 1", sql_id, rent_time, GetBusinessData(businessid, B_SQL_ID));
    mysql_query(mysql, query, false);
    if(mysql_errno()) return 0;

    mysql_format(mysql, query, sizeof(query), "UPDATE accounts SET business=%d WHERE id=%d AND (business=-1 OR business=0) LIMIT 1", businessid, sql_id);
    mysql_query(mysql, query, false);
    ...
    foreach(new i : Player)
    {
        ...
        if(GetPlayerData(i, P_BUSINESS) <= 0) SetPlayerData(i, P_BUSINESS, businessid);
        SendClientMessage(i, 0x66CC00FF, "�������� {0099FF}/business {66CC00}��� ���������� ��������.");
        break;
    }
    return 1;
}
...
stock finish_auction_slot(slot)
{
    ...
    if(bidder <= 0)
    {
        if(type == TYPE_BUSINESS && seller == -2)
        {
...
public: SetBusinessName()
{
    ...
    mysql_format(mysql, text, sizeof text, "UPDATE business SET `name`='������� 24/7' WHERE `type` = 1");
    mysql_query(mysql, text, false);

    mysql_format(mysql, text, sizeof text, "UPDATE business SET `name`='����' WHERE `type` = 2");
    mysql_query(mysql, text, false);

    mysql_format(mysql, text, sizeof text, "UPDATE business SET `name`='���������� ����������' WHERE `type` = 3");
    mysql_query(mysql, text, false);

    mysql_format(mysql, text, sizeof text, "UPDATE business SET `name`='����������� ��������' WHERE `type` = 4");
    mysql_query(mysql, text, false);

    mysql_format(mysql, text, sizeof text, "UPDATE business SET `name`='������� ������' WHERE `type` = 5");
    mysql_query(mysql, text, false);

    mysql_format(mysql, text, sizeof text, "UPDATE business SET `name`='�����' WHERE `type` = 6");
    mysql_query(mysql, text, false);

    // Vehicle dealerships have unique names and are persisted by InitStaticCarMarkets.
    // Do not replace them all with the generic name "���������".

    mysql_format(mysql, text, sizeof text, "UPDATE business SET `name`='������' WHERE `type` = 8");
    mysql_query(mysql, text, false);

    mysql_format(mysql, text, sizeof text, "UPDATE business SET `name`='���' WHERE `type` = 10");
    mysql_query(mysql, text, false);

    mysql_format(mysql, text, sizeof text, "UPDATE business SET `name`='������� �����' WHERE `type` = 9");
    mysql_query(mysql, text, false);

    mysql_format(mysql, text, sizeof text, "UPDATE business SET `name`='������� ������' WHERE `type` = 11");
    mysql_query(mysql, text, false);
...
public:LoadBusinessToAuction()
{
    ...
    new Cache:result = mysql_query(mysql, "SELECT id,name,price FROM business WHERE owner_id=0 ORDER BY id ASC", true);
    if(mysql_errno())
    {
        cache_delete(result);
        return 0;
    ...
    for(new row; row < rows; row++)
    {
        ...
        format(auction_slot[slot][OPISANIE_SLOT], 124, "��������������� ������ #%d", businessid);
        if(Auction_InsertLot(slot)) added++;
        else Auction_ClearSlot(slot);
    }
    cache_delete(result);
    printf("[AUCTION] State businesses added: %d", added);
    return 1;
}
