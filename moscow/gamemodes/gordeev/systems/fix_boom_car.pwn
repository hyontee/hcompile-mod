...
stock bool:IsVehicleBrokenForEngine(vehicleid)
{
...
stock ShowBrokenVehicleMessage(playerid)
{
    return SendClientMessage(playerid, -1, "{868641}Ваш транспорт сломался, вызовите механика ((/call 090))");
}
...
public CheckPlayerVehicle(playerid)
{
    if(IsPlayerInAnyVehicle(playerid))
    {
        ...
        if(health < 279.0)
        {
            ...
            {
                ShowBrokenVehicleMessage(playerid);
