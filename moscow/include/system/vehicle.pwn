...
#define MIN_VEHICLE_INFO_MODEL_ID   (400)
#define MAX_VEHICLE_INFO_MODEL_ID   (2582)
#define BASE_VEHICLE_INFO_COUNT     (212)
#define CUSTOM_VEHICLE_INFO_COUNT   (5)

#define GetVehicleInfo(%0,%1)		g_vehicle_info[GetVehicleInfoIndex(%0)][%1]
#define GetVehicleName(%0)			GetVehicleInfo(GetVehicleData(%0, V_MODELID)-MIN_VEHICLE_INFO_MODEL_ID, VI_NAME)
...
new const
    g_vehicle_info[BASE_VEHICLE_INFO_COUNT + CUSTOM_VEHICLE_INFO_COUNT][E_VEHICE_INFO_STRUCT] = 
{//цена в тысячах
    ...
    {"Mercedes-Benz CLS63 AMG",  10300000,     7800,   1, 305, 4},     // 410
    ...
    {"BMW M5 CS",      12500000,      0,      2, 305, 3.0},     // 666
    {"UAZ Patriot",    1200000,       0,      1, 163, 12.0},    // 2560
    {"UAZ Patriot Pickup", 1250000,   0,      1, 163, 12.0},    // 2561
    {"BMW X5 E53",     1500000,       0,      1, 215, 6.4},     // 2568
    {"Mercedes-Benz CLS63 AMG", 10300000, 7800, 1, 305, 3.5}    // 2582
};

stock GetVehicleInfoIndex(model_index)
{
    if(0 <= model_index < BASE_VEHICLE_INFO_COUNT)
    {
        return model_index;
    }

    switch(model_index + MIN_VEHICLE_INFO_MODEL_ID)
    {
        case 666: return BASE_VEHICLE_INFO_COUNT;
        case 2560: return BASE_VEHICLE_INFO_COUNT + 1;
        case 2561: return BASE_VEHICLE_INFO_COUNT + 2;
        case 2568: return BASE_VEHICLE_INFO_COUNT + 3;
        case 2582: return BASE_VEHICLE_INFO_COUNT + 4;
    }

    return -1;
}

stock bool:IsValidVehicleInfoModel(modelid)
{
    return GetVehicleInfoIndex(modelid - MIN_VEHICLE_INFO_MODEL_ID) != -1;
}
