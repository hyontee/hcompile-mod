...
public OnPlayerEnterDynamicArea(playerid, areaid)
{
    ...
    {
        ShowNotificationXxesao(playerid, 4, 6, OXOTA_OFFER, 0, "Взаимодействовать", ">>");
    }
    ...
    for(new i = 0; i < MAX_BAIT_SPOTS; i++)
    {
        ...
        {
            ShowNotificationXxesao(playerid, 4, 6, OXOTA_OFFER_PRIMANKA, 0, "Взаимодействовать", ">>");
            break;
        }
    }
        ...
        if(FindAnimalByAreaID(playerid, areaid, animalid))
        {
            if(animalid >= 0 && animalid < MAX_ANIMALS)
            {
                if(AnimalData[playerid][animalid][animalDead] && !AnimalData[playerid][animalid][animalCollected])
                {
                    ...
                    ShowNotificationXxesao(playerid, 4, 6, OXOTA_OFFER_TAKE, 0, "Взаимодействовать", ">>");
                }
            }
        }
    }
