            ...
            switch(listitem)
            {
                case 0:
                {
                    ...
                    (//Автор данной системы https://t.me/welsistudio (Welsi Studio)
                        ...
                        "{FF4F43}"FAN4IIK_NAME"{FFFFFF} | Основная информация",
                ...
                case 1:
                {
                    if(GetPlayerLevel(playerid) < 3) return 	ShowNotificationFan4iik(playerid, 2, 5, 0, 0, "Для работы автоугонщика необходим 3 уровень!", " ");
...
//Автор данной системы https://t.me/welsistudio (Welsi Studio)
                    ...
                    if(player_order_hijacker[playerid] == -1) return 	ShowNotificationFan4iik(playerid, 2, 5, 0, 0, "Сейчас заданий нет.", " ");
    ...
    {//Автор данной системы https://t.me/welsistudio (Welsi Studio)
        ...
        if(stage == 5)
        {
    		...
    		SendCreateWayPoint(playerid, 3, 2181.646484,-1838.352783,18.81676, 85, 27, 5000.0, 1);
...
public OnPlayerEnterDynamicArea(playerid, areaid)
{
    if(areaid == sphere_npc_hijacker)
    {
        if(player_order_hijacker[playerid] != -1)
        {
            ...
            {
                new txt_salary[84], salary = 300000 + random(50000);
                ...
                SendDestroyWayPoint(playerid, 3);
...
//Автор данной системы https://t.me/welsistudio (Welsi Studio)
        ...
        (
            ...
            "{FF4F43}"FAN4IIK_NAME" {FFFFFF}| Угонщик автомобилей",
...
{
    CreateHijacker();
    print("[Инклуд-система]: Система загружена!");
...
stock CreateHijacker()//Автор данной системы https://t.me/welsistudio (Welsi Studio)
{
	...
	CreateActor(103, 2165.000488,-1859.087280,18.814174,50.157138, 0);
    CreateDynamic3DTextLabel("{FF5252}« Автоугонщик Константин »\n{ffffff}Подойдите для\nвзаимодействия", 0xFF5252FF, 2165.000488,-1859.087280,18.814174 + 0.5, 5.0);
...
//Автор данной системы https://t.me/welsistudio (Welsi Studio)
    ...
    else SendClientMessage(playerid, -1, ""SC" Сначало возьмите заказ у Константина.");
//Автор данной системы https://t.me/welsistudio (Welsi Studio)
}
