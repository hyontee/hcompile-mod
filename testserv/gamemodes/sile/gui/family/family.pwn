...
stock MoveFamilyCar(database_car, playerid)
{
    ...
    (
        ...
        VALUES \
        (%d, %d, %d, %d, %f, %f, %f, %f, %d, '%e')",
        GetPlayerAccountID(playerid), model_id, color_1, color_2, pos_x, pos_y, pos_z, angle, gettime(), stored_number
    );
    mysql_query(mysql, query, false);
