//>> Файл: bykranin_src/systems/carshare_welsi.pwn  (387 строк)
//>> Тема: самостоятельные модули (были отдельными файлами в исходном проекте)
//>> Внутри: OnPlayerConnect, OnPlayerDisconnect, OnGameModeInit, OnDialogResponse, /arendacar, DialogCarShare, CarShare
//>> Файл подключается из gamemodes/bykranin.pwn; порядок include менять нельзя (см. bykranin_src/GUIDE.md).
// BEGIN INLINED: include/system/carshare_welsi.pwn
...
{
    print("[KRANIN_SYSTEM] Система каршеринга загружена.");
...
// END INLINED: include/system/carshare_welsi.pwn
