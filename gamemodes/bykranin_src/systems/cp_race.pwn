//>> Файл: bykranin_src/systems/cp_race.pwn  (114 строк)
//>> Тема: самостоятельные модули (были отдельными файлами в исходном проекте)
//>> Внутри: ClearPlayerRCPInfo, n_SetPlayerRaceCheckpoint, n_IsPlayerInRaceCheckpoint, n_DisablePlayerRaceCheckpoint
//>> Файл подключается из gamemodes/bykranin.pwn; порядок include менять нельзя (см. bykranin_src/GUIDE.md).
// BEGIN INLINED: include/system/cp_race.pwn
...
// END INLINED: include/system/cp_race.pwn
