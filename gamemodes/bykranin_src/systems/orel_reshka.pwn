//>> Файл: bykranin_src/systems/orel_reshka.pwn  (372 строк)
//>> Тема: самостоятельные модули (были отдельными файлами в исходном проекте)
//>> Внутри: OnGameModeInit, /spin, /spins, StartHAT, EndHAT, DefaultHAT, DialogThrowHAT
//>> Файл подключается из gamemodes/bykranin.pwn; порядок include менять нельзя (см. bykranin_src/GUIDE.md).
// BEGIN INLINED: include/system/orel_reshka.pwn
enum Game_HAT
{
    HAT_Owner,
    HAT_Player,
...
{
    printf("[KRANIN_SYSTEM] Игра \"Орёл и решка\" загружена");
...
#endif
// END INLINED: include/system/orel_reshka.pwn
