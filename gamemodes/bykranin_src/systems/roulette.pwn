//>> Файл: bykranin_src/systems/roulette.pwn  (1261 строк)
//>> Тема: самостоятельные модули (были отдельными файлами в исходном проекте)
//>> Внутри: OnGameModeInit, OnDialogResponse, OnPlayerConnect, OnPlayerClickTextDraw, /openroulette, RuletkaMenu, RuletkaPlayer
//>> Файл подключается из gamemodes/bykranin.pwn; порядок include менять нельзя (см. bykranin_src/GUIDE.md).
// BEGIN INLINED: include/system/roulette.pwn
//Рулетка
#define T_NONE		0
#define	T_MONEY		1
#define	T_LIC		2
...
{
    printf("[KRANIN_SYSTEM] Система рулетки загружена.\n");
    RuletkaMenu();
    LoadPrizeRuletka();
...
stock RuletkaMenu()
{
    ...
    welsirltk_TD[34] = TextDrawCreate(580.9998, 2.0888, "t.me/prizmamobile"); // пусто
...
// END INLINED: include/system/roulette.pwn
