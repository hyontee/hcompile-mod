//>> Файл: bykranin_src/systems/cp.pwn  (104 строк)
//>> Тема: самостоятельные модули (были отдельными файлами в исходном проекте)
//>> Внутри: ClearPlayerCPInfo, n_SetPlayerCheckpoint, n_IsPlayerInCheckpoint, n_DisablePlayerCheckpoint
//>> Файл подключается из gamemodes/bykranin.pwn; порядок include менять нельзя (см. bykranin_src/GUIDE.md).
// BEGIN INLINED: include/system/cp.pwn
...
// END INLINED: include/system/cp.pwn
