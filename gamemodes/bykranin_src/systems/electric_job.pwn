//>> Файл: bykranin_src/systems/electric_job.pwn  (476 строк)
//>> Тема: самостоятельные модули (были отдельными файлами в исходном проекте)
//>> Внутри: OnPlayerDisconnect, OnPlayerConnect, OnPlayerSpawn, OnDialogResponse, OnPlayerEnterDynamicArea, OnGameModeInit, CreateElectric
//>> Файл подключается из gamemodes/bykranin.pwn; порядок include менять нельзя (см. bykranin_src/GUIDE.md).
// BEGIN INLINED: include/system/electric_job.pwn
...
// END INLINED: include/system/electric_job.pwn
