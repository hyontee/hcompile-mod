...
{
    m_rakClientInterface->Connect((char*)OBFUSCATE("54.38.117.74"), 1129, 0, 0, 5); // Balika
    m_szHostOrIp = (char*)OBFUSCATE("54.38.117.74");
    m_szNickName = nickname;
    // m_rakClientInterface->Connect("54.38.117.74", 1129, 0, 0, 0); // Sasuke
}
