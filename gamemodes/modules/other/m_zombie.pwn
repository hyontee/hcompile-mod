			...
			if ( random ( 60 ) == 1 )
			{
				...
				if ( IsPlayerConnected ( _random ) )
				{
					switch ( random ( 3 ) )
					{
						...
						{
							_item = 202 ;
							give_player_item_prise ( _random, 202, 1, -1 ) ;
							
							global_string [ 0 ] = EOS ;
							format ( global_string, 144, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( 202 ) ) ;
							SendClientMessage ( _random, col_yellow, global_string ) ;
						}
						case 1:
						{
							_item = 203 ;
							give_player_item_prise ( _random, 203, 1, -1 ) ;
							
							global_string [ 0 ] = EOS ;
							format ( global_string, 144, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( 203 ) ) ;
							SendClientMessage ( _random, col_yellow, global_string ) ;
						}
						case 2:
						{
							_item = 204 ;
							give_player_item_prise ( _random, 204, 1, -1 ) ;
							
							global_string [ 0 ] = EOS ;
							format ( global_string, 144, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( 204 ) ) ;
							SendClientMessage ( _random, col_yellow, global_string ) ;
						}
					}
