...
{
	{ "Рулетка удачи {cd7f32}Bronze{"#cWH"}", 600, 45, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_OBJECT },
	{ "Рулетка удачи {c8c8c8}Silver{"#cWH"}", 1000, 55, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_OBJECT },
	{ "Рулетка удачи {c3900a}Gold{"#cWH"}", 1400, 125, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_OBJECT },
	{ "VIP {cd7f32}Bronze{"#cWH"} (3 дн.)", 500, 24, GIVE_TYPE_INVENTORY, BATTLEPASS_NO_RENDER },
	{ "VIP {cd7f32}Bronze{"#cWH"} (5 дн.)", 800, 25, GIVE_TYPE_INVENTORY, BATTLEPASS_NO_RENDER },
	{ "VIP {cd7f32}Bronze{"#cWH"} (7 дн.)", 1100, 26, GIVE_TYPE_INVENTORY, BATTLEPASS_NO_RENDER },
	{ "VIP {cd7f32}Bronze{"#cWH"} (10 дн.)", 1550, 27, GIVE_TYPE_INVENTORY, BATTLEPASS_NO_RENDER },
	{ "VIP {c8c8c8}Silver{"#cWH"} (3 дн.)", 800, 28, GIVE_TYPE_INVENTORY, BATTLEPASS_NO_RENDER },
	{ "VIP {c8c8c8}Silver{"#cWH"} (5 дн.)", 1300, 29, GIVE_TYPE_INVENTORY, BATTLEPASS_NO_RENDER },
	{ "VIP {c8c8c8}Silver{"#cWH"} (7 дн.)", 1800, 30, GIVE_TYPE_INVENTORY, BATTLEPASS_NO_RENDER },
	{ "VIP {c8c8c8}Silver{"#cWH"} (10 дн.)", 2650, 31, GIVE_TYPE_INVENTORY, BATTLEPASS_NO_RENDER },
	...
	{ "Одежда #183", 3000, skin_cross + 183, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
	{ "Одежда #184", 3000, skin_cross + 184, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
	{ "Одежда #277", 2000, skin_cross + 277, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
	{ "Одежда #281", 2000, skin_cross + 281, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
	{ "Одежда #294", 600, skin_cross + 294, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
	{ "Одежда #300", 1000, skin_cross + 300, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
	{ "Одежда #4500", 1000, skin_cross + 4500, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
	{ "Одежда #4501", 1000, skin_cross + 4501, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
	{ "Одежда #4502", 1000, skin_cross + 4502, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
	{ "Одежда #4503", 1000, skin_cross + 4503, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
	{ "Одежда #4504", 1000, skin_cross + 4504, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
	{ "Одежда #4505", 1000, skin_cross + 4505, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
	{ "Одежда #4505", 1000, skin_cross + 4505, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
	{ "Одежда #4655", 3000, skin_cross + 4655, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
	{ "Одежда #4657", 3000, skin_cross + 4657, GIVE_TYPE_INVENTORY, BATTLEPASS_RENDER_SKIN },
...
new BattlePass [ MAX_BATTLE_PASS_ITEMS ] [ ENUM_BATTLE_PASS_ITEMS ] =
{
	...
	{"Аптечка", BP_INVENTORY, 145, BP_ITEM_COMMON, BATTLEPASS_NO_RENDER,							"Деньги: 2 000 000"valute_title_"", 1, 2_000_000, BP_ITEM_COMMON, BATTLEPASS_NO_RENDER}, // 2
		...
		if ( player_device { playerid } != 2 )
		{
			...
			switch ( BattlePass [ BPLevel ] [ bpiType ] )
			{
				...
				case BP_SKIN:
				{
					...
					give_player_item_prise ( playerid, BattlePass [ BPLevel ] [ bpiAmount ] + skin_cross, 1 ) ;
				...
				case BP_SECRET:
				{
					if ( event_count >= 1 )
					{
						...
						new scm_string [ 52 + 9 ] ;
						format ( scm_string, sizeof scm_string, "Поздравляем! Вы получаете {"#cWH"}%s{"#cSucces"}.", GetVehicleNameEx ( -1, _car_id ) ) ;
						SendClientMessage ( playerid, col_succes, scm_string ) ;
					}
					else
					{
				...
				case BP_BRONZE_ROULETTE:
				{
					...
					give_player_item_prise ( playerid, 45, _rou_count ) ;
				
					global_string [ 0 ] = EOS ;
					format ( global_string, 128, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( 45 ) ) ;
				...
				case BP_SILVER_ROULETTE:
				{
					...
					give_player_item_prise ( playerid, 55, _rou_count ) ;
				
					global_string [ 0 ] = EOS ;
					format ( global_string, 128, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( 55 ) ) ;
					SendClientMessage ( playerid, col_yellow, global_string ) ;
				}
				case BP_GOLD_ROULETTE:
				{
					...
					give_player_item_prise ( playerid, 125, _rou_count ) ;
				
					global_string [ 0 ] = EOS ;
					format ( global_string, 128, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( 125 ) ) ;
					SendClientMessage ( playerid, col_yellow, global_string ) ;
				}
				case BP_ACCS:
				{
					...
					global_string [ 0 ] = EOS ;
					format ( global_string, 128, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( _acc_id ) ) ;
					SendClientMessage ( playerid, col_yellow, global_string ) ;
				}
				case BP_FAMILY:
				{
					...
					p_info [ playerid ] [ family_ticket ] += _er_count ;
				...
				case BP_DETAIL_CRAFT:
				{
					...
					give_player_item_prise ( playerid, _bpiAmount, random ( 15 ) + 10 ) ;
				
					global_string [ 0 ] = EOS ;
					format ( global_string, 128, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( _bpiAmount ) ) ;
					SendClientMessage ( playerid, col_yellow, global_string ) ;
				...
				{
					new _bpiAmount = BattlePass [ BPLevel ] [ bpiAmount ] ;
					give_player_item_prise ( playerid, 45, _bpiAmount ) ;
				...
				{
					new _bpiAmount = BattlePass [ BPLevel ] [ bpiAmount ] ;
					give_player_item_prise ( playerid, 55, _bpiAmount ) ;
				...
				{
					new _bpiAmount = BattlePass [ BPLevel ] [ bpiAmount ] ;
					give_player_item_prise ( playerid, 125, _bpiAmount ) ;
				...
				{
					new _bpiAmount = BattlePass [ BPLevel ] [ bpiAmount ] ;
					give_player_item_prise ( playerid, _bpiAmount, 1 ) ;
...
stock give_eventpass_prise ( playerid, bool: status )
{
	...
	switch ( _bpiType )
	{
		...
		case BP_SKIN:
		{
			...
			give_player_item_prise ( playerid, _bpiAmount + skin_cross, 1 ) ;
		...
		case BP_CAR:
		{
			...
			format ( sql_string, sizeof sql_string, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( _bpiAmount ) ) ;
			SendClientMessage ( playerid, col_yellow, sql_string ) ;
		}
		case BP_MONEY:
		{
			...
			if ( event_count >= 1 )
			{
				...
				if ( status && _bpiPrem )
				{
					switch ( random ( 3 ) )
					{
						case 0:
						{
							give_player_item ( playerid, 8249 ) ;
					
							sql_string [ 0 ] = EOS ;
							format ( sql_string, sizeof sql_string, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( 8249 ) ) ;
							SendClientMessage ( playerid, col_yellow, sql_string ) ;
						...
						case 1:
						{
							give_player_item_prise ( playerid, 4716 + skin_cross, 1 ) ;
					
							sql_string [ 0 ] = EOS ;
							format ( sql_string, sizeof sql_string, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( 4716 + skin_cross ) ) ;
							SendClientMessage ( playerid, col_yellow, sql_string ) ;
							
							sql_string [ 0 ] = EOS ;
							format ( sql_string, sizeof sql_string, "Поздравляем! Вы получаете {"#cWH"}%s{"#cSucces"}.", item_name ( 4716 + skin_cross ) ) ;
							SendClientMessage ( playerid, col_succes, sql_string ) ;
						}
						case 2:
						{
							give_player_item_prise ( playerid, 3370, 1 ) ;
					
							sql_string [ 0 ] = EOS ;
							format ( sql_string, sizeof sql_string, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( 3370 ) ) ;
							SendClientMessage ( playerid, col_yellow, sql_string ) ;
							
							sql_string [ 0 ] = EOS ;
							format ( sql_string, sizeof sql_string, "Поздравляем! Вы получаете {"#cWH"}%s{"#cSucces"}.", GetVehicleNameEx ( -1, 3370 ) ) ;
							SendClientMessage ( playerid, col_succes, sql_string ) ;
						}
					}
				}
				else
				{
					switch ( random ( 3 ) )
					{
						case 0:
						{
							give_player_item ( playerid, 8247 ) ;
					
							sql_string [ 0 ] = EOS ;
							format ( sql_string, sizeof sql_string, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( 8247 ) ) ;
							SendClientMessage ( playerid, col_yellow, sql_string ) ;
						...
						case 1:
						{
							give_player_item_prise ( playerid, 4679 + skin_cross, 1 ) ;
					
							sql_string [ 0 ] = EOS ;
							format ( sql_string, sizeof sql_string, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( 4679 + skin_cross ) ) ;
							SendClientMessage ( playerid, col_yellow, sql_string ) ;
							
							sql_string [ 0 ] = EOS ;
							format ( sql_string, sizeof sql_string, "Поздравляем! Вы получаете {"#cWH"}%s{"#cSucces"}.", item_name ( 4679 + skin_cross ) ) ;
							SendClientMessage ( playerid, col_succes, sql_string ) ;
						}
						case 2:
						{
							give_player_item_prise ( playerid, 3365, 1 ) ;
					
							sql_string [ 0 ] = EOS ;
							format ( sql_string, sizeof sql_string, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( 3365 ) ) ;
							SendClientMessage ( playerid, col_yellow, sql_string ) ;
							
							sql_string [ 0 ] = EOS ;
							format ( sql_string, sizeof sql_string, "Поздравляем! Вы получаете {"#cWH"}%s{"#cSucces"}.", GetVehicleNameEx ( -1, 3365 ) ) ;
							SendClientMessage ( playerid, col_succes, sql_string ) ;
						}
					}
				}
		...
		case BP_ACCS:
		{
			give_player_item ( playerid, _bpiAmount ) ;
		...
		case BP_FAMILY:
		{
			p_info [ playerid ] [ family_ticket ] += _bpiAmount ;
			update_int_sql ( playerid, "u_family_ticket", p_info [ playerid ] [ family_ticket ] ) ;
...
stock epass_OnDialogResponse ( playerid, dialogid, response, listitem, inputtext [ ] )
{
	...
	switch ( dialogid )
	{
		...
		case d_event_trade:
		{
			...
			{
				give_player_item_prise ( playerid, event_trade [ listitem ] [ event_prise ], 1 ) ;
				
				global_string [ 0 ] = EOS ;
				format ( global_string, 128, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( event_trade [ listitem ] [ event_prise ] ) ) ;
				SendClientMessage ( playerid, col_yellow, global_string ) ;
			}
...
stock epass_EnterDynamicArea ( playerid, areaid )
{
	if ( GetPlayerState ( playerid ) == PLAYER_STATE_ONFOOT )
	{
		switch ( area_info [ areaid ] [ a_type ] )
		{
			...
			{
				if ( player_device { playerid } == 2 )
					send_check_cinfo ( playerid, "Актёр. Нажмите для взаимодействия", 1, -1, CINFO_EVENTACTOR_ID, CINFO_TYPE_AREA, PICTURE_INFO_TALKING, "Актёр", "" ) ;
...
CMD:epstart ( playerid, params [ ] )
{
	...
	format ( query_string, sizeof query_string, "SELECT `u_id`, `u_epass` FROM `users` WHERE `u_epass` > '0' AND `u_epass` < '%d'", MAX_BATTLE_PASS_ITEMS ) ;
	mysql_tquery ( sql_connection, query_string, "callback_rewards_battle_pass", "" ) ;
...
callback: callback_rewards_battle_pass ( )
{
	new rows, fields ;
	...
	if ( rows )
	{
		...
		{
			new _account_id = cache_get_field_content_int ( i, "u_id", sql_connection ) ;
			new _epass_lvl = cache_get_field_content_int ( i, "u_epass", sql_connection ) ;
			if ( _epass_lvl > 0 && _epass_lvl < 30 ) show_give_bp_discount ( _account_id, 30 ) ;
			else if ( _epass_lvl > 29 && _epass_lvl < MAX_BATTLE_PASS_ITEMS ) show_give_bp_discount ( _account_id, 50 ) ;
		}
	}
	
	mysql_tquery ( sql_connection, "UPDATE `users` SET `u_eventpass` = '1|2|3|4|5|6', `u_eventpass_progress` = '0|0|0|0|0|0', `u_epass` = '0', `u_eexp` = '0', `u_epriseuse` = '0', `u_epriseuse_prem` = '0', `u_epremium` = '0'", "callback_update_bp", "i", 2 ) ;
	return 1 ;
}

stock show_give_bp_discount ( _u_id, _discount )
{
	insert_debtor_message ( "Battle Pass", "{"#cRInfo"}* {"#CGRinfo"}Нам пришлось завершить событие раньше в связи с обновлением!\n{"#cRInfo"}* {"#CGRinfo"}В знак извинения Вам выдан скидочный талон.\nИспользуйте {"#cGInfo"}/returnmoney{"#cWH"}.", _u_id ) ;
		
	new _i_item ;
	if ( _discount == 30 ) _i_item = 185 ;
	else if ( _discount == 50 ) _i_item = 186 ;
	insert_return_money ( "Инвентарь", _i_item, RETURN_TYPE_PRISE_INVENTORY, _u_id, 1 ) ;
	return 1 ;
}
...
stock epass_OnGameModeInit ( )
{
	...
	CreateActor ( 4545, event_actor_position [ 0 ], event_actor_position [ 1 ], event_actor_position [ 2 ], event_actor_position [ 3 ] ) ;
...
stock SetBattleRoulettePrise ( playerid, _roulette_id, _bp_type )
{
	...
	if ( _roulette_id >= 5 && _roulette_id <= 7 || _roulette_id >= 10 && _roulette_id <= 20 )
	{
		...
		if ( _render == BATTLEPASS_RENDER_OBJECT )
		{
			...
			global_string [ 0 ] = EOS ;
			format ( global_string, 128, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( _prise_id ) ) ;
			SendClientMessage ( playerid, col_yellow, global_string ) ;
		}
		else if ( _render == BATTLEPASS_RENDER_SKIN )
		{
			format ( _str_name, sizeof _str_name, "%s", item_name ( _prise_id + skin_cross ) ) ;
			give_player_item_prise ( playerid, _prise_id + skin_cross, 1 ) ;

			global_string [ 0 ] = EOS ;
			format ( global_string, 128, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( _prise_id + skin_cross ) ) ;
			SendClientMessage ( playerid, col_yellow, global_string ) ;
		}
	...
	if ( _param4 == 1 ) // arizona
	{
		if ( _param1 == 0 )
		{
			...
			else if ( _param2 == 1 ) // buy prem
			{
				if ( gPlayerBattlePassPrem [ playerid ] )
				{
					...
					if ( get_player_item_prise ( playerid, 184 ) > 1 ) _discount = 10 ;
					else if ( get_player_item_prise ( playerid, 185 ) > 1 ) _discount = 30 ;
					else if ( get_player_item_prise ( playerid, 186 ) > 1 ) _discount = 50 ;
		...
		else if ( _param1 == 7 )
		{
			...
			if ( _listitem == 0 )
			{
				...
				if ( get_player_item_prise ( playerid, 184 ) > 0 ) _discont = 10, _type = 1 ;
				else if ( get_player_item_prise ( playerid, 185 ) > 0 ) _discont = 30, _type = 2 ;
				else if ( get_player_item_prise ( playerid, 186 ) > 0 ) _discont = 50, _type = 3 ;
			...
			else if ( _listitem == 1 )
			{
				...
				{
					send_check_cinfo ( playerid, "У Вас уже снят лимит заданий!", 0, 300, CINFO_OTHER_ID, CINFO_TYPE_AREA, PICTURE_INFO_ERROR, "", "" ) ;
					return 1 ;
				}
			...
			else if ( _listitem == 4 )
			{
				if ( gPlayerBattlePassPrem [ playerid ] )
				{
					send_check_cinfo ( playerid, "У Вас уже есть премиум-статус!", 0, 300, CINFO_OTHER_ID, CINFO_TYPE_AREA, PICTURE_INFO_ERROR, "", "" ) ;
					return 1 ;
				}
		...
		else if ( _param1 == 8 )
		{
			if ( EventGlobalQuest != -1 )
			{
				...
				{
					send_check_cinfo ( playerid, "Вы получили вознаграждение.", 0, 300, CINFO_OTHER_ID, CINFO_TYPE_AREA, PICTURE_INFO_SUCESS, "", "" ) ;
					...
					if ( GlobalQuestData [ _q_id ] [ goPriseModel ] [ 0 ] != -1 )
					{
						...
						{
							give_player_item_prise ( playerid, _model, GlobalQuestData [ _q_id ] [ goPriseCount ] [ 0 ] ) ;
					...
					if ( GlobalQuestData [ _q_id ] [ goPriseModel ] [ 1 ] != -1 )
					{
						...
						{
							give_player_item_prise ( playerid, _model, GlobalQuestData [ _q_id ] [ goPriseCount ] [ 1 ] ) ;
					...
					if ( GlobalQuestData [ _q_id ] [ goPriseModel ] [ 2 ] != -1 )
					{
						...
						{
							give_player_item_prise ( playerid, _model, GlobalQuestData [ _q_id ] [ goPriseCount ] [ 2 ] ) ;
	...
	else if ( _param4 == 2 ) // matreshka
	{
		...
		else if ( _param1 == 4 ) // roll case
		{
			if ( _param2 == 1 )
			{
				...
				if ( _render == BATTLEPASS_RENDER_OBJECT )
				{
					give_player_item ( playerid, _item ) ;
				...
				{
					give_player_item_prise ( playerid, _item + skin_cross, 1 ) ;
					
					global_string [ 0 ] = EOS ;
					format ( global_string, 128, "* Вам был добавлен предмет '%s'. Откройте инвентарь, используйте /mm или радиальное меню.", item_name ( _item + skin_cross ) ) ;
					SendClientMessage ( playerid, col_yellow, global_string ) ;
				}
				else if ( _render == BATTLEPASS_RENDER_CAR )
				{
