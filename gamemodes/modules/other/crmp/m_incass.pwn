...
new Float: actor_incass_pos [ 3 ] = { -90.2223, 712.4904, 1600.1958 } ;
new Float: actor_incass_position [ 4 ] [ 4 ] =
{
	{ -90.1949, 711.4156, 1600.1958, 356.3094 },
	{ -90.1949, 711.4156, 1600.1958, 356.3094 },
	{ -90.1949, 711.4156, 1600.1958, 356.3094 },
	{ -90.1949, 711.4156, 1600.1958, 356.3094 }
} ;

new Float: start_inkass_position [ 3 ] = { -86.6605, 712.6578, 1600.1958 } ;
...
stock incass_OnGameModeInit ( )
{
	...
	CreateDynamic3DTextLabel ( "** Начальник службы инкассации **\n{"#cGR3D"}Подойдите для получения з/п", col_blue, actor_incass_pos [ 0 ], actor_incass_pos [ 1 ], actor_incass_pos [ 2 ], 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, -1, -1 ) ;
	...
	CreateDynamic3DTextLabel ( "** Инкассация **\n{"#cGR3D"}Подойдите для начала рабочего дня", col_blue, start_inkass_position [ 0 ], start_inkass_position [ 1 ], start_inkass_position [ 2 ] + 0.7, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, -1, -1 ) ;
	return 1 ;
}
