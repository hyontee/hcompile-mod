...
stock delivery_OnGameModeInit ( )
{
	...
	CreateDynamic3DTextLabel ( "** Пицца для доставки **", col_blue, pick_hand_pizza_pos [ 0 ], pick_hand_pizza_pos [ 1 ], pick_hand_pizza_pos [ 2 ] + 1.0, 3.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, -1, 0, 0 );
	return 1 ;
}
