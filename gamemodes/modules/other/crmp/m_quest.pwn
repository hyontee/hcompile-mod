...
stock create_player_pearle ( playerid )
{
	...
	UpdateDynamic3DTextLabelText ( pearle_text, col_blue, text_label ) ;
	return 1 ;
}
...
stock create_player_turtle ( playerid )
{
	...
	UpdateDynamic3DTextLabelText ( turtle_text, col_blue, text_label ) ;
	return 1 ;
}
...
stock create_player_fruit ( playerid )
{
	...
	UpdateDynamic3DTextLabelText ( fruit_text, col_blue, text_label ) ;
	return 1 ;
}
...
stock create_player_cow_food ( playerid )
{
	...
	UpdateDynamic3DTextLabelText ( cow_food_text, col_blue, text_label ) ;
	return 1 ;
}
...
stock create_player_meat ( playerid )
{
	...
	UpdateDynamic3DTextLabelText ( meat_text, col_blue, text_label ) ;
	return 1 ;
}
...
stock create_player_farmer ( playerid, _type )
{
	...
	UpdateDynamic3DTextLabelText ( farmer_text, col_blue, text_label ) ;
	return 1 ;
}
...
stock create_player_milking ( playerid )
{
	...
	UpdateDynamic3DTextLabelText ( milking_text, col_blue, text_label ) ;
	return 1 ;
}
...
stock create_player_eggs ( playerid )
{
	...
	UpdateDynamic3DTextLabelText ( eggs_text, col_blue, text_label ) ;
	return 1 ;
}
...
stock create_player_hay ( playerid, _type )
{
	...
	UpdateDynamic3DTextLabelText ( hay_text, col_blue, text_label ) ;
	return 1 ;
}
...
stock create_player_graffity ( playerid )
{
	...
	UpdateDynamic3DTextLabelText ( graffity_text, col_blue, text_label ) ;
...
stock create_player_maze ( playerid )
{
	...
	UpdateDynamic3DTextLabelText ( maze_text, col_blue, text_label ) ;
...
/*
	...
	new text_label [ 100 ] ;
	format ( text_label, sizeof text_label, "** Ограбление **\n\n{"#cWH3D"}Игроков на квесте: {"#cGN3D"}%d\n{"#cWH3D"}Квест %s", maze_player_quest, ( maze_quest_active == false ) ? ( "{"#cGN3D"}доступен" ) : ( "{"#cRL3D"}занят" ) ) ;
	maze_text = CreateDynamic3DTextLabel ( text_label, col_blue, quest_position [ 1 ] [ 0 ], quest_position [ 1 ] [ 1 ], quest_position [ 1 ] [ 2 ] + 1.0, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, -1, -1, -1 );
	...
	format ( text_label, sizeof text_label, "** Граффити **\n\n{"#cWH3D"}Игроков на квесте: {"#cGN3D"}%d\n{"#cWH3D"}Квест %s", graffity_player_quest, ( graffity_quest_active == false ) ? ( "{"#cGN3D"}доступен" ) : ( "{"#cRL3D"}занят" ) ) ;
	graffity_text = CreateDynamic3DTextLabel ( text_label, col_blue, quest_position [ 2 ] [ 0 ], quest_position [ 2 ] [ 1 ], quest_position [ 2 ] [ 2 ] + 1.0, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, -1, -1, -1 );
	...
	format ( text_label, sizeof text_label, "** Сено **\n\n{"#cWH3D"}Игроков на квесте: {"#cGN3D"}%d\n{"#cWH3D"}Квест %s", hay_player_quest, ( hay_quest_active == false ) ? ( "{"#cGN3D"}доступен" ) : ( "{"#cRL3D"}занят" ) ) ;
	hay_text = CreateDynamic3DTextLabel ( text_label, col_blue, quest_position [ 10 ] [ 0 ], quest_position [ 10 ] [ 1 ], quest_position [ 10 ] [ 2 ] + 1.0, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, -1, -1, -1 );
	...
	format ( text_label, sizeof text_label, "** Сбор яиц **\n\n{"#cWH3D"}Игроков на квесте: {"#cGN3D"}%d\n{"#cWH3D"}Квест %s", eggs_player_quest, ( eggs_quest_active == false ) ? ( "{"#cGN3D"}доступен" ) : ( "{"#cRL3D"}занят" ) ) ;
	eggs_text = CreateDynamic3DTextLabel ( text_label, col_blue, quest_position [ 11 ] [ 0 ], quest_position [ 11 ] [ 1 ], quest_position [ 11 ] [ 2 ] + 1.0, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, -1, -1, -1 );
	...
	format ( text_label, sizeof text_label, "** Дойка коров **\n\n{"#cWH3D"}Игроков на квесте: {"#cGN3D"}%d\n{"#cWH3D"}Квест %s", milking_player_quest, ( milking_quest_active == false ) ? ( "{"#cGN3D"}доступен" ) : ( "{"#cRL3D"}занят" ) ) ;
	milking_text = CreateDynamic3DTextLabel ( text_label, col_blue, quest_position [ 12 ] [ 0 ], quest_position [ 12 ] [ 1 ], quest_position [ 12 ] [ 2 ] + 1.0, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, -1, -1, -1 );
	...
	format ( farm_label, sizeof farm_label, "** Фермер **\n\n{"#cWH3D"}Игроков на квесте:\n\
																...
																{"#cBL3D"}2. {"#cWH3D"}Распыление удобрения: {"#cGN3D"}%d\n\
																{"#cBL3D"}3. {"#cWH3D"}Сбор тыкв: {"#cGN3D"}%d", farmer_player_quest [ 0 ], farmer_player_quest [ 1 ], farmer_player_quest [ 2 ] ) ;
	farmer_text = CreateDynamic3DTextLabel ( farm_label, col_blue, quest_position [ 13 ] [ 0 ], quest_position [ 13 ] [ 1 ], quest_position [ 13 ] [ 2 ] + 1.0, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, -1, -1, -1 );
	...
	meat_text = CreateDynamic3DTextLabel ( farm_label, col_blue, quest_position [ 16 ] [ 0 ], quest_position [ 16 ] [ 1 ], quest_position [ 16 ] [ 2 ] + 1.0, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, -1, -1, -1 );
	...
	cow_food_text = CreateDynamic3DTextLabel ( farm_label, col_blue, quest_position [ 17 ] [ 0 ], quest_position [ 17 ] [ 1 ], quest_position [ 17 ] [ 2 ] + 1.0, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, -1, -1, -1 );
	...
	fruit_text = CreateDynamic3DTextLabel ( farm_label, col_blue, quest_position [ 18 ] [ 0 ], quest_position [ 18 ] [ 1 ], quest_position [ 18 ] [ 2 ] + 1.0, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, -1, -1, -1 );
*/
	// Черепахи
	...
	turtle_text = CreateDynamic3DTextLabel ( farm_label, col_blue, quest_position [ 25 ] [ 0 ], quest_position [ 25 ] [ 1 ], quest_position [ 25 ] [ 2 ] + 1.0, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, -1, -1, -1 );
	...
	pearle_text = CreateDynamic3DTextLabel ( farm_label, col_blue, quest_position [ 26 ] [ 0 ], quest_position [ 26 ] [ 1 ], quest_position [ 26 ] [ 2 ] + 1.0, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, -1, -1, -1 );
