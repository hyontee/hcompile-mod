...
stock start_medic_actor ( )
{
	...
	static const _skin_id [ ] = { 33, 35, 185, 300, 303, 301 } ;
	...
	medic_label [ _random ] = CreateDynamic3DTextLabel ( "** Больной **\n{"#cGR3D"}Нажмите {"#cWH3D"}ALT{"#cGR3D"} для взаимодействия", col_blue, actor_medic_position [ _random ] [ 0 ], actor_medic_position [ _random ] [ 1 ], actor_medic_position [ _random ] [ 2 ], 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0 ) ;
...
stock destroy_medic_actor ( _actor_id )
{
	...
	DestroyActor ( medic_actor_id [ _actor_id ] ) ;
