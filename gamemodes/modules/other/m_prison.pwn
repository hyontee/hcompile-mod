...
#define skin_male			4694
#define skin_female			4695
...
{
	{ "Регистратура", 9048, { 790.5913, -853.5228, 1504.2799, 0.0000, 0.0000, 0.0000 }, prison_interior, prison_virtualworld },
	{ "Железные двери #1", 9047, { 788.0096, -845.9285, 1504.1873, 0.0000, 0.0000, 88.1498 }, prison_interior, prison_virtualworld },
	{ "Железные двери #2", 9047, { 788.0634, -835.4782, 1504.2000, 0.0000, 0.0000, 87.5000 }, prison_interior, prison_virtualworld },
	{ "Камера #1", 9046, { 793.8906, -820.0518, 1502.2351, 0.0000, 0.0000, 0.0000 }, prison_interior, prison_virtualworld },
	{ "Камера #2", 9046, { 793.8704, -814.9892, 1502.3052, -0.0499, 0.0000, 0.0499 }, prison_interior, prison_virtualworld },
	{ "Камера #3", 9046, { 793.8566, -809.8868, 1502.3070, 0.0000, 0.0000, 0.0000 }, prison_interior, prison_virtualworld },
	{ "Камера #4", 9046, { 793.8659, -804.8505, 1502.3076, 0.0000, 0.0000, -0.0499 }, prison_interior, prison_virtualworld },
	{ "Камера #5", 9046, { 793.8717, -799.7669, 1502.3126, 0.0000, 0.0000, 0.0000 }, prison_interior, prison_virtualworld },
	{ "Камера #6", 9046, { 793.8721, -794.6632, 1502.3126, 0.0000, 0.0000, 0.0000 }, prison_interior, prison_virtualworld },
	{ "Камера #7", 9046, { 793.8628, -789.5840, 1502.3126, 0.0000, 0.0000, 0.0000 }, prison_interior, prison_virtualworld },
	{ "Камера #8", 9046, { 793.8685, -784.5403, 1502.3126, 0.0000, -0.4499, 0.0000 }, prison_interior, prison_virtualworld },
	{ "Камера #9", 9046, { 793.8664, -784.5333, 1505.6671, 0.0000, 0.0000, 0.0000 }, prison_interior, prison_virtualworld },
	{ "Камера #10", 9046, { 793.8694, -789.5907, 1505.6568, 0.0000, 0.0000, 0.0000 }, prison_interior, prison_virtualworld },
	{ "Камера #11", 9046, { 793.8612, -794.6713, 1505.6667, 0.0000, 0.0000, 0.0000 }, prison_interior, prison_virtualworld },
	{ "Камера #12", 9046, { 793.8661, -799.7652, 1505.6667, 0.0000, 0.0000, 0.0000 }, prison_interior, prison_virtualworld },
	{ "Камера #13", 9046, { 793.8714, -804.8505, 1505.6571, 0.0000, 0.0000, -0.0499 }, prison_interior, prison_virtualworld },
	{ "Камера #14", 9046, { 793.8664, -809.8923, 1505.6567, 0.0000, 0.0000, 0.0000 }, prison_interior, prison_virtualworld },
	{ "Камера #15", 9046, { 793.8602, -814.9856, 1505.6636, 0.0000, 0.0000, 0.0000 }, prison_interior, prison_virtualworld },
	{ "Уличная дверь", 9046, { -1761.8937, -2826.6472, 14.1966, 0.0000, 0.0000, 60.0000 }, 0, 0 }
} ;
	...
	if ( GetPlayerState ( playerid ) == PLAYER_STATE_ONFOOT )
	{
		switch ( area_info [ areaid ] [ a_type ] )
		{
			case area_type_prison:
			{
				...
				if ( prison_door_toggled [ i ] == true ) send_check_cinfo ( playerid, global_string, 1, -1, CINFO_PRISON_ID, CINFO_TYPE_AREA, PICTURE_INFO_DOOR, "Закрыть", "" ) ;
				else send_check_cinfo ( playerid, global_string, 1, -1, CINFO_PRISON_ID, CINFO_TYPE_AREA, PICTURE_INFO_DOOR, "Открыть", "" ) ;
				return 1 ;
			}
			case area_type_prison_electric:
			{
				...
				{
					send_check_cinfo ( playerid, "Трансформатор. Нажмите для взаимодействия", 1, 500, CINFO_PRISON_ELECTRIC_ID, CINFO_TYPE_AREA, PICTURE_INFO_SUCESS, "Взломать", "" ) ;
				}
				return 1 ;
			}
		}
...
stock prison_OnPlayerSyncDeath ( playerid, killerid )
{
	...
	{
		if ( random ( 10 ) == 1 ) give_player_item_prise ( playerid, 19773, 1, 30 ) ;
	}
	return 1 ;
}
...
stock prison_KeyStateChange ( playerid, newkeys, oldkeys )
{
	...
	if ( newkeys & KEY_CTRL_BACK )
	{
		...
		{
			if( get_player_item_prise ( playerid, 161 ) < 1 ) 
			...
			clear_player_item_prise ( playerid, 162, 1 ) ;
