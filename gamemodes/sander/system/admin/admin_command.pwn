...
{
	if(GetPlayerAdminEx(playerid) < 4 && GetPlayerYouTubeEx(playerid) < 1) return ShowNotificationSander(playerid, 2, 3, 0, 0, "У вас нет доступа к использованию данной команде", " ");
