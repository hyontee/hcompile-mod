...
#define SERVER_NAME "SAGE MOBILE"
#define FORUM_NAME ""


#define MYSQL_HOST "127.0.0.1"
#define MYSQL_USER "gs344641"
#define MYSQL_PASS "a8iCHS4M91Zy"
#define MYSQL_DB   "gs344641"
...
{
    SendClientMessage(playerid, COLOR_WHITE, "Добро пожаловать на {FFFF00}SAGE MOBILE");
    SendClientMessage(playerid, COLOR_WHITE, "Телеграм канал разработки: {FFFF00}t.me/");
    SendClientMessage(playerid, COLOR_WHITE, "Телеграм канал {FFFF00}t.me/");
    return 1;
}
