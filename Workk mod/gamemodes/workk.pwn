...
#define MYSQL_PASS "Danyal4ik2012"
#define MYSQL_DB   "gs350476"
...
{
    SetGameModeText("white RP MySQL");
    ShowNameTags(1);
...
public OnAccountCheck(playerid)
{
    ...
    {
        ShowPlayerDialog(playerid, DIALOG_REGISTER, DIALOG_STYLE_PASSWORD, "�����������", "{FFFFFF}����� ���������� �� white RP!\n���������� ������ ��� �����������:", "�����", "�����");
    }
    return 1;
}
...
{
    SendClientMessage(playerid, COLOR_WHITE, "����� ���������� �� {FFFF00}white RP");
    SendClientMessage(playerid, COLOR_WHITE, "�������� ����� ����������: {FFFF00}t.me/dev_whiterp");
    SendClientMessage(playerid, COLOR_WHITE, "�������� ����� white'�: {FFFF00}t.me/crmp_white");
    return 1;
}
...
// �������� 
#include "white/summer_event.inc"
#include "white/autumn_event.inc"
#include "white/admin.inc"
#include "white/chat.inc"
