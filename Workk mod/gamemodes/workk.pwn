...
{
    print("\n----------------------------------");
    print(" Мод с 0 By makvin ураааа");
    print("----------------------------------\n");
}
...

{
    ...
    format(string, sizeof(string), 
        ...
        "Привет! Дорогой игрок, ты зашел в игру под названием MINE RUSSIA.\n\

        Пожалуйста, соблюдай все игровые правила, работай, развивайся и наслаждайся.\n\n\

        И да, кстати, подпишись, пожалуйста, на наш ТГК:\n\
