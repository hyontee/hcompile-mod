...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    if(dialogid == 5990)
    {
        if(response)
        {
            ...
            if(!(rate >= price)) return SendClientMessage(playerid, -1, "Ваша ставка должна превышать минимальную ставку на лот.");
            ...
            {   
                if(old_rate != -1)
                {
                    ...
                    foreach(new i : Player)
                    {
                        ...
                        give_money = true;
                        SendClientMessage(i, -1, "Вашу ставку перебили. Деньги возвращены");
                        break;
                    }
                ...
                SendClientMessage(playerid, -1, "Вы успешно сделали ставку на лот.");
            }
        }
    ...
    if(dialogid == 5991)
    {
        ...
        switch(GetPVarInt(playerid, "select_param"))
        {
            ...
            case 2: // opisanie
            {
                //if(!inputtext) return SendClientMessage(playerid, -1, "Нельзя оставлять описание пустым");
            ...
            case 3://price
            {
                ...
                if(price >= 1_000_000_001 || price <= 4_999) return SendClientMessage(playerid, -1, "Введите сумму от 5000 руб до 1000000000 руб");
                ...
                if(num[0] == 0)
                {
                    ...
                    for(new i, sql = GetPlayerAccountID(playerid);i < MAX_AUCTION_SLOT;i++)
                    {
                        ...
                        if(auction_slot[i][SLOT_NAME] == TYPE_VEHICLE && auction_slot[i][DATABASE_ID] == id_car) 
                            return SendClientMessage(playerid, -1, "Транспорт на аукционе");
        ...
        if(response)
        {
            ...
            else if(player_info_panel[playerid][filter_type] == 2)
            {
                ...
                else
                {
                    ...
                    {
                        SendClientMessage(playerid, 0xFFFFFFFF, "Минимальная цена должна быть меньше чем максимальная");
                        player_info_panel[playerid][filter_type] = 0;
                    ...
                    {
                        SendClientMessage(playerid, 0xFFFFFFFF, "Цена должна быть от 1000 руб до 500000000 руб");
                        player_info_panel[playerid][filter_type] = 0;
...
public OnPlayerClickPlayerTextDraw(playerid, PlayerText:playertextid)
{
    ...
    {
        if(!player_info_panel[playerid][opisanie_tovar]) return SendClientMessage(playerid, -1, " Сначало напишите описание");
    ...
    {
        if(!player_info_panel[playerid][type_tovar]) return SendClientMessage(playerid, -1, "Сначало выберите тип товара");
        ...
        switch(GetPVarInt(playerid, "type_param"))
        {
            case TYPE_VEHICLE:
            {
                ...
                else SendClientMessage(playerid, -1, "Ваш транспорт не загружен на сервер");
            }
            case TYPE_BUSINESS:
            {
                ...
                else SendClientMessage(playerid, -1, "У вас нет бизнеса");
            }
            case TYPE_HOUSE:
            {
                ...
                else SendClientMessage(playerid, -1, "У вас нет недвижимости");
            }
            case TYPE_SUM_NUMBER:
            {
                ...
                else SendClientMessage(playerid, -1, "У вас нет сим-карта");
            }
            case TYPE_VEHICLE_NUMBER:
            {
                new Cache:result;
                ...
                if(!cache_num_rows()) return SendClientMessage(playerid, -1, "У вас нет транспорта с номером");
            ...
            case TYPE_CLOTHES:
            {
                ...
                if(!cache_num_rows()) return SendClientMessage(playerid, -1, "У вас нет свободной одежды");
    ...
    {
        if(!player_info_panel[playerid][tovar]) return SendClientMessage(playerid, -1, "Сначало выберите товар");
    ...
    if(playertextid == auction_PTD[playerid][37])
    {
        ...
        if(auction_slot[id_slot][TIMER_END] <= gettime()) return SendClientMessage(playerid, -1, "Время вышло. Лот скоро удалиться.");
        ...
        {
            SendClientMessage(playerid, -1, "Вы не можете сделать ставку на свой лот.");
            return 1;
        }
        else if(auction_slot[id_slot][OWNER_RATE] == GetPlayerAccountID(playerid))
        {
            SendClientMessage(playerid, -1, "Вы уже сделали ставку.");
            return 1;
        }
        ...
        switch(auction_slot[id_slot][SLOT_TYPE])
        {
            case TYPE_BUSINESS:
            {
                if(GetPlayerBusiness(playerid) != -1) return SendClientMessage(playerid, -1, "У вас уже имеется бизнес");
                ...
                for(new i, account = GetPlayerAccountID(playerid); i < MAX_AUCTION_SLOT; i ++)
                {
                    ...
                    SendClientMessage(playerid, -1, "Вы уже делали ставку на другой бизнес.");
                    return 1;   
                }
            }
            case TYPE_HOUSE:
            {
                if(GetPlayerHouse(playerid) != -1) return SendClientMessage(playerid, -1, "У вас уже имеется недвижемость");
                ...
                for(new i, account = GetPlayerAccountID(playerid); i < MAX_AUCTION_SLOT; i ++)
                {
                    ...
                    SendClientMessage(playerid, -1, "Вы уже делали ставку на другую недвижимость.");
                    return 1;   
                }
            }
            case TYPE_VEHICLE_NUMBER:
            {
                ...
                if(!rows) return SendClientMessage(playerid, -1, "У вас нет транспорта без номерного знака");
            ...
            case TYPE_SUM_NUMBER:
            {
                if(GetPlayerPhone(playerid)) 
                {
                    for(new i; i < 5; i++) SendClientMessage(playerid, -1, "У вас уже есть сим-карта. При выйгрыше она измениться на новую");
                }
            }
        }
    ...
    {
        if(!player_info_panel[playerid][price_tovar]) return SendClientMessage(playerid, -1, "Сначало выберите все");
        ...
        if(type == TYPE_VEHICLE)
        {
            if(GetPlayerOwnableCar(playerid) != GetPVarInt(playerid, "tovar_param_server"))
                return SendClientMessage(playerid,-1, "Ваш транспорт выгружен");
...
CMD:auction(playerid)
{
 ...
 //  if(!(8 <= hour <= 21)) return SendClientMessage(playerid, -1, "Аукцион работает с 8:00 до 22:00");
...
stock create_auction_slot(playerid, type, opisanie[124], start_rate, data_base, server_id, number_vehicle[7] = "", number_SUM = 0)
{
    ...
    if(stop_create) return SendClientMessage(playerid, -1, "Вы уже выставляли данный товар.");
    ...
    if(id == -1) return SendClientMessage(playerid, -1, "В данный момент достигнут лимит слотов в аукционе.");
    ...
    SendClientMessage(playerid, -1, "Вы выставили слот на аукцион");
    return 1;
}
...
stock finish_auction_slot(slot)
{
    ...
    foreach(new i : Player)
    {
        ...
        {
            SendClientMessage(i, -1, "Поздравляем! Вы получили деньги за слот с аукциона");
            money_give = true;
    ...
    switch(auction_slot[slot][SLOT_TYPE])
    {
        case TYPE_BUSINESS:
        {
            foreach(new i : Player)
            {
                if(auction_slot[slot][OWNER_RATE] == GetPlayerAccountID(i)) SendClientMessage(i, -1, "Поздравляем! Вы получили бизнес с аукциона");
            }
        ...
        case TYPE_HOUSE:
        {
            foreach(new i : Player)
            {
                if(auction_slot[slot][OWNER_RATE] == GetPlayerAccountID(i)) SendClientMessage(i, -1, "Поздравляем! Вы получили недвижимость с аукциона");
            }
        ...
        case TYPE_VEHICLE:
        {
            foreach(new i : Player)
            {
                if(auction_slot[slot][OWNER_RATE] == GetPlayerAccountID(i)) SendClientMessage(i, -1, "Поздравляем! Вы получили транспорт с аукциона");
            }
        ...
        case TYPE_VEHICLE_NUMBER:
        {
            foreach(new i : Player)
            {
                if(GetPlayerAccountID(i) == auction_slot[slot][OWNER_RATE]) SendClientMessage(i, -1, "Поздравляем! Вы приобрели на номерной знак");
                if(GetPlayerAccountID(i) == auction_slot[slot][OWNER_SLOT_SQL]) SendClientMessage(i, -1, "Поздравляем! Вы продали на номерной знак");
            }
        ...
        case TYPE_SUM_NUMBER:
        {
            ...
            foreach(new i : Player)
            {
                if(GetPlayerAccountID(i) == auction_slot[slot][OWNER_RATE])
                {
                    ...
                    SendClientMessage(i, -1, "Поздравляем! Вы приобрели на аукционе сим-карту");
                }

                if(GetPlayerAccountID(i) == auction_slot[slot][OWNER_SLOT_SQL])
                {
                    SetPlayerData(i, P_PHONE, 0);
                    SendClientMessage(i, -1, "Поздравляем! Вы продали на аукционе сим-карту");
                }
            }
        ...
        case TYPE_CLOTHES:
        {
            foreach(new i : Player)
            {
                if(GetPlayerAccountID(i) == auction_slot[slot][OWNER_RATE]) SendClientMessage(i, -1, "Поздравляем! Вы приобрели на аукционе одежду");
                if(GetPlayerAccountID(i) == auction_slot[slot][OWNER_SLOT_SQL]) SendClientMessage(i, -1, "Поздравляем! Вы продали на аукционе одежду");
            }
