...
{
    //19133
    CreateDynamicPickupEx(1318, 23, -2512.555908,2910.743164,40.274486);
    ...
    CreateDynamicPickupEx(1318, 23, -2507.844482,2912.990234,37.695709);
...
CMD:wedding(playerid, params[])
{
    ...
    ShowNewNotification(playerid, 4, 5, YES_WEDDING, 1, string64, "");
    return 1;
}
