...
public OnPlayerClickPlayerTextDraw(playerid, PlayerText:playertextid)
{
    ...
    if(playertextid == auction_PTD[playerid][33])
    {
        ...
        if(!have_sell) return ShowNotificationBR(playerid, 2, "У вас нет ставок на продажу", 3, "", "");
    ...
    if(playertextid == auction_PTD[playerid][34])
    {
        ...
        if(!have_buy) return ShowNotificationBR(playerid, 2, "У вас нет ставок на покупку", 3, "", ""); 
    ...
    if(playertextid == auction_PTD[playerid][37])
    {
        ...
        if(GetPlayerMoneyEx(playerid) < auction_slot[id_slot][CURRENT_RATE])
        {
            ...
            ShowNotificationBR(playerid, 2, dialog, 2, "", "");
