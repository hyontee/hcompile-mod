...
#define MAX_CASE_REWARDS 50

enum E_PLAYER_REWARD
{
    rCase,
    rItem,
    rBonus
...
new g_PlayerRewards[MAX_PLAYERS][MAX_CASE_REWARDS][E_PLAYER_REWARD];
...
{
    ShowNotificationNew(playerid, 3, 3, 0, 0, message);
    return 1;
}
...
stock SavePlayerCaseRewardDB(playerid, case_id, item_id, bool:is_premium)
{
    new query[256];
    mysql_format(mysql, query, sizeof(query),
        "INSERT INTO player_rewards (account_id,case_id,item_id,is_premium,created_at) VALUES (%d,%d,%d,%d,UNIX_TIMESTAMP())",
        GetPlayerAccountID(playerid),
        case_id,
        item_id,
        is_premium ? 1 : 0
