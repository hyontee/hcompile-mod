    ...
    if(dialogid == 5992) // согласие
    {
        ...
        switch(GetPVarInt(playerid, "type_param"))
        {
            ...
            case TYPE_CLOTHES:
            {
                ...
                format(text, sizeof text, "Вы хотите выставить на аукцион одежду?");
...
public OnGameModeInit()
{
    ...
    CreateDynamicPickup(1318, 23, 2092.610351,-2283.928955,23.096267, 0, 0);
    CreateDynamicPickup(1318, 23, 999.965148,2488.335205,1499.304687, AUCTION_WORLD, 1);
    Create3DTextLabel("Аукцион", 0x3399FFEE, 2092.610351,-2283.928955,23.096267, 10.0, 0);
...
public: SetBusinessName()
{
    ...
    mysql_format(mysql, text, sizeof text, "UPDATE business SET `name`='Аксессуары' WHERE `type` = 13");
    mysql_query(mysql, text, false);
