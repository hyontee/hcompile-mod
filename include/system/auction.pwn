...
{
    {"txd:braucnulist", "txd:brauculist"},
...
public:PlayerTextDrawAuction(playerid)
{
    ...
    PlayerTextDrawLetterSize(playerid, auction_PTD[playerid][1], 0.2480, 1.3330);
    ...
    auction_PTD[playerid][6] = CreatePlayerTextDraw(playerid, 174.6666, 293.9630, "txd:braucnulist");
    ...
    PlayerTextDrawLetterSize(playerid, auction_PTD[playerid][8], 0.2350, 1.4262);
    ...
    auction_PTD[playerid][10] = CreatePlayerTextDraw(playerid, 174.6666, 144.6296, "txd:braucnulist");
    ...
    auction_PTD[playerid][14] = CreatePlayerTextDraw(playerid, 174.6666, 195.2370, "txd:braucnulist");
    ...
    auction_PTD[playerid][18] = CreatePlayerTextDraw(playerid, 174.6666, 244.6000, "txd:braucnulist");
