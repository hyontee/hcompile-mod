        ...
        if(response)
        {
            ...
            else
            {
                ...
                (
                    ...
                    "{E0584B}SIMPLE RUSSIA | {FFFFFF}Предоплата",
                    "Без доплаты\n"\
                    "Доплачиваете Вы\n"\
                    "Доплачивает Игрок",
                    "Выбрать", "Отмена"
...
stock bool:Exchange_ShowVehicleList(viewerid, ownerid, page = 0, bool:is_select_other = false)
{
    ...
    Dialog(viewerid, 1612, DIALOG_STYLE_TABLIST_HEADERS, "{E0584B}SIMPLE RUSSIA | {FFFFFF}Выберете что обменять", dialog, "Выбрать", "Отмена");
...
stock ShowDialogSelectTypeExchange(playerid)
{
    if(player_exchange[playerid] != -1)
    {
        ...
        (
            ...
            "{E0584B}SIMPLE RUSSIA | {FFFFFF}Выберете тип имущества",
...
stock SendExchange(playerid)
{
    ...
    (
        ...
        "{E0584B}SIMPLE RUSSIA | {FFFFFF}Обмен",
        string_284,
        "Обмен", "Выйти"
    );
