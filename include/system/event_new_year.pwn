...
{
    print("[SANDER_SYSTEM] Новогодние квесты загружены\nАвтор: https://t.me/welsistudio");
...
stock UnLoadPlayerData_NewYear(playerid)
{
 //Автор данного ивента https://t.me/welsistudio (Welsi Studio)
    ...
    if(GetPVarInt(playerid, "quest_5_new_year"))    RemoveQuestNewYear(playerid, 5);//Автор данного ивента https://t.me/welsistudio (SANDER_SYSTEM)
