...
new BlackJackSphere[MAX_BJ_LOBBY];
...
stock LoadBJLobbyTimer(lobby)
{
    ...
    // Lobby countdown TextDraw intentionally removed: it must not appear outside Blackjack.
...
stock GiveTableBlackJack(lobby, playerid, table)
{
    ...
    PlayerTextDrawSetString(playerid, bj_panel_info[playerid], "blackjack:brbjyoubj");
    PlayerTextDrawHide(playerid, bj_panel_info[playerid]);
    BlackJackLobby[lobby][TableTurnTime] = 0;
    BlackJackLobby[lobby][TableTurn]++;
}
