...
stock ShowTuningStylingGUI(playerid)
{
    ...
    SendPacketToClient(playerid, 28, tuning_json);
...
stock BuyStylingTuningPart(playerid, vehicleid, detail_id)
{
    ...
    {
        ShowNotificationSander(playerid, 2, 5, 0, 0, "Дальний свет временно отключен.", "");
        return 0;
    }
...
stock PacketIncomingVehicleRadial(playerid, Node:JSONObject)
{
    ...
    switch(type)
    {
        ...
        case 5:
        {
            ...
            {
                radial_state = 0;
                ShowNotificationSander(playerid, 2, 5, 0, 0, "Launch-control не установлен.", "");
            }
            else
            {
        ...
        case 8..11:
        {
            ...
            else ShowNotificationSander(playerid, 2, 5, 0, 0, "Прошивка установлена не полностью.", "");
        }
        case 12:
        {
            ...
            {
                radial_state = 0;
                ShowNotificationSander(playerid, 2, 5, 0, 0, "Подсветка не установлена.", "");
            }
            else
            {
        ...
        case 15:
        {
            ...
            {
                radial_state = 0;
                ShowNotificationSander(playerid, 2, 5, 0, 0, "Стробоскопы не установлены.", "");
            }
            else
            {
        ...
        case 16..18:
        {
            ...
            else ShowNotificationSander(playerid, 2, 5, 0, 0, "Пневмоподвеска не установлена.", "");
        }
        case 19:
        {
            ...
            {
                radial_state = 0;
                ShowNotificationSander(playerid, 2, 5, 0, 0, "Гидравлика не установлена.", "");
            }
            else
            {
...
stock CloseTuningGUI(playerid)
{
    ...
    SendPacketToClient(playerid, 28, json);
    JSON_Cleanup(json);
    ...
    JSON_SetInt(tuning_response, "m", GetPlayerMoneyEx(playerid));
        ...
        case 7:
        {
            ...
            if(BuyTechTuningPart(playerid, vehicleid, detail_id) ||
                ...
                RaceSto_TryPurchase(playerid, vehicleid, detail_id))
            {
