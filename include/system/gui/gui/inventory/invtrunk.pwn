...
new g_vehicle_trunk_data[MAX_VEHICLES][35][E_TRUNK_ITEM_STRUCT];
    ...
    switch(type)
    {
        case 0: // Из инвентаря в багажник
        {
            ...
            if(vehicleid == INVALID_VEHICLE_ID)
            {
                ...
                ShowNotificationSander(playerid, 2, 6, -1, -1, debug_msg, "");
            ...
            if(item_id == 134)  // ID скина
            {
                ...
                ShowNotificationSander(playerid, 2, 5, -1, -1, debug_msg, "");
            }
    ...
    else if(item_id == 81 || item_id == 82)  // Номера без региона
    {
        ...
        ShowNotificationSander(playerid, 2, 5, -1, -1, debug_msg, "");
            ...
            else
            {
                ...
                ShowNotificationSander(playerid, 2, 4, -1, -1, debug_msg, "");
            }
        ...
        case 2: // Из активного слота в инвентарь
        {
            ...
            {
                ShowNotificationSander(playerid, 2, 6, -1, -1, "Ошибка: Нельзя снять одежду (ID: 134, слот: 6)", "");
        ...
        case 8:
        {
            ...
            ShowNotificationSander(playerid, 2, 4, -1, -1, "Режим инвентаря сброшен (typeinv=0)", "");
        }
