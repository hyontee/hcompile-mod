...
{//цена в тысячах
    ...
    {"Rolls-Royce Phantom VIII",          48683700,     40000,   2, 250.00, 6.00},     // 422
    {"ЗАМЕНА! ",                       0,     60000,   2, 250.00, 5.00},     // 423
    {"Lamborghini Urus",                 15000000,    15000,  2, 320.00, 3.00},    // 424
    {"Hunter",              0,          0,      0},     // 425
    ...
    {"Batmobile",            80000000,    38000,  0, 246.00, 5.00},     // 434
    {"Прицеп",              0,          0,      0},     // 435
    ...
    {"Coastg",              0,          0,      0},     // 472
    {"Dinghy",              0,          0,      0},     // 473
    {"Lamborghini Vision Gran-turismo",              20000000,    15000,  2, 320.00, 3.00},    // 474
    ...
    {"ГАЗ 53",              0,          0,      0},     // 499
    {"ГАЗ 69",              100000000,    0,  0, 250.00, 7.00},     // 500
    {"RCgobl",              0,          0,      0},     // 501
    ...
    {"BMW M5 CS",             100000000,    10000,  2, 400.00, 3.00},     // 517
    {"Bugatti LaNoir",            999999999,    99999,  2, 425.00, 2.00},     // 518
    {"Shamal",              0,          0,      0},     // 519
    ...
    {"Bugatti Divo",             320000000,    32000,  2, 400.00, 2.00},     // 535
    ...
    {"Пожарка",             0,          0,      0},     // 544
    {"BMW M8",         13500000,     10000,   2, 280.00, 5.10},    // 545
    ...
    {"Mercedes-Benz G63 AMG",             23000000,    50000,  0, 290.00, 4.00},     // 554
    ...
    {"Rolls-Royce Cullinan I",                       68990000,     60000,   2, 250.00, 5.00},     // 575
    ...
    {"RCcam",               0,          0,      0},     // 594
    {"Launch",              0,          0,      0},     // 595
    {"BMW M5 Ф90 (ППС)",             50000000,    0,  0, 250.00, 7.00},     // 596
    {"VAZ 2172 (ППС)",             30000000,    0,  0, 250.00, 7.00},     // 597
    {"GETTA (ППС)",             20000000,    0,  0, 250.00, 7.00},     // 598
    {"samp мил",             0,          0,      0},     // 599
