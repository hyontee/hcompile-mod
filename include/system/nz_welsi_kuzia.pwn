...
stock TextDrawNomer()
{
    ...
    nz_TD[6] = TextDrawCreate(185.3333, 10.3851, "PEÇÖCèPAâÖï_ÇOC._àHAKA_AãèOMOÄÖáï");
    ...
    nz_TD[7] = TextDrawCreate(143.6666, 302.0001, "C¶oúØoc¶©_ÆoØepÆ®x_üÆako¢:");
    ...
    nz_TD[8] = TextDrawCreate(143.9999, 326.4740, "C¶oúØoc¶©_úüØeÆeÆú¨_ÆoØepÆ®x_üÆako¢:");
    ...
    nz_TD[10] = TextDrawCreate(206.3332, 179.2147, "ã®ópaÆ®ù_ÆoØep_óyöe¶_£oc¶a¢ûeÆ_Æa_¢a•_¶paÆc£op¶");
...
public OnPlayerClickTextDraw(playerid, Text:clickedid)
{
    if(clickedid == nz_TD[1])
    {
	    ...
	    format(fmt_text, sizeof fmt_text, "¬˚ ÍÛÔËÎË ÌÓÏÂ‡ ÙÓÏ‡Ú‡: {ffcd00}\"%s\" {66cc33}Á‡ 5000 Û·", player_select_nz);
	    SendClientMessage(playerid, 0x66CC33FF, fmt_text);

	    GivePlayerMoneyEx(playerid, -5000, "œÓÍÛÔÍ‡ ÌÓÏÂÓ‚", true, true);
    ...
    if(clickedid == nz_TD[4])
    {
        ...
        GivePlayerMoneyEx(playerid, -2000, "œÓÍÛÚÍ‡ Ì/Á");
