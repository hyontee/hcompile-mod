...
new setting_vehicle[210][STRUCT_VEHICLE] =
{
    ...
    {1700.0 ,   5008.0 ,  0.75, 0.85, 0.5 , 	5, 280.0, 18.7, 35.0 ,	    6.2  ,  	-0.14, 0.5 },
    {1300.0 ,   2200.0 ,  0.75, 0.80, 0.52,     5, 160.0, 15.0, 10.0 ,	    8.0  , 	    -0.15, 0.57},
    {1500.0 ,   4000.0 ,  0.7 , 0.9 , 0.5 , 	5, 315.0, 20.5, 10.0 ,  	11.0 ,  	-0.24, 0.5 },
    {3800.0 ,  19953.2 ,  0.95, 0.65, 0.4 , 	5, 120.0, 25.0, 30.0 ,  	8.0  ,  	-0.20, 0.5 },
    {1200.0 ,   3000.0 ,  0.70, 0.90, 0.48, 	5, 150.0, 13.0, 122.0,  	4.0  ,  	-0.17, 0.5 },
    {1600.0 ,   4000.0 ,  0.75, 0.75, 0.5 , 	5, 305.0, 18.9, 20.0 ,  	10.0 ,  	-0.20, 0.5 }	,
    {20000.0,  200000.0,  0.78, 0.8 , 0.55,     4, 110.0, 25.0, 30.0 , 	    3.17 ,  	-0.30, 0.55}	,
    {6500.0 ,  36670.8 ,  0.55, 0.8 , 0.5 , 	5, 170.0, 27.0, 10.0 ,   	10.00,  	-0.17, 0.5 }	,
    {5500.0 ,  33187.9 ,  0.70, 0.9 , 0.5 , 	4, 110.0, 20.0, 30.0 ,   	3.5  ,  	-0.25, 0.55}	,
    {2200.0 ,  10000.0 ,  0.70, 0.8 , 0.5 , 	5, 180.0, 18.0, 25.0 ,   	10.0 ,  	-0.20, 0.5 }	,
    {1000.0 ,   1400.0 ,  0.80, 0.8 , 0.5 , 	5, 280.0, 20.0, 10.0 ,   	8.0  ,  	-0.15, 0.5 }	,
    {1400.0 ,   2725.3 ,  0.80, 0.8 , 0.50, 	5, 224.0, 30.0, 10.0 ,   	11.0 ,  	-0.10, 0.5 }	,
    {1800.0 ,   4411.5 ,  0.95, 0.80, 0.45, 	5, 160.0, 23.0, 19.0  ,   	6.50 ,  	-0.25, 0.5 }	,
    {2600.0 ,   8666.7 ,  0.55, 0.90, 0.50, 	5, 160.0, 15.0, 25.0 ,   	6.0  ,  	-0.15, 0.25}	,
    {3500.0 ,  14000.0 ,  0.55, 0.85, 0.46, 	5, 140.0, 18.0, 20.0 ,   	4.5  ,  	-0.15, 0.5 }	,
    {1200.0 ,   3000.0 ,  0.80, 0.9 , 0.50,     5, 350.0, 24.0, 7.0  ,   	11.1 ,  	-0.15, 0.5 }	,
    {1900.0 ,   6333.3 ,  0.75, 0.80, 0.47, 	5, 160.0, 13.0, 75.0 ,   	7.0  ,  	-0.20, 0.5 }	,
    {2000.0 ,   5848.3 ,  0.70, 0.80, 0.50, 	5, 150.0, 15.0, 15.0 ,   	5.5  ,  	-0.15, 0.55}	,
    {1800.0 ,   4350.0 ,  0.55, 0.88, 0.52, 	5, 160.0, 18.0, 16.0  ,   	4.0  ,  	-0.18, 0.5 }	,
    {1600.0 ,   4000.0 ,  0.80, 0.75, 0.45, 	5, 205.0, 20.8, 23.0 ,   	9.1  ,  	-0.15, 0.54}	,
    {1850.0 ,   5000.0 ,  0.75, 0.65, 0.52, 	4, 187.0, 13.5, 99.0 ,   	7.5  ,  	-0.20, 0.5 }	,
    {1700.0 ,   4000.0 ,  0.75, 0.85, 0.57, 	5, 165.0, 20.0, 15.0 ,   	8.5  ,  	-0.18, 0.4 }	,
    {1700.0 ,   4108.3 ,  0.75, 0.75, 0.5 , 	5, 145.0, 14.0, 50.0 ,   	4.17 ,  	-0.15, 0.5 }	,
    {1200.0 ,   2000.0 ,  0.75, 0.85, 0.5,      4, 170.0, 30.0, 10.0 , 	    6.0  ,  	-0.15, 0.45}	,
    {1600.0 ,   3921.3 ,  0.75, 0.85, 0.52, 	5, 200.0, 22.0, 10.0 ,   	10.0 ,  	-0.12, 0.38}	,
    {4000.0 ,  17333.3 ,  0.55, 0.8 , 0.48, 	5, 170.0, 20.0, 20.0 ,   	5.4  ,  	-0.25, 0.5 }	,
    {7000.0 ,  30916.7 ,  0.50, 0.7 , 0.46, 	5, 170.0, 15.0, 30.0 ,   	8.4  ,  	-0.15, 0.5 }	,
    {1400.0 ,   3000.0 ,  0.75, 0.89, 0.50, 	5, 318.0, 22.5, 10.0 ,   	8.0  ,  	-0.15, 0.5 }	,
    {5500.0 ,  33187.9 ,  0.75, 0.85, 0.40, 	4, 130.0, 14.0, 50.0 ,   	4.17 ,  	-0.25, 0.45}	,
    {25000.0,  250000.0,  2.50, 0.8 , 0.5 , 	4, 280.0 ,40.0 ,150.0 ,   	5.0  , 	    -0.10, 0.5 }	,
    {10500.0,   61407.5,  0.75, 0.7 , 0.47, 	5, 180.0, 20.0, 50.0 ,   	4.00 ,  	-0.17, 0.5 }	,
    {1400.0 ,   3400.0 ,  0.75, 0.8 , 0.5 , 	5, 200.0, 28.0, 5.0  ,   	11.0 ,  	-0.20, 0.4 }	,
    {3800.0 ,  30000.0 ,  0.45, 0.75, 0.5 , 	5, 120.0, 18.0, 5.0  ,   	8.0  ,  	-0.15, 0.5 }	,
    {1400.0 ,   3000.0 ,  0.70, 0.80, 0.45,     5, 242.0, 16.8, 44.0 ,   	8.0  ,  	-0.18, 0.55}	,
    {9500.0 ,  57324.6 ,  0.75, 0.85, 0.35, 	5, 160.0, 18.0, 10.0 , 	    5.7  ,  	-0.25, 0.5 }	,
    {1400.0 ,   4000.0 ,  0.75, 0.85, 0.51, 	5, 238.0, 15.5, 90.0 , 	    7.0  ,  	-0.30, 0.5 }	,
    {1600.0 ,   3921.3 ,  0.80, 0.75, 0.55, 	4, 160.0, 23.0, 5.0  , 	    8.17 ,  	-0.2 , 0.5 }	,
    {2000.0 ,   4901.7 ,  0.7 , 0.75, 0.52, 	5, 160.0, 18.0, 15.0 , 	    5.5  ,  	-0.11, 0.5 }	,
    {100.0  ,    24.1  ,  0.80, 0.90, 0.49, 	1,  75.0, 35.0, 5.0  , 	    5.5  ,  	-0.08, 0.5 }	,
    {2500.0 ,   5960.4 ,  0.75, 0.80, 0.50, 	5, 150.0, 16.0, 15.0 , 	    4.0  ,  	-0.15, 0.4 }	,
    {8000.0 ,  48273.3 ,  0.75, 0.85, 0.35, 	5, 150.0, 13.0, 5.0  , 	    5.7  ,  	-0.25, 0.5 }	,
    {5000.0 ,  20000.0 ,  0.75, 0.85, 0.55,     5, 110.0, 45.0, 25.0 , 	    7.0  ,  	-0.30, 0.5 }	,
    {1650.0 ,   3851.4 ,  0.75, 0.90, 0.51, 	5, 258.0, 16.4, 67.0 , 	    8.5  ,  	-0.19, 0.5 }	,
    {1900.0 ,   4795.9 ,  0.97, 0.77, 0.51, 	5, 150.0, 25.0, 5.0  , 	    8.5  ,  	-1.00, 0.4 }	,
    {25500.0,  139272.5,  0.58, 0.7 , 0.46, 	5, 140.0, 24.0, 5.0  , 	    10.00,  	-0.17, 0.5 }	,
    {3800.0 ,  30000.0 ,  0.45, 0.75, 0.5 , 	5, 120.0, 18.0, 5.0  , 	    8.0  ,  	-0.15, 0.5 }	,
    {2200.0 ,  29333.3 ,  3.00, 15.0, 0.65, 	5, 190.0, 3.0 , 5.0  ,   	0.02 ,  	 0.05, 0.0  }	,
    {8500.0 ,  48804.2 ,  0.70, 0.7 , 0.46, 	5, 140.0, 25.0, 80.0 , 	    10.00,  	-0.17, 0.5 }	,
    {4500.0 ,  18003.7 ,  0.55, 0.70, 0.48,     5, 160.0, 14.0, 40.0 ,   	4.5  ,  	-0.25, 0.5 }	,
    {1000.0 ,   1354.2 ,  0.55, 0.85, 0.5 , 	3, 160.0, 15.0, 30.0 ,   	13.0 ,  	-0.13, 0.5 }	,
    {3000.0 ,  3500.0  ,  0.75, 0.75, 0.6 ,     4 , 130.0, 30.0, 50.0 ,      8.0  ,      -0.1 , 0.4 },
    {1400.0 ,   3000.0 ,  0.75, 0.85, 0.45, 	5, 240.0, 30.0, 10.0 , 	    11.0 ,  	-0.20, 0.5  }	,
    {1600.0 ,   4000.0 ,  0.70, 0.84, 0.52, 	5, 305.0, 20.8, 23.0 ,  	6.2  ,  	-0.22, 0.5 }	,
    {1900.0 ,   4529.9 ,  0.77, 0.75, 0.52, 	5, 140.0, 13.0, 150.0,  	5.0  ,  	-0.17, 0.5 }	,
    {2500.0 ,   7968.7 ,  0.70, 0.85, 0.5 , 	5, 170.0, 25.0, 20.0 ,  	8.0  ,  	-0.35, 0.5 }	,
    {1950.0 ,   4712.5 ,  0.70, 0.75, 0.51, 	5, 160.0, 18.0, 15.0 ,  	3.5  ,  	-0.20, 0.58}	,
    {1700.0 ,   4000.0 ,  0.70, 0.80, 0.53, 	5, 250.0, 16.5, 23.0 ,  	8.0  ,  	-0.20, 0.5 }	,
    {1400.0 ,   2979.7 ,  0.80, 0.80, 0.51, 	5, 200.0, 28.0, 10.0 ,  	11.1 ,      -0.15, 0.5 },
    {1850.0 ,   3534.0 ,  0.70, 0.70, 0.5 , 	4, 150.0, 14.0, 25.0 ,  	6.5  ,  	-0.18, 0.4 }	,
    {1500.0 ,   3800.0 ,  0.75, 0.85, 0.52, 	5, 170.0, 13.0, 150.0,  	5.0  , 	    -0.17, 0.5 }	,
    {1400.0 ,   2200.0 ,  0.70, 0.9 , 0.5 , 	5, 250.0, 17.7, 30.0 ,   	11.0 ,  	-0.15, 0.5 }	,
    {1900.0 ,   5000.0 ,  0.70, 0.87, 0.51, 	5, 150.0, 25.0, 100.0,  	8.5  ,  	-0.25, 0.4 }	,
    {1900.0 ,   4000.0 ,  0.60, 0.80, 0.46, 	5, 120.0, 16.0, 20.0 ,     	8.5  ,  	-0.10, 0.4 }	,
    {1000.0 ,   1354.2 ,  1.00, 0.85, 0.5 , 	3, 160.0, 20.0, 30.0 ,     	5.0  ,  	-0.10, 0.5 }	,
    {10000.0,   35000.0,  0.85, 0.8 , 0.60,     5, 100.0, 35.0, 150.0,   	5.0  ,  	-0.20, 0.35}	,
    {2500.0 ,   7604.2 ,  0.70, 0.85, 0.54,     5, 250.0, 16.5, 40.0 ,   	7.0  ,  	-0.25, 0.45}	,
    {3500.0 ,  11156.2 ,  0.80, 0.80, 0.52,     5, 260.0, 18.2, 38.0 ,   	8.5  ,  	-0.20, 0.5 }	,
    {1700.0 ,   3435.4 ,  0.70, 0.86, 0.5 , 	4, 160.0, 18.0, 15.0 ,   	7.0  ,  	-0.15, 0.5 }	,
    {1600.0 ,   4000.0 ,  0.70, 0.8 , 0.52, 	4, 160.0, 20.0, 20.0 ,   	5.4  ,  	-0.20, 0.5 }	,
    {1200.0 ,   3000.0 ,  0.85, 0.80, 0.48, 	0, 320.0, 20.9, 3.0  ,   	10.0 ,      -0.16, 0.6 },
    {2000.0 ,   4000.0 ,  0.75, 0.85, 0.5 , 	5, 210.0, 16.3, 37.0 ,   	8.0  ,  	-0.31, 0.5 }	,
    {1000.0 ,   2141.7 ,  0.85, 0.85, 0.5 , 	5, 200.0, 26.0, 5.0  ,   	11.0 ,  	-0.12, 0.5 }	,
    {5500.0 ,  23489.6 ,  0.82, 0.70, 0.46, 	5, 140.0, 14.0, 45.0 ,   	4.5  ,  	-0.25, 0.35}	,
    {3500.0 ,  13865.8 ,  0.75, 0.70, 0.46, 	5, 140.0, 14.0, 20.0 ,   	4.5  ,  	-0.15, 0.45}	,
    {1300.0 ,   1900.0 ,  0.70, 0.80, 0.50, 	5, 160.0, 24.0, 15.0 ,   	8.0  ,  	-0.20, 0.35}	,
    {2100.0 ,   5146.7 ,  0.75, 0.70, 0.52, 	5, 160.0, 24.0, 5.0  ,   	6.2  ,  	-0.24, 0.5 }	,
    {1400.0 ,   2800.0 ,  0.75, 0.86, 0.48, 	5, 230.0, 26.0, 5.0  ,   	8.0  ,  	-0.10, 0.5 }	,
    {2200.0 ,   5000.0 ,  0.70, 0.80, 0.46, 	5, 240.0, 15.4, 50.0 ,   	6.0  ,  	-0.15, 0.5 }	,
    {3500.0 ,  13865.8 ,  0.72, 0.70, 0.46, 	5, 140.0, 14.0, 25.0 ,   	4.5  ,  	-0.15, 0.5 }	,
    {3800.0 ,  20000.0 ,  0.85, 0.75, 0.4 , 	5, 120.0, 25.0, 20.0 ,   	8.0  ,  	-0.20, 0.5 }	,
    {5000.0 ,  28000.0 ,  0.95, 0.75, 0.4 , 	5, 120.0, 25.0, 20.0 ,   	8.0  ,  	-0.17, 0.5 }	,
    {1400.0 ,   4000.0 ,  0.75, 0.80, 0.50, 	5, 238.0, 15.5, 90.0 ,   	8.0  ,  	-0.10, 0.58}	,
    {1400.0 ,   3267.8 ,  0.75, 0.80, 0.52, 	5, 165.0, 22.0, 10.0 ,   	7.0  ,  	-0.15, 0.5 }	,
    {1700.0 ,   4500.0 ,  0.70, 0.86, 0.54, 	4, 160.0, 24.0, 15.0 ,   	5.0  ,  	-0.20, 0.54}	,
    {5500.0 ,  33187.9 ,  0.58, 0.8 , 0.5 , 	4, 110.0, 20.0, 20.0 ,   	3.17 , 	    -0.25, 0.55}	,
    {3500.0 ,  12000.0 ,  0.85, 0.70, 0.46, 	5, 160.0, 25.0, 30.0 ,   	6.0  ,  	-0.15, 0.25}	,
    {1700.0 ,   4166.4 ,  0.70, 0.84, 0.53, 	5, 270.0, 18.0, 35.0 ,   	8.17 ,  	-0.10, 0.5 }	,
    {1200.0 ,   2000.0 ,  0.70, 0.86, 0.5 ,     5, 250.0, 17.6, 47.0 ,   	8.0  ,  	-0.08, 0.5 }	,
    {4000.0 ,  10000.0 ,  0.75, 0.85, 0.54,     5, 170.0, 25.0, 25.0 ,   	6.0  ,  	-0.15, 0.5 }	,
    {1800.0 ,   4350.0 ,  0.70, 0.8 , 0.52, 	5, 183.0, 13.6, 100.0,  	5.4  ,  	-0.14, 0.5 }	,
    {1000.0 ,   1354.2 ,  0.80, 0.85, 0.5 , 	3,  60.0, 20.0, 15.0 ,   	6.0  ,  	-0.20, 0.5 }	,
    {2000.0 ,   5000.0 ,  0.90, 0.85, 0.5 , 	4,  70.0, 20.0, 90.0 ,   	15.0 ,  	-0.05, 0.5 }	,
    {8500.0 ,  48804.2 ,  0.88, 0.7 , 0.46, 	5, 140.0, 25.0, 80.0 ,   	10.00,  	-0.11, 0.5 }	,
    {1600.0 ,   4500.0 ,  0.75, 0.9 , 0.5 , 	5, 320.0, 21.0, 5.0  ,   	7.0  ,  	-0.10, 0.5 }	,
    {1800.0 ,   4000.0 ,  0.75, 0.80, 0.56,     5, 235.0, 16.2, 65.0 ,	    6.50 ,  	-0.20, 0.4 }	,
    {1950.0 ,   4712.5 ,  0.75, 0.90, 0.50, 	5, 160.0, 40.0, 10.0 ,   	10.0 ,  	-0.14, 0.5 }	,
    {1500.0 ,   2500.0 ,  0.75, 0.84, 0.53, 	5, 175.0, 13.7, 100.0,  	8.17 ,  	-0.15, 0.44}	,
    {5500.0 ,  65000.0 ,  0.58, 0.8 , 0.5 , 	4, 110.0, 20.0, 20.0 ,   	3.17 , 	     0.0 , 0.55}	,
    {5500.0 ,  65000.0 ,  0.58, 0.8 , 0.5 , 	4, 110.0, 20.0, 20.0 ,   	3.17 , 	    -0.10, 0.55}	,
    {1800.0 ,   3000.0 ,  0.70, 0.8 , 0.5 , 	5, 210.0, 13.4, 80.0 ,   	5.4  ,  	-0.16, 0.56}	,
    {1200.0 ,   2500.0 ,  0.75, 0.90, 0.48, 	5, 330.0, 24.9, 12.0 ,   	8.0  ,  	-0.10, 0.45}	,
    {1400.0,    3000.0 ,  0.73, 0.89, 0.47,	    5, 280.0, 19.9, 40.0, 	    24.0 ,	    -0.12, 0.3	}	,
    {1600.0 ,   3000.0 ,  0.75, 0.80, 0.52, 	5, 142.0, 12.9, 90.0 ,   	8.0  ,  	-0.10, 0.5 }	,
    {1700.0 ,   4500.0 ,  0.75, 0.70, 0.5 , 	5, 165.0, 25.0, 20.0 ,   	8.5  ,  	-0.15, 0.4 }	,
    {1700.0 ,   4108.3 ,  0.85, 0.85, 0.51, 	5, 160.0, 20.0, 5.0  ,   	6.2  ,  	-0.15, 0.5 }	,
    {1700.0 ,   4000.0 ,  0.75, 0.75, 0.52, 	5, 160.0, 22.0, 10.0 ,   	8.0  ,  	-0.15, 0.5 }	,
    {1800.0 ,   4350.0 ,  0.70, 0.8 , 0.49, 	5, 160.0, 18.0, 25.0 ,   	5.4  ,  	-0.15, 0.54}	,
    {1600.0 ,   3300.0 ,  0.70, 0.8 , 0.54, 	4, 160.0, 18.0, 7.0  ,   	5.4  ,  	-0.14, 0.5 }	,
    {1700.0 ,   4166.4 ,  0.70, 0.85, 0.52, 	4, 120.0, 22.0, 260.0,  	8.17 ,  	-0.16, 0.5 }	,
    {1600.0 ,   3550.0 ,  0.70, 0.8 , 0.52, 	5, 240.0, 16.7, 60.0 ,   	5.4  ,  	-0.12, 0.55}	,
    {1800.0 ,   4500.0 ,  0.75, 0.8 , 0.49, 	5, 307.0, 20.8, 20.0 ,   	9.0  ,  	-0.08, 0.54}	,
    {2600.0 ,   8666.7 ,  0.85, 0.70, 0.46, 	5, 160.0, 18.0, 10.0 ,   	6.0  ,  	-0.18, 0.25}	,
    {3000.0 ,   6000.0 ,  0.70, 0.80, 0.4 , 	5, 170.0, 25.0, 15.0 ,   	8.5  ,  	-0.20, 0.5 }	,
    {1500.0 ,   3500.0 ,  0.55, 0.85, 0.5 , 	4, 120.0, 12.5, 280.0,  	8.0  ,  	-0.10, 0.5 }	,
    {5000.0 ,  20000.0 ,  0.75, 0.85, 0.55,     5, 110.0, 45.0, 25.0 ,   	7.0  ,  	-0.30, 0.5 }	,
    {5000.0 ,  20000.0 ,  0.75, 0.85, 0.55,     5, 110.0, 45.0, 25.0 ,   	7.0  ,  	-0.30, 0.5 }	,
    {1400.0 ,   2998.3 ,  0.80, 0.85, 0.47,     5, 250.0, 19.3, 40.0 ,   	8.0  , 	    -0.10, 0.5 }	,
    {1500.0 ,   3600.0 ,  0.85, 0.8 , 0.5 , 	5, 220.0, 15.1, 95.0 ,   	10.0 ,  	-0.15, 0.5 }	,
    {1400.0 ,   3400.0 ,  0.80, 0.8 , 0.5 , 	5, 250.0, 16.6, 60.0 ,   	10.0 ,  	-0.20, 0.5 }	,
    {15000.0,   81250.0,  0.55, 0.8 , 0.7 , 	1, 200.0, 16.0, 5.0  ,   	1.5  ,  	-0.00, 0.3 }	,
    {1500.0 ,   3500.0 ,  0.75, 0.9 , 0.5 , 	5, 252.0, 16.5, 60.0 ,   	8.0  ,  	-0.10, 0.5 }	,
    {100.0  ,    24.1  ,  0.70, 0.9 , 0.49, 	1,  75.0, 35.0, 15.0 ,   	5.0  ,  	-0.14, 0.5 }	,
    {1400.0 ,   2998.3 ,  0.75, 0.9 , 0.5 , 	5, 248.0, 18.4, 60.0 ,   	8.0  ,  	-0.10, 0.5 }	,
    {1800.0 ,   4000.0 ,  0.75, 0.85, 0.52,     5, 160.0, 24.0, 10.0 ,   	7.0  ,  	-0.20, 0.45}	,
    {1500.0 ,   2500.0 ,  0.70, 0.84, 0.55, 	4, 160.0, 24.0, 5.0  ,   	8.17 ,  	-0.15, 0.3 }	,
    {1000.0 ,   2500.3 ,  0.70, 0.88, 0.55, 	4, 170.0, 35.0, 5.0  ,   	6.1  ,  	-0.20, 0.35}	,
    {5500.0 ,  33187.9 ,  0.58, 0.8 , 0.5 , 	4, 110.0, 20.0, 20.0 ,   	03.17,  	 0.0 , 0.55}	,
    {5500.0 ,  33187.9 ,  0.58, 0.8 , 0.5 , 	4, 110.0, 20.0, 20.0 ,   	03.17,  	-0.10, 0.55}	,
    {300.0  ,   150.0  ,  0.90, 0.85, 0.48, 	4,  90.0, 18.0, 5.0  ,   	15.0 ,  	-0.04, 0.5 }	,
    {800.0  ,   500.0  ,  0.70, 0.80, 0.48, 	3,  60.0, 12.0, 30.0 ,   	6.1  ,  	-0.05, 0.5 }	,
    {10000.0,   50000.0,  0.75, 0.85, 0.5 , 	5, 110.0, 35.0, 25.0 ,   	7.0  ,  	-0.40, 0.5 }	,
    {800.0  ,   632.7  ,  0.70, 0.80, 0.46, 	3,  60.0, 12.0, 30.0 ,   	6.1  ,  	-0.10, 0.5 }	,
    {1700.0 ,   4166.4 ,  0.75, 0.75, 0.46, 	4, 160.0, 20.0, 10.0 ,   	6.0  ,  	-0.14, 0.5 }	,
    {1700.0 ,   4166.4 ,  0.75, 0.75, 0.52, 	4, 160.0, 20.0, 10.0 ,   	6.0  ,  	-0.15, 0.5 }	,
    {5500.0 ,  33187.9 ,  0.75, 0.8 , 0.40,     5, 110.0, 20.0, 20.0 ,   	3.5  ,  	-0.25, 0.55}	,
    {2500.0 ,   6000.0 ,  0.72, 0.89, 0.5 , 	5, 230.0, 18.4, 25.0 , 	    7.0  ,  	-0.21, 0.45}	,
    {2200.0 ,   6000.0 ,  0.75, 0.92, 0.5 , 	5, 165.0, 24.0, 15.0 , 	    5.0  ,  	-0.22, 0.5 }	,
    {1900.0 ,   6333.3 ,  0.85, 0.70, 0.46, 	5, 147.0, 13.0, 80.0 , 	    6.0  ,  	-0.15, 0.45}	,
    {800.0  ,   632.7  ,  0.85, 0.80, 0.46, 	4, 170.0, 15.0, 30.0 , 	    6.1  ,  	-0.10, 0.5 }	,
    {3800.0 ,  30000.0 ,  0.45, 0.75, 0.5 , 	5, 120.0, 18.0, 5.0  , 	    8.0  ,  	-0.15, 0.5 }	,
    {1800.0 ,   4000.0 ,  0.75, 0.80, 0.52, 	5, 160.0, 13.4, 75.0 , 	    8.0  ,  	-0.10, 0.5 }	,
    {5500.0 ,  33187.9 ,  0.58, 0.8 , 0.5 , 	4, 110.0, 20.0, 20.0 , 	    03.17,  	-0.25, 0.55}	,
    {1400.0 ,   2998.3 ,  0.70, 0.8 , 0.5 , 	5, 266.0, 18.4, 50.0 , 	    8.0  ,  	-0.10, 0.5 }	,
    {5500.0 ,  23489.6 ,  0.72, 0.70, 0.46, 	5, 140.0, 14.0, 25.0 , 	    4.5  ,  	-0.24, 0.4 }	,
    {1400.0 ,   3000.0 ,  0.75, 0.90, 0.49,     5, 246.0, 15.9, 80.0 , 	    11.0 ,  	-0.12, 0.5 }	,
    {3800.0 ,  30000.0 ,  0.45, 0.75, 0.5 , 	5, 120.0, 18.0, 5.0  ,  	8.0  ,  	-0.15, 0.5 }	,
    {100.0  ,    50.0  ,  0.70, 0.90, 0.49, 	1,  60.0, 50.0, 10.0 ,  	5.5  ,  	-0.15, 0.5 }	,
    {1600.0 ,   4000.0 ,  0.75, 0.85, 0.50, 	5, 305.0, 20.8, 23.0 ,  	10.0 ,  	-0.12, 0.55}	,
    {1800.0 ,   4350.0 ,  0.75, 0.85, 0.52, 	5, 183.0, 13.6, 100.0,  	10.0 ,  	-0.17, 0.55}	,
    {1400.0 ,   4000.0 ,  0.75, 0.85, 0.52, 	5, 238.0, 15.5, 90.0 ,  	10.0 ,  	-0.17, 0.55}	,
    {2500.0 ,   5500.0 ,  0.75, 0.85, 0.55, 	5, 160.0, 30.0, 15.0 ,  	6.2  ,  	-0.25, 0.5 }	,
    {1600.0 ,   3800.0 ,  0.75, 0.70, 0.52,     5, 165.0, 25.0, 20.0 , 	    8.5  ,  	-0.15, 0.4 }	,
    {5000.0 ,  10000.0 ,  0.75, 0.7 , 0.46, 	5, 110.0, 24.0, 25.0 ,   	6.4  ,  	-0.18, 0.5 }	,
    {1500.0 ,   3400.0 ,  0.7 , 0.8 , 0.5 , 	5, 200.0, 23.0, 5.0  ,   	7.0  ,  	-0.15, 0.5 }	,
    {1500.0 ,   4000.0 ,  0.7 , 0.9 , 0.52,     5, 270.0, 19.4, 20.0 ,   	6.0  ,  	-0.24, 0.59}	,
    {1000.0 ,   1354.2 ,  1.00, 0.85, 0.5 , 	3, 160.0, 20.0, 30.0 ,   	5.0  ,  	-0.10, 0.5 }	,
    {1000.0 ,   1354.2 ,  1.00, 0.85, 0.5 , 	3, 160.0, 20.0, 30.0 ,   	5.0  ,  	-0.10, 0.5 }	,
    {1000.0 ,   2500.0 ,  1.00, 0.85, 0.5 , 	3, 160.0, 20.0, 30.0 ,   	5.0  ,  	-0.10, 0.5 }	,
    {5500.0 ,  23489.6 ,  0.82, 0.70, 0.46, 	5, 140.0, 14.0, 25.0 ,   	4.5  ,  	-0.25, 0.35}	,
    {400.0  ,   400.0  ,  0.70, 0.85, 0.5 , 	3, 160.0, 20.0, 30.0 ,   	5.0  ,  	-0.10, 0.5 }	,
    {1000.0 ,   1354.2 ,  1.00, 0.85, 0.5 , 	3, 160.0, 20.0, 30.0 ,   	5.0  ,  	-0.10, 0.5 }	,
    {1800.0 ,   4500.0 ,  0.70, 0.85, 0.5 , 	5, 250.0, 20.0,  5.0 ,   	7.0  ,  	-0.16, 0.5}	,
    {1800.0 ,   4500.0 ,  0.70, 0.85, 0.5 , 	5, 250.0, 20.0,  5.0 ,   	7.0  ,  	-0.16, 0.5}	,
    {1800.0 ,   4500.0 ,  0.70, 0.85, 0.5 , 	5, 250.0, 20.0,  5.0 ,   	7.0  ,  	-0.16, 0.5}	,
    {1800.0 ,   4500.0 ,  0.70, 0.85, 0.5 , 	5, 250.0, 20.0,  5.0 ,   	7.0  ,  	-0.16, 0.5}	,
    {1800.0 ,   4500.0 ,  0.70, 0.85, 0.5 , 	5, 250.0, 20.0,  5.0 ,   	7.0  ,  	-0.16, 0.5}	,
    ...
    {1800.0 ,   4500.0 ,  0.70, 0.85, 0.5 , 	5, 250.0, 20.0,  5.0 ,   	7.0  ,  	-0.16, 0.5}	,
    {1800.0 ,   4500.0 ,  0.70, 0.85, 0.5 , 	5, 250.0, 20.0,  5.0 ,   	7.0  ,  	-0.16, 0.5}	,
    {2200.0 ,  29333.3 ,  2.30, 15.0, 0.58, 	5, 190.0, 1.7 , 5.0  ,   	0.05 ,  	 0.1 , 0.0 },
    {2200.0 ,  20210.7 ,  2.5 , 15.0, 0.65, 	5, 190.0, 2.5 , 5.0  ,   	0.04 ,  	 0.5 , 2.0 },
    {5000.0 ,  25520.8 , -1.50, 15.0, 0.45, 	5, 190.0, 0.7 , 5.0  ,   	0.02 ,  	 0.1 , 0.0 },
    {3000.0 ,  17312.5 , -4.00, 25.0, 0.50, 	5, 190.0, 0.5 , 5.0  ,   	0.02 ,  	 0.1 , 0.0 },
    {2200.0 ,  29333.3 ,  3.00, 15.0, 0.65, 	5, 190.0, 3.0 , 5.0  ,   	0.02 ,  	 0.05, 0.0 },
    {2200.0 ,  29333.3 ,  2.20, 12.0, 0.45, 	5, 190.0, 1.4 , 5.0  ,   	0.05 ,  	 0.1 , 0.0 },
    {1200.0 ,   6525.0 ,  2.00, 4.2 , 0.70, 	5, 190.0, 1.6 , 5.0  ,   	0.05 ,  	 0.1 , 2.5 },
    {800.0  ,  1483.3  ,  3.50, 3.5 , 1.00, 	5, 190.0, 1.2 , 5.0  ,   	0.07 ,  	 0.1 , 0.7 },
    {5000.0 , 155520.8 , -3.50, 25.0, 0.40, 	5, 190.0, 0.5 , 5.0  ,   	0.04 ,  	 0.0 , 1.0 },
    {3000.0 ,  40000.0 ,  2.00, 15.0, 0.50, 	5, 190.0, 3.0 , 5.0  ,   	0.02 ,  	 0.3 , 1.5 },
    {2200.0 ,  20210.7 ,  1.5 , 15.0, 0.65, 	5, 190.0, 1.5 , 5.0  ,   	0.03 ,  	 0.5 , 2.0 },
    {5000.0 ,  27083.3 ,  0.83, 45.0, 0.5 , 	1, 200.0,  1.7, 5.0  ,   	0.01 ,  	 0.0 , 2.0 },
    {1900.0 ,   4795.9 ,  0.05, 1.0 , 0.5 , 	5, 150.0,  2.0, 5.0  ,   	1.0  ,  	-0.25, 0.5 },
    {5000.0 ,  27083.3 ,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	1.5  ,  	-0.20, 0.5 },
    {10000.0,   80000.0,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	1.5  ,  	-0.10, 0.35},
    {5000.0 ,  27083.3 ,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	1.5  ,  	-0.05, 0.5 },
    {5000.0 ,  20000.0 ,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	1.5  ,  	-0.10, 0.9 },
    {15000.0,   81250.0,  0.55, 0.8 , 0.7 , 	1, 200.0, 16.0, 5.0  ,   	1.5  ,  	-0.00, 0.3 },
    {9000.0 ,  48750.0 ,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	1.5  ,  	-0.20, 0.8 },
    {25000.0,  438750.0,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	1.0  ,  	-0.30, 0.5 },
    {60000.0, 9000000.0,  1.5 , 0.9 , 0.85,     1, 200.0, 16.0, 5.0  ,   	1.0  ,  	-0.20, 0.3 },
    {40000.0, 3000000.0,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	1.0  ,  	-0.20, 0.5 },
    {5000.0 ,  27083.3 ,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	1.5  ,  	-0.05, 0.2 },
    {2500.0 ,   6041.7 ,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	5.0  ,  	-0.20, 0.5 },
    {3000.0 ,   7250.0 ,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	5.0  ,  	-0.20, 0.5 },
    {5000.0 ,  29270.8 ,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	5.0  ,  	-0.20, 0.5 },
    {3500.0 ,   8458.3 ,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	5.0  ,  	-0.20, 0.5 },
    {4500.0 ,  26343.7 ,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	5.0  ,  	-0.20, 0.5 },
    {10000.0,  150000.0,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	5.0  ,  	-0.15, 0.85},
    {15000.0,  200000.0,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	5.0  ,  	-0.20, 0.9 },
    {20000.0,   48333.3,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	5.0  ,  	-0.10, 0.3 },
    {10000.0,   96666.7,  0.75, 0.9 , 0.5 , 	1, 200.0, 16.0, 5.0  ,   	5.0  ,  	-0.15, 0.5 },
    {100.0  ,    50.0  ,  0.20, 0.9 , 0.5 , 	1,  75.0,  1.0, 5.0  ,   	0.5  ,  	-0.00, 0.8 },
    {100.0  ,    24.1  ,  1.10, 0.75, 0.50, 	1,  75.0, 35.0, 5.0  ,   	5.5  ,  	-0.08, 0.5 },
    {100.0  ,    24.1  ,  1.10, 0.75, 0.50, 	1,  75.0, 35.0, 5.0  ,   	5.5  ,  	-0.08, 0.5 }
};
...
{
    stg_TD[0] = TextDrawCreate(487.6665, 150.4369, "txd:brtuning2service");
    ...
    stg_TD[1] = TextDrawCreate(12.0833, 152.9257, "txd:brtuning4info");
    ...
    stg_TD[2] = TextDrawCreate(186.3332, 389.7853, "txd:brtuning4cost");
    ...
    stg_TD[3] = TextDrawCreate(186.9998, 419.6520, "txd:brtuning2buy");
    ...
    stg_TD[4] = TextDrawCreate(334.6665, 419.6520, "txd:brtuning2exit");
...
{
    stg_PTD[playerid][0] = CreatePlayerTextDraw(playerid, 506.0000, 164.1257, "txd:brtuning4stg1");
    ...
    stg_PTD[playerid][1] = CreatePlayerTextDraw(playerid, 505.3334, 202.2888, "txd:brtuning4stg2");
    ...
    stg_PTD[playerid][2] = CreatePlayerTextDraw(playerid, 506.0000, 240.0368, "txd:brtuning4stg3");
    ...
    stg_PTD[playerid][3] = CreatePlayerTextDraw(playerid, 9999.0000, 9999.7850, "txd:brtuning4stg4");
    ...
    stg_PTD[playerid][4] = CreatePlayerTextDraw(playerid, 9999.3332, 9999.8445, "txd:brtuning4nstage4");
    ...
    stg_PTD[playerid][5] = CreatePlayerTextDraw(playerid, 21.6665, 297.0742, "55555555555555555");
    ...
    stg_PTD[playerid][6] = CreatePlayerTextDraw(playerid, 22.0832, 210.4814, "66666666666666");
    ...
    stg_PTD[playerid][7] = CreatePlayerTextDraw(playerid, 22.0832, 340.6299, "777777777");
    ...
    stg_PTD[playerid][8] = CreatePlayerTextDraw(playerid, 22.0832, 253.5186, "88888888888888");
    ...
    stg_PTD[playerid][9] = CreatePlayerTextDraw(playerid, 385.6665, 395.3333, "0000");
    ...
    stg_PTD[playerid][10] = CreatePlayerTextDraw(playerid, 22.4998, 211.0000, "1000000000000");
    ...
    stg_PTD[playerid][11] = CreatePlayerTextDraw(playerid, 22.0832, 297.5927, "1111111111111111111");
    ...
    stg_PTD[playerid][12] = CreatePlayerTextDraw(playerid, 22.4998, 341.1484, "12222222222222222");
    ...
    stg_PTD[playerid][13] = CreatePlayerTextDraw(playerid, 22.4998, 254.0371, "13333333333333333");
