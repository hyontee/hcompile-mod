...
if(clickedid == welsirltk_TD[4])
    ...
    SCM(playerid, -1,"DEBUG: Clickid = 3");
    }
	...
	TogglePlayerControllable(playerid, true);
		...
		TextDrawSetString(casesda_TD[8], "pizda:brgiftsnuautocase");
			...
			TextDrawSetString(casesda_TD[5], "pizda:brgiftsnubronza");
    typecase[playerid] = 0;
    SCM(playerid, -1,"DEBUG: Clickid = 4");
    }
    ...
    SCM(playerid, -1,"DEBUG: Clickid = 5");
    }
    ...
    typecase[playerid] = 2;
    SCM(playerid, -1,"DEBUG: Clickid = 6");
    }
    ...
    typecase[playerid] = 3;
    SCM(playerid, -1,"DEBUG: Clickid = 7");
    }
	...
	TextDrawShowForPlayer(playerid, casesda_TD[8]);
    typecase[playerid] = 4 ;
    SCM(playerid, -1,"DEBUG: Clickid = 8");
    }
    ...
    SCM(playerid, -1,"DEBUG: Clickid = 9");
	}
...
stock RuletkaMenu_2()
{
    ...
    welsirltk_TD_2[34] = TextDrawCreate(580.9998, 2.0888, "t.me/welsistudio"); // пусто
...
random2_2(array_2[], size_w_2 = sizeof(array_2))
 {
	...
	{
		sum_2 += array_2[i_2];
		 if(sum_2 > 0 && random(sum_2) < array_2[i_2])
		  {
			result_2 = i_2;
		  } 
	}
...
stock GivePlayerCarRoulette_2(playerid, modelid_2, color_1_2, color_2_2) 
{
		...
		{
			format(g_ownable_car[idx_2][OC_NUMBER], 12, g_ownable_car[idx_2][OC_NUMBER]);
			SetVehicleRuNumberPlate(vehicleid_2, g_ownable_car[idx_2][OC_NUMBER], "17");
...
stock RuletkaMenu3()
{
    ...
    welsirltk_TD3[34] = TextDrawCreate(580.9998, 2.0888, "t.me/welsistudio"); // пусто
...
random23(array3[], size_w3 = sizeof(array3))
 {
	...
	{
		sum3 += array3[i3];
		 if(sum3 > 0 && random(sum3) < array3[i3])
		  {
			result3 = i3;
		  } 
	}
...
stock GivePlayerCarRoulette3(playerid, modelid3, color_13, color_23) 
{
		...
		{
			format(g_ownable_car[idx3][OC_NUMBER], 12, g_ownable_car[idx3][OC_NUMBER]);
			SetVehicleRuNumberPlate(vehicleid3, g_ownable_car[idx3][OC_NUMBER], "17");
