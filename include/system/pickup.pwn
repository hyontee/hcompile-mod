...
{
     // FIX: playerid was never validated before being used to index
     // g_pickup_flood[playerid] / GetPVarInt/SetPVarInt - an out-of-range
     // playerid here is the segfault root cause reported for this callback.
