        ...
        if(response)
        {
            ...
            else
            {
                ...
                if(money > 10_000_000)
                {
                    ...
                    SetPVarInt(playerid, "selection_listitem", 0);
...
{
    print("[SANDER_SYSTEM] Гоночные дуэли загружены\н");
    TextDrawRace();
...
CMD:gonki(playerid, params[])
{
    ...
    // ?? Списание денег за вызов на дуэль
    new duel_cost = 1000;
    ...
    // ?? Пузырь и сообщение отправителю
    ...
    // ? Чат-сообщение отправителю, что предложение отправлено
