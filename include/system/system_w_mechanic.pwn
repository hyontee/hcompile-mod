...
new model_veh_mex[10] = {412, 492, 500, 503, 516, 415, 2582, 2569, 666, 667};
...
{
    print("[KIRILL_SYSTEM] Работа автомеханика загружена\nАвтор: Welsi Studio");
        ...
        if(response)
        {
            ...
            switch(listitem)
            {
                ...
                case 1:
                {
                   ...
                   new id = NewIdVehMex(), veh_id = model_veh_mex[random(10)], R = random(3) + 1, RR = random(5);
                ...
                case 3:
                {
					...
					{
						new money = (random(50000)*2) + 2500 * GetMexAuto(id_veh);
