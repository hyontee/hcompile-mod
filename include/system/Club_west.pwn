...
/*
    ...
    CreateDynamic3DTextLabel("{ff0000}Ночной клуб\n{ffffff}Вход - 50.000руб", 0xFFFFFFFF, 
        CLUB_ENTER_X, CLUB_ENTER_Y, CLUB_ENTER_Z, 5.0, .testlos = 0, .worldid = -1, .interiorid = 0, .playerid = -1, .streamdistance = 100.0);
    CreateDynamic3DTextLabel("{ffffff}ВЫХОД", 0xFFFFFFFF, 
        CLUB_EXIT_X, CLUB_EXIT_Y, CLUB_EXIT_Z, 5.0, .testlos = 0, .worldid = -1, .interiorid = 1, .playerid = -1, .streamdistance = 100.0);
    CreateDynamic3DTextLabel("{ffff00}МЕНЮ БАРА\n{ffffff}/clubmenu", 0xFFFFFFFF, 
        CLUB_MENU_X, CLUB_MENU_Y, CLUB_MENU_Z, 5.0, .testlos = 0, .worldid = -1, .interiorid = 1, .playerid = -1, .streamdistance = 100.0);
    CreateDynamic3DTextLabel("{00ff00}ПРОДАЖА КОТИКОВ\n{ffffff}/koti", 0xFFFFFFFF, 
        CLUB_KOTI_X, CLUB_KOTI_Y, CLUB_KOTI_Z, 5.0, .testlos = 0, .worldid = -1, .interiorid = 1, .playerid = -1, .streamdistance = 100.0);
    
    CreateActorEx("", "{FFFF00}Продажа на#котиков\n{FFFFFF}Подойдите для взаимодействия", 236, CLUB_KOTI_X, CLUB_KOTI_Y, CLUB_KOTI_Z, 175.167251, 0, 1);
    
    vhodmoon_pickup = CreatePickup(1273, 1, CLUB_ENTER_X, CLUB_ENTER_Y, CLUB_ENTER_Z, -1);
    exitmoon_pickup = CreatePickup(1273, 1, CLUB_EXIT_X, CLUB_EXIT_Y, CLUB_EXIT_Z, -1);
    clubmenu_pickup = CreatePickup(1239, 1, CLUB_MENU_X, CLUB_MENU_Y, CLUB_MENU_Z, -1);
*/

// ==============================================
// ВСТАВЬ В OnPlayerPickUpPickup
// ==============================================
...
// ==============================================
// ТАЙМЕР ВХОДА - ТЕЛЕПОРТ НА 7.679895!
// ==============================================
...
/*
    if(dialogid == 5001) // МЕНЮ БАРА
    {
        ...
        new items[][] = {"Лимонад", "Пиво", "Вино", "Шампанское", "Водка", "Коньяк", "Виски", "Абсент", "Закуска", "Сигара"};
