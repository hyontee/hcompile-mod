...
public OnPlayerDisconnect(playerid, reason)
{
    ...
    #if defined tun_OnPlayerDisconnect
        return tun_OnPlayerDisconnect(playerid, reason);
    #else
        return 1;
    #endif
}
...
#endif
#define OnPlayerDisconnect tun_OnPlayerDisconnect
#if defined tun_OnPlayerDisconnect
    forward tun_OnPlayerDisconnect(playerid, reason);
#endif
