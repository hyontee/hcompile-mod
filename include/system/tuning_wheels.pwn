...
public OnPlayerClickTextDraw(playerid, Text:clickedid)
{
    if(clickedid == welsi_tun_TD[3])
    {
        ...
        if(GetPlayerMoneyEx(playerid) >= price)
        {
            ...
            {//Автор системы: Welsi. (t.me/welsistudio) 
                case 4:SendClientMessage(playerid, -1, "Успешно");
                case 1:SendClientMessage(playerid, -1, "Успешно");
                case 2:SendClientMessage(playerid, -1, "Успешно");
                case 3:SendClientMessage(playerid, -1, "Успешно");
            }
