...
new second_auction = 10800; //тут менять время аукциона
       ...
       default:
        {
            ...
            {   
                ...
                {
                    format(stats, sizeof stats, "%d. %s (%d)\t\t\t\t%d р.\n", c+1, auction_business[c][name_business],
auction_business[c][id_business_sql], auction_business[c][last_rate]);
                    strcat(dialog, stats);
