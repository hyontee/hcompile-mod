    ...
    for(new playerid = 0; playerid < MAX_PLAYERS; playerid++)
    {
        if(g_scrap_yard_player_vehicle[playerid] != INVALID_VEHICLE_ID)
        {
            if(IsPlayerConnected(playerid))
                ShowNotificationSander(playerid, 2, 5, 0, 0, "\xD1\xEB\xEE\xEC\xE0\xED\xED\xFB\xE5 \xEC\xE0\xF8\xE8\xED\xFB \xED\xE0 \xF1\xE2\xE0\xEB\xEA\xE5 \xE1\xFB\xEB\xE8 \xEE\xE1\xED\xEE\xE2\xEB\xE5\xED\xFB", " ");
...
public ScrapYard_FinishTake(playerid)
{
    ...
    {
        ShowNotificationSander(playerid, 2, 5, 0, 0, "\xCF\xEE\xE4\xEE\xE9\xE4\xE8\xF2\xE5 \xEA \xEC\xE0\xF8\xE8\xED\xE5", " ");
        return 1;
    }
    ...
    ShowNotificationSander(playerid, 3, 6, 0, 0, text, " ");
    return 1;
}
...
stock ScrapYard_ConvertFoundCarToOwnable(playerid, slot)
{
    ...
    {
        ShowNotificationSander(playerid, 2, 5, 0, 0, "\xD3\x20\xE2\xE0\xF1\x20\xED\xE5\xF2\x20\xF1\xE2\xEE\xE1\xEE\xE4\xED\xEE\xE3\xEE\x20\xF1\xEB\xEE\xEE\xF2\xE0\x20\xE4\xEB\xFF\x20\xEB\xE8\xF7\xED\xEE\xE3\xEE\x20\xD2\xD1", " ");
        return INVALID_VEHICLE_ID;
    }
    ...
    if(mysql_errno())
    {
        ...
        ShowNotificationSander(playerid, 2, 5, 0, 0, "\xCE\xF8\xE8\xE1\xEA\xE0 \xF1\xEE\xF5\xF0\xE0\xED\xE5\xED\xE8\xFF \xD2\xD1", " ");
        return INVALID_VEHICLE_ID;
    }
    ...
    if(vehicleid == INVALID_VEHICLE_ID)
    {
        ...
        ShowNotificationSander(playerid, 2, 5, 0, 0, "\xCD\xE5 \xF3\xE4\xE0\xEB\xEE\xF1\xFC \xE7\xE0\xE3\xF0\xF3\xE7\xE8\xF2\xFC \xD2\xD1", " ");
        return INVALID_VEHICLE_ID;
    }
...
stock ScrapYard_ProcessPlayer(playerid)
{
    ...
    if(near_slot != -1)
    {
        if(old_near_vehicle != near_vehicle)
        {
            ...
            if(g_scrap_yard_owner[near_slot] == -1)
            {
                ...
                ShowNotificationSander(playerid, 5, 10, SCRAP_YARD_CAR_NOTIFY_ID, near_vehicle, text, "\xC7\xC0\xC1\xD0\xC0\xD2\xDC \xCA\x20\xD1\xC5\xC1\xC5");
            }
        }
    }
    ...
    if(npc_near && !old_npc_near)
    {
        ...
        ShowNotificationSander(playerid, 5, 10, SCRAP_YARD_NPC_NOTIFY_ID, 0,
...
stock ScrapYard_OnNotifyClick(playerid, notify_type, notify_id, notify_sub_id)
{
    ...
    if(notify_id == SCRAP_YARD_CAR_NOTIFY_ID)
    {
        ...
        {
            ShowNotificationSander(playerid, 2, 5, 0, 0, "\xDD\xF2\xF3 \xEC\xE0\xF8\xE8\xED\xF3 \xF3\xE6\xE5 \xE7\xE0\xE1\xF0\xE0\xEB\xE8", " ");
            return 1;
        }

        if(ScrapYard_GetPlayerOwnableFoundVehicle(playerid) != INVALID_VEHICLE_ID)
        {
            ShowNotificationSander(playerid, 2, 5, 0, 0, "\xD3 \xE2\xE0\xF1 \xF3\xE6\xE5 \xE5\xF1\xF2\xFC \xED\xE0\xE9\xE4\xE5\xED\xED\xE0\xFF \xEC\xE0\xF8\xE8\xED\xE0. \xD1\xED\xE0\xF7\xE0\xEB\xE0 \xF0\xE5\xF8\xE8\xF2\xE5, \xE5\xE5 \xEF\xF0\xEE\xE4\xE0\xF2\xFC \xE8\xEB\xE8 \xEE\xF1\xF2\xE0\xE2\xFC\xF2\xE5 \xF1\xE5\xE1\xE5.", " ");
            return 1;
        }
...
stock ScrapYard_OnPlayerEnterVehicle(playerid, vehicleid)
{
    if(ScrapYard_FindSlotByVehicle(vehicleid) != -1)
    {
        ...
        ShowNotificationSander(playerid, 2, 5, 0, 0, "\xD1\xEB\xEE\xEC\xE0\xED\xED\xE0\xFF \xEC\xE0\xF8\xE8\xED\xE0 \xED\xE5 \xEF\xF0\xE5\xE4\xED\xE0\xE7\xED\xE0\xF7\xE5\xED\xE0 \xE4\xEB\xFF \xE5\xE7\xE4\xFB", " ");
        return 0;
    }
