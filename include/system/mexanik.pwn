...
#if defined _SYSTEM_JOB_MEX
	#endinput
#endif 
#define _SYSTEM_JOB_MEX
...
public OnPlayerEnterDynamicArea(playerid, areaid)
{
    ...
    {
        //Автор: Welsi Тг канал:t.me/RageDev
        ...
        return m_OnPlayerEnterDynamicArea(playerid, STREAMER_TAG_AREA:areaid);
    #else
        return 1;
    #endif
}
...
#if defined m_OnPlayerEnterDynamicArea
    forward m_OnPlayerEnterDynamicArea(playerid, STREAMER_TAG_AREA:areaid);
#endif
//Автор: Welsi Тг канал:t.me/RageDev
