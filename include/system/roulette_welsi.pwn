...
public OnPlayerClickTextDraw(playerid, Text:clickedid)
{
	if(clickedid == welsirltk_TD[4])
	{
        ...
        if(GetPlayerDonateRub(playerid) >= 50)
        {
            ...
            ShowNotification(playerid, 0, "-50 UC", 2, "", "");
...
stock RuletkaMenu()
{
    ...
    welsirltk_TD[8] = TextDrawCreate(239.3332, 219.0370, "BRONZE");
    ...
    welsirltk_TD[34] = TextDrawCreate(580.9998, 2.0888, "Sile Russia");
...
stock RuletkaPlayer(playerid)
{
    ...
    ruletka_PTD_t[playerid][8] = CreatePlayerTextDraw(playerid, 86.9999, 376.6668, "BRONZE CASE");
    ...
    ruletka_PTD_t[playerid][11] = CreatePlayerTextDraw(playerid, 99.6666, 308.2222, "Werton_Werton");
    ...
    ruletka_PTD_t[playerid][12] = CreatePlayerTextDraw(playerid, 86.9999, 323.1556, "BRONZE CASE");
    ...
    ruletka_PTD_t[playerid][15] = CreatePlayerTextDraw(playerid,99.6666, 256.3703, "Werton_Werton");
    ...
    ruletka_PTD_t[playerid][16] = CreatePlayerTextDraw(playerid,86.9999, 271.3037, "BRONZE CASE");
