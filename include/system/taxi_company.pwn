        ...
        if(response){
            ...
            switch(listitem)
            {
                case 0: {
                    ...
                    UpdatePlayerDatabaseIint(playerid, "taxi_company", select);
...
stock TextDrawTaxi()
{
    taxi_panel_TD[0] = TextDrawCreate(14.5833, 208.9259, "LD_SPAC:white"); // пусто
    TextDrawTextSize(taxi_panel_TD[0], 88.0000, 68.0000);
    TextDrawAlignment(taxi_panel_TD[0], 1);
    TextDrawColor(taxi_panel_TD[0], 170);
...
stock PlayerTextDrawTaxi(playerid){
    ...
    taxi_panel_PTD[playerid][0] = CreatePlayerTextDraw(playerid, 18.7500, 211.7777, "Pacc¦o¬®њe:_1234_Ї."); // пусто
    ...
    taxi_panel_PTD[playerid][1] = CreatePlayerTextDraw(playerid, 18.7500, 223.7037, "C¦oњЇoc¦©:_123345_p."); // пусто
    ...
    taxi_panel_PTD[playerid][2] = CreatePlayerTextDraw(playerid, 19.1666, 235.1111, "Kћacc:_KoЇop¦"); // пусто
    ...
    taxi_panel_PTD[playerid][3] = CreatePlayerTextDraw(playerid, 34.5833, 260.5184, "‹peЇ¬:_04:23"); // пусто
