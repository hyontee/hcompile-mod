...
{
    if(pInfo[playerid][pAdminLevel] < 3) return SendClientMessage(playerid, 0xFF0000FF, "Недостаточно прав!");
    ...
    new str[128];
    format(str, sizeof(str), "Вы выдали %d BC игроку %s", amount, GetNameGamer[targetid]);
    SendClientMessage(playerid, 0x00FF00FF, str);
...
CMD:givedust(playerid, params[])
{
    ...
    new str[128];
    format(str, sizeof(str), "Вы выдали %d пыли игроку %s", amount, GetNameGamer[targetid]);
    SendClientMessage(playerid, 0x00FF00FF, str);
...
{
    if(pInfo[playerid][pAdminLevel] < 1) return SendClientMessage(playerid, 0xFF0000FF, "Недостаточно прав!");
