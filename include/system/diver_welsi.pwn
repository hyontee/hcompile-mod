...
public OnPlayerEnterDynamicArea(playerid, areaid)
{
    ...
    if(sphere_actor[0] <= areaid <= sphere_actor[1])
    {
        ...
        (
            ...
            ""br_с"Водолаз | Меню",
            ""br_с"1. Взять заказ\n"\
            ""br_с"2. Начать/Закончить смену\n"\
            ""br_с"3. Арендовать транспорт\n"\
            ""br_с"4. Продать предметы",
            "Далее", "Выход"
        );
        return 1;
    }
                ...
                case 4:
                {
                    ...
                    for(new c, count; c < 20;c++)
                    {
                        ...
                        (
                            ...
                            "Название\tКол-во\tПокупка за\n"\
                            "Шкатулка\t{FFFFFF}%d\t{D7FD00}%d\n"\
                            "Шина\t{FFFFFF}%d\t{D7FD00}%d\n"\
                            "Золотой слиток\t{FFFFFF}%d\t{D7FD00}%d\n"\
                            "Телевизор\t{FFFFFF}%d\t{D7FD00}%d\n"\
                            "Сапог с кладом\t{FFFFFF}%d\t{D7FD00}%d",
                    ...
                    (
                        ...
                        ""br_с"Водолаз | Продажа предметов",
                        dialog_text,
                        "Продать", "Назад"
                    );
                }
