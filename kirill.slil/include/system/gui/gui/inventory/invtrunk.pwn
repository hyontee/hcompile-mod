    ...
    switch(type)
    {
        case 0: // Из инвентаря в багажник
        {
            ...
            if(item_id == 134)  // ID скина
            {
                ...
                ShowNotificationSile(playerid, 2, 5, -1, -1, debug_msg, "");
            }
    ...
    else if(item_id == 81 || item_id == 82)  // Номера без региона
    {
        ...
        ShowNotificationSile(playerid, 2, 5, -1, -1, debug_msg, "");
            ...
            else
            {
                ...
                ShowNotificationSile(playerid, 2, 4, -1, -1, debug_msg, "");
            }
        ...
        case 2: // Из активного слота в инвентарь
        {
            ...
            {
                ShowNotificationSile(playerid, 2, 6, -1, -1, "Ошибка: Нельзя снять одежду (ID: 134, слот: 6)", "");
        ...
        case 8:
        {
            ...
            ShowNotificationSile(playerid, 2, 4, -1, -1, "Режим инвентаря сброшен (typeinv=0)", "");
        }
