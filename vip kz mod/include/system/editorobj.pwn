...
public OnPlayerEditObject(playerid, playerobject, objectid, response, Float:x, Float:y, Float:z, Float:rx, Float:ry, Float:rz)
{
    ...
    #if defined vis_OnPlayerEditObject
        return vis_OnPlayerEditObject(playerid, playerobject, objectid, response, x, y, z, rx, ry, rz);
    #else
        return 1;
    #endif
}
...
#endif
#define OnPlayerEditObject vis_OnPlayerEditObject

#if defined vis_OnDialogResponse
    forward vis_OnDialogResponse(playerid, dialogid, response, listitem, inputtext[]);
#endif
#if defined vis_OnPlayerEditObject
    forward vis_OnPlayerEditObject(playerid, playerobject, objectid, response, Float:x, Float:y, Float:z, Float:rx, Float:ry, Float:rz);
#endif