...
// ============================================================================
// Интеграция найденных предметов с основным инвентарём SANDER
...
stock Vodo_GetSlotItemIndex(playerid, slot)
{
    ...
    if(g_PlayerInventory[playerid][slot][inv_itemId] <= 0) return -1;

    new tag[16];
    for(new i = 0; i < sizeof(VodolazInventoryItemIds); i++)
    {
...
stock Vodo_ApplyInventoryName(playerid, slot, item_index)
{
    ...
    if(item_index < 0 || item_index >= sizeof(VodolazItemNames)) return 0;
