...
stock FireSystemMoveServiceVehicleOutside(playerid, vehicleid)
{
    ...
    {
        ShowNotificationSander(playerid, 2, 5, -1, 0, "Этот транспорт уже использует другой сотрудник МЧС.", "");
    ...
    {
        ShowNotificationSander(playerid, 2, 5, -1, 0, "Сначала верните ранее взятый транспорт МЧС.", "");
        FireSystemEjectFromVehicle(playerid, vehicleid);
        fire_player_driver_vehicle[playerid] = INVALID_VEHICLE_ID;
        return 0;
    }
    ...
    ShowNotificationSander(playerid, 3, 5, -1, 0, "Служебный транспорт МЧС выведен на улицу.", "");
    return 1;
}
