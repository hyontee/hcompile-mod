// ===== Missing defines for garages.pwn =====
// Добавь P_GARAGE и P_IN_GARAGE в твой enum PlayerData (в файле где хранятся все P_ константы)
// Если их нет - раскомментируй строки ниже:
// #define P_GARAGE         100  // замени 100 на свободный номер в твоём enum
// #define P_IN_GARAGE      101  // замени 101 на свободный номер в твоём enum
    ...
    #define ShowNewNotification ShowNotificationSander
#endif
// ============================================
