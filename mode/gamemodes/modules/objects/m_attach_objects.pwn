stock SetAttachToSkin(playerid, type, skinid, setobject)
{
	...
	else if(type == 21)//Ъанданы на голову
	{
		switch (skinid)
		{
	...
	{
		switch (skinid)//Њиратска§ пов§зка (19085)
		{
	...
	{
		switch (skinid)//Новогодн§§ ™лка (881)
		{
