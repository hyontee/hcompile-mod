        ...
        if(response)
        {
            ...
            if(GetPlayerMoneyEx(playerid) >= 3_000_000)
            {
                ...
                if(!mysql_errno())
                {
                    ...
                    ShowNotificationSander(playerid, 2, 5, 0, 0, "Вы потратили 3000000 рублей", " ");
       ...
       case 2: // Автопарк
{
    ...
    if(s_value == 1) // Запрос информации о машине
    {
        ...
        if(car_id == 0)
        {
            ...
            ShowNotificationSander(playerid, 2, 5, -1, -1, "Ошибка, не удалось загрузить транспорт!", "");
            return 1;
        }
        ...
        if(f == -1)
        {
            ...
            ShowNotificationSander(playerid, 2, 5, -1, -1, "Вы не состоите в семье.", "");
            return 1;
        }
        ...
        if(mysql_errno())
        {
            ...
            ShowNotificationSander(playerid, 2, 5, -1, -1, "Ошибка в SQL-запросе", "");
            cache_delete(cache);
            return 1;
        }
        ...
        if(!rows)
        {
            ShowNotificationSander(playerid, 2, 5, -1, -1, "Транспорт не найден.", "");
            cache_delete(cache);
            return 1;
        }
    ...
    else if(s_value == 2) // Действие с машиной
    {
        ...
        if(car_id <= 0)
        {
            ...
            ShowNotificationSander(playerid, 2, 5, -1, -1, "Ошибка, попробуйте позже.", "");
            JSON_Cleanup(response);
            return 1;
        }
        ...
        if(action_id == 1) // загрузить на парковке
        {
            if(LoadFamilyCar(car_id))
            {
                ...
                ShowNotificationSander(playerid, 3, 5, -1, -1, "Автомобиль успешно загружен.", "");
            }
            else
            {
                JSON_SetInt(response, "t", 2);
                ...
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Ошибка загрузки транспорта", "");
            } 
        }
        else if(action_id == 4) // выгрузить
        {
            ...
            {
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Транспорт занят", "");
                JSON_SetInt(response, "t", 2);
                JSON_SetInt(response, "s", 2);
                JSON_SetInt(response, "d", 0);
            }
            else if(UnLoadFamilyCar(car_id))
            {
                ...
                SendFamilyMessage(GetPlayerIdFamily(playerid), f_string144);
                SendFamilyLog(type_log_car, playerid, -1, f_string144);
                ShowNotificationSander(playerid, 3, 5, -1, -1, "Вы успешно выгрузили транспорт", "");
            }
            else
            {
                JSON_SetInt(response, "t", 2);
                JSON_SetInt(response, "s", 2);
                JSON_SetInt(response, "d", 0);
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Ошибка выгрузки транспорта", "");
            }
        }
        ...
        else if(action_id == 7) // сбросить парковку
        {
            ...
            if(GetPlayerRangFamily(playerid) != 5)
            {
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Сброс парковки доступен только лидеру семьи.", "");
                JSON_SetInt(response, "t", 2);
                JSON_SetInt(response, "s", 2);
                JSON_SetInt(response, "d", 0);
                SendPacketToClient(playerid, 45, response);
            ...
            if(vehicleid != INVALID_VEHICLE_ID)
            {
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Невозможно сбросить парковку. Сначала выгрузите транспорт.", "");
                JSON_SetInt(response, "t", 2);
                JSON_SetInt(response, "s", 2);
                JSON_SetInt(response, "d", 0);
                SendPacketToClient(playerid, 45, response);
            ...
            if(!mysql_errno())
            {
                ...
                ShowNotificationSander(playerid, 3, 5, -1, -1, "Парковка была успешно сброшена", "");
            ...
            else
            {
                ...
                JSON_SetInt(response, "s", 2);
                JSON_SetInt(response, "d", 0);
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Ошибка сброса парковки", "");
        ...
        else if(action_id == 3) // изменить ранг
        {
            ...
            if(GetPlayerRangFamily(playerid) != 5)
            {
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Изменение ранга транспорта доступно только лидеру семьи.", "");
                JSON_SetInt(response, "t", 2);
                JSON_SetInt(response, "s", 2);
                JSON_SetInt(response, "d", 0);
                SendPacketToClient(playerid, 45, response);
            ...
            if(vehicleid != INVALID_VEHICLE_ID)
            {
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Сначала выгрузите транспорт.", "");
                JSON_SetInt(response, "t", 2);
                JSON_SetInt(response, "s", 2);
                JSON_SetInt(response, "d", 0);
                SendPacketToClient(playerid, 45, response);
            ...
            if(access == 0)
            {
                if(current_rang > 1)
                {
                    ...
                    ShowNotificationSander(playerid, 3, 5, -1, -1, "Ранг использования автомобиля был успешно изменен", "");
                }
                else
                {
                    ShowNotificationSander(playerid, 2, 5, -1, -1, "В данной машине уже минимальный ранг.", "");
                    JSON_SetInt(response, "t", 2);
                    JSON_SetInt(response, "s", 2);
                    JSON_SetInt(response, "d", 0);
                    SendPacketToClient(playerid, 45, response);
            ...
            else if(access == 1)
            {
                ...
                {
                    ShowNotificationSander(playerid, 2, 5, -1, -1, "В данной машине уже максимальный ранг.", "");
                    JSON_SetInt(response, "t", 2);
                    JSON_SetInt(response, "s", 2);
                    JSON_SetInt(response, "d", 0);
                    SendPacketToClient(playerid, 45, response);
            ...
            else
            {
                ...
                JSON_SetInt(response, "s", 2);
                JSON_SetInt(response, "d", 0);
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Ошибка изменения ранга", "");
            }
        }
        else if(action_id == 2) // вернуть из семьи (забрать машину)
        {
            ...
            if(GetPlayerRangFamily(playerid) != 5)
            {
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Забрать транспорт из семьи может только лидер", "");
                JSON_SetInt(response, "t", 2);
                JSON_SetInt(response, "s", 2);
                JSON_SetInt(response, "d", 0);
                SendPacketToClient(playerid, 45, response);
            ...
            {
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Невозможно забрать транспорт, сначала выгрузите его", "");
                JSON_SetInt(response, "t", 2);
                JSON_SetInt(response, "s", 2);
                JSON_SetInt(response, "d", 0);
                SendPacketToClient(playerid, 45, response);
            ...
            {
                ShowNotificationSander(playerid, 2, 5, -1, -1, "У вас нет свободных слотов для транспорта", "");
                JSON_SetInt(response, "t", 2);
                JSON_SetInt(response, "s", 2);
                JSON_SetInt(response, "d", 0);
                SendPacketToClient(playerid, 45, response);
            ...
            if(MoveFamilyCar(car_id, playerid))
            {
                ...
                ShowNotificationSander(playerid, 3, 5, -1, -1, "Вы успешно удалили авто из семьи.", "");
            }
            else
            {
                JSON_SetInt(response, "t", 2);
                JSON_SetInt(response, "s", 2);
                JSON_SetInt(response, "d", 0);
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Ошибка удаления авто из семьи.", "");
            }
        }
        else if(action_id == 5) // загрузить в гараж
        {
            ShowNotificationSander(playerid, 2, 5, -1, -1, "action id 5");
            JSON_SetInt(response, "t", 2);
        ...
        else if(action_id == 6) // загрузить на месте выгрузки
{
    ...
    if(GetStatusFamilyCar(car_id))
    {
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Транспорт уже загружен", "");
        JSON_SetInt(response, "t", 2);
        JSON_SetInt(response, "s", 2);
        JSON_SetInt(response, "d", 0);
        SendPacketToClient(playerid, 45, response);
    ...
    {
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Ваш ранг не позволяет загрузить этот транспорт", "");
        JSON_SetInt(response, "t", 2);
        JSON_SetInt(response, "s", 2);
        JSON_SetInt(response, "d", 0);
        SendPacketToClient(playerid, 45, response);
        ...
        if(rows == 0)
{
    ...
    ShowNotificationSander(playerid, 2, 5, -1, -1, "Автопарк пуст.", "");
        ...
        case 3: // Магазин
{
    ...
    switch(item_id)
    {
        ...
        default:
        {
            ShowNotificationSander(playerid, 2, 5, -1, -1, "Предмет не найден", "");
            return 1;
        }
    }
    ...
    {
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Недостаточно семейных токенов!", "");
    ...
    if(item_id == 0)
    {
        ...
        if(freeSlot == -1)
        {
            ShowNotificationSander(playerid, 2, 7, -1, -1, "Нет свободного места в инвентаре!", "");
            return 1;
        }
        ...
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Кейс открыт! Проверьте инвентарь.", "");
    ...
    else // Обычный предмет (не кейс)
    {
        ...
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Предмет добавлен в инвентарь!", "");
        ...
        case 4: // Улучшения
        {
            ...
            if(s_value == 1)
            {
                 switch(id_value) 
                 {
						...
						ShowNotificationSander(playerid, 2, 5, -1, -1, fmt, ""); 
						JSON_SetInt(response, "s", 0);
						} 
              		  } 
             		   case 1:
        ...
        if(s_value == 1) // Переименование ранга
{
    ...
    if(GetPlayerRangFamily(playerid) != 5)
    {
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Доступно только лидеру семьи.", "");
        JSON_Cleanup(response);
        return 1;
    }
    ...
    if(len < 3 || len > 24)
    {
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Название ранга должно быть от 3 до 24 символов.", "");
        JSON_Cleanup(response);
        return 1;
    }
    ...
    {
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Название ранга не должно содержать запятую.", "");
        JSON_Cleanup(response);
        return 1;
    }
    ...
    ShowNotificationSander(playerid, 2, 5, -1, -1, "Название ранга изменено.", "");
...
else if(s_value == 2) // Изменение доступа
{
    ...
    if(player_rang != 5)
    {
        ...
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Изменять доступы может только лидер семьи.", "");
        JSON_Cleanup(response);
        return 1;
    }
    ...
    else
    {
        ...
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Неверные параметры доступа", "");
        JSON_Cleanup(response);
        return 1;
    }
        ...
        else if(s_value == 3) // Установка цвета
{
    ...
    if(GetPlayerRangFamily(playerid) != 5)
    {
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Изменять цвет семьи может только лидер.", "");
        JSON_Cleanup(response);
        return 1;
    }
    ...
    if(r_value >= 0 && r_value <= 17)
    {
        ...
        foreach(new i : Player)
        {
            ...
            format(f_string144, sizeof f_string144, "%sСемья:{FFFFFF} %s", family_type_color[r_value], GetFamily(f, family_name));

            if(IsValidDynamic3DTextLabel(GetPlayerFamily(i, TEXT_FAMILY)))
                UpdateDynamic3DTextLabelText(GetPlayerFamily(i, TEXT_FAMILY), -1, f_string144);
            else
                SetPlayerFamily(i, TEXT_FAMILY, CreateDynamic3DTextLabel(f_string144, -1, 0.0, 0.0, 0.8, 7.8, i));
        }
    ...
    {
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Неверный ID цвета!", "");
        JSON_Cleanup(response);
        return 1;
    }
...
else // Получение списка рангов
{
    ...
    else if(id_value == 2)
    {
        ...
        if(s_value == 1)
        {
            ...
            {
                printf("[FAMILY] SQL ERROR: %d", mysql_errno());
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Ошибка SQL", "");
                cache_delete(cache);
                JSON_Cleanup(response);
                return 1;
            }
            ...
            if(rows == 0)
            {
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Игрок не найден в семье", "");
                cache_delete(cache);
                JSON_Cleanup(response);
                return 1;
            }
        ...
        else if(s_value == 2)
{
    ...
    if(strlen(target_nick) == 0)
    {
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Не выбран игрок для действия", "");
        JSON_Cleanup(response);
        return 1;
    }
    ...
    {
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Вы не можете взаимодействовать с собой.", "");
        JSON_Cleanup(act_response);
        return 1;
    }
    ...
    {
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Нельзя выполнить действие над игроком с равным или высшим рангом", "");
        JSON_Cleanup(act_response);
        return 1;
    }
    ...
    switch(action_value)
    {
        case 0: // МИНУС
        {
            if(action_type == 0) // Понизить ранг
            {
           	if(!family_rang_dostup[f][GetPlayerRangFamily(playerid)-1][2])
           {
           ShowNotificationSander(playerid, 2, 5, -1, -1, "У Вас нет доступа к использованию данной функции", "");
        JSON_Cleanup(act_response);
        return 1;
       } 
                if(target_rang <= 1)
                {
                    ShowNotificationSander(playerid, 2, 5, -1, -1, "Нельзя понизить ранг ниже 1", "");
                    JSON_Cleanup(act_response);
                    return 1;
                }
                ...
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Ранг изменён", "");
        ...
        return 1;
                ...
                {
                    ShowNotificationSander(playerid, 2, 5, -1, -1, "У игрока нет активного мута", "");
                    JSON_Cleanup(act_response);
                    return 1;
                }
                ...
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Мут уменьшен на 10 минут", "");
                JSON_SetInt(act_response, "r", 1);
            }
            else if(action_type == 3) // Кик
            {
           	if(!family_rang_dostup[f][GetPlayerRangFamily(playerid)-1][1] && GetPlayerRangFamily(playerid) != 5)
          	{
                ...
                if(target_playerid != -1)
                {
                    ...
                    ShowNotificationSander(target_playerid, 2, 5, -1, -1, "Вас исключили из семьи!", "");
                }
                else
                {
                    mysql_format(mysql, f_string184, sizeof f_string184,
                ...
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Игрок исключён из семьи", "");
                JSON_SetInt(act_response, "r", 1);
            }
        }
        case 1: // ПЛЮС
        ...
        return 1;
                ...
                if(target_rang >= 4)
                {
                    ShowNotificationSander(playerid, 2, 5, -1, -1, "Нельзя повысить ранг выше 5", "");
                    JSON_Cleanup(act_response);
                    return 1;
                }
                ...
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Ранг повышен", "");
                JSON_SetInt(act_response, "r", 1);
            }
        ...
        return 1;
                ...
                {
                    ShowNotificationSander(playerid, 2, 5, -1, -1, "Нельзя выдать мут больше 60 минут!", "");
                    JSON_Cleanup(act_response);
                    return 1;
                }
                ...
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Мут увеличен на 10 минут", "");
                JSON_SetInt(act_response, "r", 1);
            }
        }
    }
    ...
    return 1;
        ...
        else
        {
            ...
            {
                printf("[FAMILY] SQL ERROR: %d", mysql_errno());
                ShowNotificationSander(playerid, 2, 5, -1, -1, "Ошибка получения списка игроков", "");
                cache_delete(cache);
                JSON_Cleanup(response);
                return 1;
            }
    ...
    else if(id_value == 3) // Склад/Сейф
{
    ...
    if(r_value == 1) // Склад
    {
   	JSON_SetInt(response, "s", 1);
        ...
        {
            ShowNotificationSander(playerid, 2, 5, -1, -1, "Склад временно недоступен.", "");
            JSON_SetInt(response, "s", 1);
        }
    }
    ...
    else if(id_value == 4) 
{
    ...
    if(GetPlayerRangFamily(playerid) != 5)
    {
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Доступно только лидеру.", "");
        JSON_Cleanup(response);
        return 1;
    }
    ...
    else if(id_value == 5)
    {
        ...
        SendPacketToClient(playerid, 45, response);
        JSON_Cleanup(response);
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Временно не доступно.", "");
        return 1;
    }
        ...
        case 6: // Уведомления
{
    ...
    if(f == -1)
    {
        ShowNotificationSander(playerid, 2, 5, -1, -1, "Ошибка");
        JSON_Cleanup(response);
        return 1;
    }
    ...
    if(b == 1)
    {
        ...
        if(strlen(msg) < 1)
        {
       	 ShowNotificationSander(playerid, 2, 5, -1, -1, "Введите текст", "");
        }
        ...
        case 9: // Токены (покупка жетонов)
{
    ...
    else if(s_value == 2) // Покупка токенов
    {
        ...
        if(count <= 0)
        {
            ShowNotificationSander(playerid, 2, 5, -1, -1, "Укажите корректное количество токенов!", "");
            return 1;
        }
        ...
        else
        {
            ...
            ShowNotificationSander(playerid, 2, 5, -1, -1, "Недостаточно BC!", "");
        }
        ...
        case 10: // Диалоги подтверждения (покинуть семью)
{
    ...
    if(s_value == 0) // Подтверждение выхода из семьи
    {
        ...
        if(player_rang == 5) // Лидер удаляет всю семью
        {
            ...
            ShowNotificationSander(playerid, 2, 5, -1, -1, "Вы покинули семью, и она была распущена.", "");
        }
        else // Обычный игрок покидает семью
        {
            ...
            ShowNotificationSander(playerid, 2, 5, -1, -1, "Вы покинули семью.", "");
        }
...
CMD:family(playerid, params[])
{
    new f = GetPlayerIdFamily(playerid);
    if(f == -1)
        return ShowNotificationSander(playerid, 2, 6, -1, -1, "Вы не состоите в семье.", "");
