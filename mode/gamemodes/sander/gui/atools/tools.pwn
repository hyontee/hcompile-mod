...
CMD:showtools(playerid, params[])
{
    ...
    switch(screenType)
    {
        ...
        default: ShowNotificationSander(playerid, 0, 3, 0, 0, "Хуйню высрал", "");
    }
	...
	switch(screenType)
	{
		case 1:
		{
			...
			switch(buttonId)
			{
				...
				case 2:
				{
					...
					else ShowNotificationSander(playerid, 0, 3, 0, 0, "Игрок не найден", "");
				}
				case 3:
				{
		...
		case 2:
		{
			...
			switch(tableButtonId)
			{
				case 1: 
				{
						if(GetPlayerAdminEx(playerid) < 1) return ShowNotificationSander(playerid, 2, 5, -1, -1, "Вам не доступно использование данной функции",  "");
				...
				case 100..107: 
				{
					...
					if(GetPlayerAdminEx(playerid) < 2) return ShowNotificationSander(playerid, 2, 5, -1, -1, "Вам не доступно использование данной функции",  "");
				...
				case 18..30:
				{
   					...
   					if(GetPlayerAdminEx(playerid) < 3)
       					return ShowNotificationSander(playerid, 2, 3, 0, 0, "У вас нет доступа к использованию данной функции", " ");
		...
		case 3:
		{
			...
			ShowNotificationSander(playerid, 2, 5, -1, -1, f_string144, "");
				switch(tableButtonId)
				{
					case 1:
					{
