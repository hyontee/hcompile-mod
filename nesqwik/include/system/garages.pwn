// РЅРµ Р±С‹Р» РѕРїСЂРµРґРµР»С‘РЅ РЅРёРіРґРµ РІ РјРѕРґРµ - РІС‹Р±РѕСЂ СЃС‚РёР»СЏ СѓРІРµРґРѕРјР»РµРЅРёСЏ РїСЂРё Р·Р°РІРµСЂС€РµРЅРёРё СѓР»СѓС‡С€РµРЅРёСЏ РіР°СЂР°Р¶Р° (0 = СЃС‚Р°СЂС‹Р№ ShowNotification, РёРЅР°С‡Рµ РЅРѕРІС‹Р№ ShowNotificationNew)
