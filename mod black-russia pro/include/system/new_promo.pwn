...
case DIALOG_APPLY_PROMO_CODE:
{
    ...
    new promoUsesLimit = cache_get_field_content_int(0, "uses_limit");
    new promoUsesLeft = cache_get_field_content_int(0, "uses_left");
    ...
    if(promoSqlId >= 0)
    {
        if(promoUsesLeft > 0 || promoUsesLimit == 0) 
        {
