...
public UpdateSatiety()
{
    ...
    foreach(new i : Player) 
    {
        ...
        new satiety_value = player_satiety[i];\n        UpdatePlayerDatabaseInt(i, "satiety", satiety_value);
    }
