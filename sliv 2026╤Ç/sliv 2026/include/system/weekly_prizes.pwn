                ...
                case STATUS_WP_MAYBE:
                {
                    switch(weekly_prizes[day][WP_Type])
                    {
                        ...
                        case WP_VIP: {
                            ...
                            new premium_date_value = GetPlayerData(playerid, P_PREMIUM_DATE);\n                            UpdatePlayerDatabaseInt(playerid, "premium_date", premium_date_value);
                        }
                        case WP_SLOT: {
                            AddPlayerData(playerid, P_CAR_SLOTS, +, weekly_prizes[day][WP_Index]);
                            new car_slots_value = GetPlayerData(playerid, P_CAR_SLOTS);\n                            UpdatePlayerDatabaseInt(playerid, "car_slots", car_slots_value);
                        }
                    }
