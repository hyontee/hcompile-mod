...
{
    {24, -10.500555,1508.271728,1381.106933,5.466476, DOWN_TYPE},
    {75, 10.421929,1508.132812,1381.106933,359.76928, DOWN_TYPE},
    ...
    {30, -15.935025,1514.664062,1380.997558,273.759552, UP_TYPE},
    ...
    {245, 9.629007,1499.574584,1380.997558,277.546264, UP_TYPE},
    {39, 18.135103,1516.698852,1380.997558,0.96914, UP_TYPE}
};
...
new Float:end_actor[11][4] =
{
    ...
    {1.310970,1512.209838,1380.997558,138.737945},
...
{
    SendClientMessage(playerid, -1, "На сервере доступны {FFFF00}новогодние задание и мини-игры");
    SendClientMessage(playerid, -1, "Чтобы найти Деда Мороза - {FFFF00}/newyear");
    return 1;
}
...
public OnPlayerEnterDynamicArea(playerid, areaid)
{
    ...
    if(areaid == shpere_ded_moroz)
    {
        if(GetPlayerNewYear(playerid, NEW_QUEST_1) == 0)
        {
            ...
            (
                ...
                "Дед Мороз",
                "Здраствуй, ты уже понял кто перед тобой? Да это я - Дед Мороз \n"\
                "У меня большие проблемы. Мне нужно чтобы ты помог мне \n"\
                "Ты же поможешь мне? Я обещаю наградить тебя щедрыми подарками \n"\
                "Давай я покажу тебе что я приготовил для игроков в этом году",
                "Посмотреть", "Задания"
            );
        }
        else
    ...
    {
        if(!(GetPVarInt(playerid, "quest_3_new_year"))) return 0;
    ...
    {
        if(!(GetPVarInt(playerid, "quest_4_new_year"))) return 0;
...
{
    print("[LAIRD_SYSTEM] Новогодние квесты загружены\nАвтор: https://t.me/welsistudio");
...
stock UnLoadPlayerData_NewYear(playerid)
{
    ...
    SetPlayerNewYear(playerid, SNOW_COINS, 0);
    ...
    if(GetPVarInt(playerid, "quest_5_new_year"))    RemoveQuestNewYear(playerid, 5);
...
stock quest_complete(playerid, id_q)
{
    ...
    UpdatePlayerDatabaseInt(playerid, quest_sql[id_q - 1], 1);
...
stock RemoveQuestNewYear(playerid, number_quest)
{
    ...
    switch(number_quest)
    {
        ...
        case 2:
        {
            DeletePVar(playerid, "quest_2_new_year");
        ...
        case 4:
        {
            ...
            DeletePVar(playerid, "dialog_progress");
...
public: OpenGiftBox(playerid, gift)
{
   ...
   if(r >= 90)
   {
        ...
        Dialog
        (
            playerid, 4438, DIALOG_STYLE_MSGBOX,
       ...
       new money = random(50000) + 5000, donate = random(25) + 1,exp = random(5) + 5;
       ...
       SetPVarInt(playerid, "gift_exp", exp);
...
{
    time_mini_game_TD[0] = TextDrawCreate(97.0000, 226.9186, "_");
    ...
    time_mini_game_TD[1] = TextDrawCreate(99.6667, 229.4075, "_");
    ...
    time_mini_game_TD[2] = TextDrawCreate(103.3332, 227.7482, "OCЏA‡OC’_‹PEMEH…:");
...
stock TextDrawMiniGamePlayer(playerid)
{
    time_mini_game_PTD[playerid][0] = CreatePlayerTextDraw(playerid, 109.3333, 236.0444, "50_ceky®љ");
