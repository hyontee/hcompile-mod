...
{
    printf("[LAIRD_SYSTEM] Система рулетки загружена.\n");
    RuletkaMenu();
    LoadPrizeRuletka();
...
stock RuletkaMenu()
{
    ...
    welsirltk_TD[6] = TextDrawCreate(586.6188, 399.6828, "љo_100000_p.");
    ...
    welsirltk_TD[8] = TextDrawCreate(239.3332, 219.0370, "ЂPOH€O‹‘†");
    ...
    welsirltk_TD[10] = TextDrawCreate(433.2857, 400.5124, "љo_100000_p.");
    ...
    welsirltk_TD[12] = TextDrawCreate(509.6188, 400.5125, "љo_100000_p.");
    ...
    welsirltk_TD[14] = TextDrawCreate(585.9521, 247.4457, "љo_100000_p.");
    ...
    welsirltk_TD[16] = TextDrawCreate(432.9524, 247.8605, "љo_100000_p.");
    ...
    welsirltk_TD[18] = TextDrawCreate(509.2855, 247.8606, "љo_100000_p.");
    ...
    welsirltk_TD[20] = TextDrawCreate(585.6187, 298.4679, "љo_100000_p.");
    ...
    welsirltk_TD[22] = TextDrawCreate(432.6191, 298.8827, "љo_100000_p.");
    ...
    welsirltk_TD[24] = TextDrawCreate(508.9522, 298.8828, "љo_100000_p.");
    ...
    welsirltk_TD[26] = TextDrawCreate(586.2855, 349.0754, "љo_100000_p.");
    ...
    welsirltk_TD[28] = TextDrawCreate(433.2857, 349.4902, "љo_100000_p.");
    ...
    welsirltk_TD[30] = TextDrawCreate(509.6188, 349.4902, "љo_100000_p.");
...
stock RuletkaPlayer(playerid)
{
	...
	ruletka_PTD_t[playerid][3]  = CreatePlayerTextDraw(playerid, 235.2379, 47.0784, "Случайное оружие");
	...
	ruletka_PTD_t[playerid][4]  = CreatePlayerTextDraw(playerid, 157.2856, 48.3346, "до 100000 р.");
	...
	ruletka_PTD_t[playerid][0]  = CreatePlayerTextDraw(playerid, 466.8570, 45.8340, "Пакет с лицензиями");
    ...
    ruletka_PTD_t[playerid][8] = CreatePlayerTextDraw(playerid, 86.9999, 376.6668, "ЂPOH€O‹‘† KE†C");
    ...
    ruletka_PTD_t[playerid][12] = CreatePlayerTextDraw(playerid, 86.9999, 323.1556, "ЂPOH€O‹‘† KE†C");
    ...
    ruletka_PTD_t[playerid][16] = CreatePlayerTextDraw(playerid,86.9999, 271.3037, "ЂPOH€O‹‘† KE†C");
