...
CheckAllItemsCollected(playerid, zone_name[], collected_index)
{
    ...
    if(all_collected == 1)
    {
        ...
        new Float:kapitan_coords[4][3] = {
            ...
            {2273.179443, 310.147216, 4.03999},
            {2501.043701, -1253.509033, 1.436212}
        };


        new closest_kapitan = 0;
        new Float:closest_distance = Float:0x7F800000;
