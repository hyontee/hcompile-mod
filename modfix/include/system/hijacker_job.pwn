...
new orders_hijacker[10][STRUCT_HIJACKER] =
{
    ...
    {-1, 490, -1, -1, -1,   490.803161,892.269592,11.254014,72.575027,       335.735992,780.646728,658.850952,1127.929077},
    {-1, 466, -1, -1, -1,   21.750465,1070.200439,11.245204,169.182846,      -159.141586,950.674804,136.920562,1378.438232},
    {-1, 405, -1, -1, -1,   -2238.848144,-55.657539,25.997491,0.019704 ,     -2493.057617,-338.89932,-2160.443603,144.148910},
    ...
    {-1, 542, -1, -1, -1,   2423.073486,-2626.398925,21.372909,181.049209,   2131.563476,-2677.256103,2546.755371,-2137.126708},
...
{
    CreateHijacker();
    print("[LAIRD_SYSTEM] Работа автоугонщика загружена.");
...
stock CreateHijacker()
{
    ...
    sphere_npc_hijacker = CreateDynamicSphere(2164.181396,-1858.483032,18.814174, 2.0);
...
CMD:carjack(playerid)
{
    if(player_order_hijacker[playerid] != -1)
    {
        ...
        foreach(new i : Vehicle)
        {
            ...
            {
                new array[5], number[] = {1, 2, 3, 4, 5}, none[5];
