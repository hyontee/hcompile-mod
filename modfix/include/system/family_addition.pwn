#define START_OBJECT_1  35
#define START_OBJECT_2  40
#define START_OBJECT_3  45

new object_duration[5] = {300, 600, 900, 300, 300};
...
new CAPTURE_FAMILY_EXP[MAX_FAM][5], CAPTURE_LEADER[5][2];
...
{
    if(t < 0 || t >= sizeof(CAPTURE_STATUS) || !CAPTURE_STATUS[t])
    {
        show_panel_capt[playerid] = false;
        return 1;
    }
...
stock TextDrawFamilyWar()
{
    for(new i;i < sizeof(fam_TD);i++)
    {
        ...
        fam_TD[i][2] = TextDrawCreate(10.3332, 252.2221, "Ваши очки:");
        ...
        fam_TD[i][3] = TextDrawCreate(10.3332, 266.7406, "Очки лидера:");
        ...
        fam_TD[i][8] = TextDrawCreate(67.6666, 284.9925, "12:11");
...
stock TextDrawExpFamily(fam)
{
    for(new i;i < 5;i++)
    {
        fam_PTD[fam][i] = TextDrawCreate( 99.3332, 252.6367, "0");
