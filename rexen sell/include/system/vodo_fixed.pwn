...
stock Vodo_OnPlayerConnect(playerid)
{
...
stock Vodo_OnPlayerEnterDynamicArea(playerid, STREAMER_TAG_AREA:areaid)
{
for(new i = 0; i < sizeof(yg_areas); i++)
    {
        if(areaid == yg_areas[i])
        {
            ...
            {
                ShowNotificationSile(playerid, 4, 6, VODOLAZ_OFFER, 0, "�����������������", ">>");
	...
	{
	ShowNotificationSile(playerid, 4, 6, VODOLAZKA_OFFER, 0, "�����������������", ">>");
...
stock Vodo_OnGameModeInit()
{
    printf("[MELLISS SYSTEM] ������� �������� ���������.");
// ��������
...
stock Vodo_OnPlayerUpdate(playerid)
{

return 1;
}
stock Vodo_OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
if(dialogid == 58909) // ������ ������� ���������
{
    if(response)
        ...
        switch(listitem)
        {
            case 0:
            {
                ...
                else 
                {
                    ...
                    ShowNotificationSile(playerid, 2, 5, 1, 10, message, "");
                }  
            }
        }         
    }     
...
stock Vodo_OnPlayerSpawn(playerid)
{
    PlayerBoatID[playerid] = INVALID_VEHICLE_ID;
...
stock Vodo_OnPlayerEnterCheckpoint(playerid)
{ 
...
if(GetPlayerLevel(playerid)<18) return ShowNotificationSile(playerid, 2, 6, 0, 0, "��� ������ ��������� 18 �������!", "");
ShowPlayerDialog(playerid, 58901, DIALOG_STYLE_LIST, "{ed4b00}������� �����", "{ed4b00}1.{fff7fc}���������� ����� \t\t\t\t{dbd5d9}������� ��� ������\n{ed4b00}2.{fff7fc}���������� ������ ������� \t\t\t\t{dbd5d9}������� ��� ���������\n{ed4b00}3.{fff7fc}������� ��������� ���������  \t\t\t\t{dbd5d9}������� ��� �������","�������","�������");
}
/*
