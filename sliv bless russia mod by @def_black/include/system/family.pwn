...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
            ...
            switch(listitem)
            {
                ...
                case 9:
                {
                    ...
                    (
                        ...
                        "{FF0000}Покинуть семью by fronz?",
                        "Вы уверены что хотите покинуть семью?\n"\
                        "Если вы лидер by fronz семья - удалиться.",
                        "Далее", "Назад"
                    );
                }
            }
    ...
    if(dialogid == 2238)
    {
        if(response)
        {
            ...
            if(GetPlayerMoneyEx(playerid) >= 15_000_000)
            {
                ...
                if(!mysql_errno())
                {
                    ...
                    GivePlayerMoneyEx(playerid, -15_000_000);
...
stock MoveOwnableCar(playerid, database_car, fam)
{
    ...
    if(GetFamily(fam_id, family_count_veh)+1 > GetFamily(fam_id, family_slot_veh))
        return SendClientMessage(playerid, -1, ""c_f_r"В семье не хватает слотов. (/buyslotfam)");
	...
	(
		...
		(family_owner,model_id,color_1,color_2,pos_x,pos_y,pos_z,angle,create_time,number,wheels_kl,wheels_size,wheels_raz,wheels_otkl,gidra,comfort,sport,sport_plus,drift) \
		VALUES \
		('%d','%d','%d','%d','%f','%f','%f','%f','%d','%s','%d','%d','%d','%d','%d','%d','%d','%d','%d')",
		fam,
		model_id,
		color_1,
		color_2,
...
//@fronzstudio
//fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio fronzstudio