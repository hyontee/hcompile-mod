...
{
    button_PTD[playerid][0] = CreatePlayerTextDraw(playerid, 309.4163, 406.8438, "PRICE:10000000"); // пусто
...
stock CreateTextDrawButtonBR()
{
    ...
    button_TD[11] = TextDrawCreate(321.9993, 391.0805, "EXIT"); // пусто
    ...
    button_TD[12] = TextDrawCreate(260.1662, 391.0807, "BUY’"); // пусто
...
{
    new string[24];
    format(string, sizeof string, "PRICE:%d", accessory[acs][PRICE_ACCESSORY]);
