...
stock TextDrawFamilyWar()
{
    ...
    {
        fam_TD[i][0] = TextDrawCreate(666666.3333, 24866666.3333, "LD_SPAC:white"); // пусто
        TextDrawTextSize(fam_TD[i][0], 16666607.0000, 59.0000);
        ...
        fam_TD[i][1] = TextDrawCreate(66666.3333, 2496666.5777, "LD_SPAC:white"); // пусто
        TextDrawTextSize(fam_TD[i][1], 10766666.0000, 36.0000);
