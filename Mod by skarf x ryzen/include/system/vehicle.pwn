    ...
    g_vehicle_info[][E_VEHICE_INFO_STRUCT] = 
{
    ...
    {"AUDI RS6 C7 ����������",   10000000,    5300,   2, 520.00, 4.00},
    ...
    {"����� 54115",              0,           0,      0, 0.00, 0.00},
    {"���",                      0,           0,      0, 0.00, 0.00},
    {"Volkswagen Polo",          850000,      1800,   0, 238.00, 8.00},
    {"��� ������",               0,           1500,   0, 0.00, 0.00},
    {"���� 977",                 0,           1000,   0, 0.00, 0.00},
    ...
    {"BMW ���",                  0,           0,      0, 0.00, 0.00},
    {"PRIORA ���",               0,           0,      0, 0.00, 0.00},
    {"GETTA ���",                0,           0,      0, 0.00, 0.00},
    {"samp ���",                 0,           0,      0, 0.00, 0.00},
    {"���� 2335",                0,           800,    0, 0.00, 0.00},
    {"����",                     0,           0,      0, 0.00, 0.00},
    {"�lpha",                    0,           34000,  0, 0.00, 0.00},
...
stock IsABike(vehicleid)
{
    ...
    switch(modelid)
    {
        case 448, 461, 462, 463, 468, 471, 481, 510, 521, 522, 523, 581, 586:
            return 1;
    }
