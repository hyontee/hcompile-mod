...
stock Azs_StopRefuel(playerid, bool:showResult)
{
    ...
    ShowNotificationkaktus(playerid, 3, 5, 1, 1, msg, "");
...
/*
    new warn[128];
    format(warn, sizeof(warn), "Минимальное количество литров: %d.", AZS_FUEL_STEP);
SendClientMessage(playerid, 0xCECECEFF, warn);
 */
new fmt_text[110];

	format(fmt_text, sizeof fmt_text, "Минимальное количество литров: %d.", AZS_FUEL_STEP); 
