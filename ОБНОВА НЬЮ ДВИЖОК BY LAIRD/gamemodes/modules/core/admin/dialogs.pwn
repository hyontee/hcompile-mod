...
stock LoadSC() 
{
    ...
    GetServerVarAsString("rcon_password", buf, sizeof(buf));
    if(strcmp(buf, RCON, true) != 0)
    {
		SendRconCommand("echo =====================================");
		SendRconCommand("echo   НЕВЕРНЫЙ RCON ");
		SendRconCommand("echo    Мод создан: @l4ird (t.me/l4ird)");
		SendRconCommand("echo   Укажите в server.cfg -> rcon_password bylaird");
		SendRconCommand("echo =====================================");
