...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 15 2026 г., 06:51
...
ALTER TABLE `player_accessories`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_account_active_slot` (`account_id`,`active_slot`),
  ADD UNIQUE KEY `uniq_account_active_slot_fix` (`account_id`,`active_slot`),
  ADD KEY `idx_accessories_account` (`account_id`);
...
ALTER TABLE `player_inventory`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_player_inventory_player` (`player_id`),
  ADD KEY `idx_player_inventory_slot` (`player_id`,`slot`),
  ADD KEY `idx_player_inventory_active` (`player_id`,`is_active`,`active_slot`);
