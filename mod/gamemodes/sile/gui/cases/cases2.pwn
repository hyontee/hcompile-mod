...
stock GetPlayerCaseCountByType(playerid, case_type)
{
    switch(case_type)
    {
        ...
        case 7: return GetPlayerData(playerid, P_COUNT_DOP_CASE2);
    }
    return 0;
}
...
stock SetPlayerCaseCountByType(playerid, case_type, value)
{
    ...
    switch(case_type)
    {
        case 1: 
        {
            ...
            UpdatePlayerData(playerid, P_COUNT_TODAY_CASE, GetPlayerData(playerid, P_COUNT_TODAY_CASE));
        }
        case 2: 
        {
            SetPlayerData(playerid, P_COUNT_BOMJ_CASE, value);
            UpdatePlayerData(playerid, P_COUNT_BOMJ_CASE, GetPlayerData(playerid, P_COUNT_BOMJ_CASE));
        }
        case 3: 
        {
            SetPlayerData(playerid, P_COUNT_STANDART_CASE, value);
            UpdatePlayerData(playerid, P_COUNT_STANDART_CASE, GetPlayerData(playerid, P_COUNT_STANDART_CASE));
        }
        case 4: 
        {
            SetPlayerData(playerid, P_COUNT_CAR_CASE, value);
            UpdatePlayerData(playerid, P_COUNT_CAR_CASE, GetPlayerData(playerid, P_COUNT_CAR_CASE));
        }
        case 5: 
        {
            SetPlayerData(playerid, P_COUNT_OSOBIY_CASE, value);
            UpdatePlayerData(playerid, P_COUNT_OSOBIY_CASE, GetPlayerData(playerid, P_COUNT_OSOBIY_CASE));
        }
        case 6: 
        {
            SetPlayerData(playerid, P_COUNT_DOP_CASE1, value);
            UpdatePlayerData(playerid, P_COUNT_DOP_CASE1, GetPlayerData(playerid, P_COUNT_DOP_CASE1));
        }
        case 7: 
        {
            SetPlayerData(playerid, P_COUNT_DOP_CASE2, value);
            UpdatePlayerData(playerid, P_COUNT_DOP_CASE2, GetPlayerData(playerid, P_COUNT_DOP_CASE2));
        }
        default: return 0;
    }
    return 1;
...
CMD:reward_case(playerid, params[])
{
