...
// ============================================================
stock ShowNotificationLaird(playerid, type, slot, target, data, text[], sound[]) { return 1; }
stock GivePlayerMoneyEx(playerid, money, reason[], bool:log = true, bool:send = false) { return 1; }
stock UpdatePlayerDatabaseInt(playerid, field[], value) { return 1; }
stock EnablePlayerGPS(playerid, type, Float:x, Float:y, Float:z, text[]) { return 1; }
// ============================================================
