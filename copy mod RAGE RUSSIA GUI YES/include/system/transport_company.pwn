...
#define LEVEL_START_TC  2 //Поменяйте на уровень с которого будет доступен дальнобойщик
...
{
    {130000, 70000}, // salary_orderот 40000 до 50000
    {100000, 65000}, // ПОЛУЧАЕТСЯ от 35000 до 45000 (10000 рандом типо пон?) 
    {145000, 45000},
...
{
	if(GetPlayerAdminEx(playerid) >= 11) // 6 - начиная с какого уровня администратора это доступно?
	{
		if(!strlen(params))
